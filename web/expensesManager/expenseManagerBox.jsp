...
/*    width: 220px;*/
    ...
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-title"><h5>Expenses Manager</h5></div>
                 <div class="row d-flex justify-content-center">
           
     <div class="col-lg-3 mt-2 mt-lg-0 p-3 " >
         <div class="round-box" id="newInvoic">
          <a style="color: inherit" href="../tenant/ExpenseCategorySettingsList.htm">
              <div class="flex-column">
                ...
                <div class="col-lg-3 mt-2 mt-lg-0 p-3 " >
         <div class="round-box">
             <a style="color: inherit" href="../tenant/bookedExpenses.htm">
             ...
             <div class="flex-column">
                ...
                <div class="col-lg-3 mt-2 mt-lg-0 p-3 " >
         <div class="round-box">
             <a style="color: inherit" href="../tenant/bookedExpensesTracking.htm">
 ...
 <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>Maintain Expense Settings, Expense Bookings, and Expense Tracking. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
