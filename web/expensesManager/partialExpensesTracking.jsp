...
<ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="../expensesManager/partialExpensesTracking.jsp">Partial Expenses</a></li>
         </ul>    </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Partial Expense Tracking</h5></div> 
                        ...
                        <table id="myTable"  class="table datatable">
                            ...
                            <tbody>
                                ...
                                <td class="center">
                                    ...
                                    <a href="#" class="fa fa-ticket fa-lg" data-toggle="tooltip" title="Ledger Voucher"></a>&nbsp;
                                    <a href="" class="fa fa-print fa-lg" data-toggle="tooltip" title="Generate Receipt"></a>&nbsp;
