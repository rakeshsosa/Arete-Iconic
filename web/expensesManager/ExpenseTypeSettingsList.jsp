...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
                     <jsp:include page="../login/headerlink.htm?submodule=Expenses Settings&tab=Expenses Type Settings&pagetype=list"/>
       </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Expense Type Settings List</h5></div> 
                                                                   ...
                                                                   <tr>
                                                                        ...
                                                                        <td class="center">
                                                                            <a href="../Expenses/ExpenseCategorySettingsForm.htm?expensesCategoryId=${type[0]}&action=view" class="fa fa-eye fa-lg" data-toggle="tooltip" title="View"></a>
                                                                                ...
                                                                                <a class="fa fa-pencil-square-o fa-lg" href="../tenant/ExpenseCategorySettingsForm.htm?expensesCategoryId=${type[0]}&action=edit" data-toggle="tooltip" title="Edit">
