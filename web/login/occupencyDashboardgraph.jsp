...
<select class="form-select" name="clientType" placeholder="Category" id="doctype" maxlength="98" required="" aria-invalid="false">
               ...
               <div class="col-md-3 form-floating mb-3 pick2">
                               ...
                               <h5 style="font-size:20px;"><b>Occupancy Statistics</b></h5>

        <div class="row mt-2 mx-auto p-2 ">
            <div class="col-lg-3 text-center bg-body p-2 rounded mx-2 mb-2" data-toggle="tooltip" style="height:150px !important;width:173px !important;border-radius:50% !important;border:4px solid #314c68 !important;" >
                           <a data-toggle="tooltip" title="Total Units"><img class="mt-4" src="../common/theme/images/total-rental.png"></a>
                           <h5 class="mt-3">400</h5>
                       </div>
            <div class="col-lg-3 text-center bg-body p-2 rounded mx-2 mb-2" data-toggle="tooltip" style="height:150px !important;width:173px !important;border-radius:50% !important;border:4px solid #314c68 !important;">
                           <a data-toggle="tooltip" title="Total Occupied Units"><img class="mt-4" src="../common/theme/images/occupied.png"></a>
                           <h5 class="mt-3">300</h5>
                       </div>
             <div class="col-lg-3 text-center bg-body p-2 rounded mx-2 mb-2" data-toggle="tooltip" style="height:150px !important;width:173px !important;border-radius:50% !important;border:4px solid #314c68 !important;">
                           <a data-toggle="tooltip" title="Total Vacant Units"><img class="mt-4" src="../common/theme/images/vacancy.png"></a>
                           <h5 class="mt-3">80</h5>
                       </div>
             <div class="col-lg-3 text-center bg-body p-2 rounded mx-2 mb-2" data-toggle="tooltip" style="height:150px !important;width:173px !important;border-radius:50% !important;border:4px solid #314c68 !important;">
                           <a data-toggle="tooltip" title="Total Booked Units"><img class="mt-4" src="../common/theme/images/booked.png"></a>
                           <h5 class="mt-3">20</h5>
                       </div>         
     </div>
                            ...
                            <div class="row mt-2 mx-auto">
                                <div class="px-2 col-md-4">
                                    <div class="card col-md-12" style="background-color: #fff;border-radius:10px;">
                                        <canvas id="complaintStatus"  class="graph-container chartjs-render-monitor" width="600" height="500" style="display: block; width: 305px; height: 305px;" ></canvas>
                                     </div>
                                </div>
                                  <div class="px-2 col-md-4">
                                   <div class="card col-md-12" style="background-color: #fff;border-radius:10px;">
                                        <canvas id="speedChart"  class="graph-container chartjs-render-monitor" width="600" height="500" style="display: block; width: 305px; height: 305px;" ></canvas>
                                     </div>
                                  </div>
                                  <div class="px-2 col-md-4">
                              <div class="card col-md-12" style="background-color: #fff;border-radius:10px;">
                                               <canvas id="invoceschart" class="graph-container chartjs-render-monitor" width="600" height="500" style="display: block; width: 305px; height: 235px;" ></canvas>
                                        </div>
                                    </div>
                                </div>
                                </div>              
...
<!--  <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.3/jspdf.min.js"></script>-->
 ...
 <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>View Property Name with from and to dates, Print and Download the Occupancy Statistics of Total Units, Total Occupied Units, Total Vacant Units, and Total Booked Units. View the colorful charts of Occupancy Break up, Occupancy Trends, and Vacancy Unit Trends. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
...
function download() {
        ...
        var barChartData = {
            ...
            datasets: [{
                    label: 'Vacant Units',
                    backgroundColor: ['#7facdb','#7facdb','#7facdb','#7facdb','#7facdb'],
                   // stack: 'Stack 1',
