...
<html lang="en">
    ...
    <body>
        ...
        <script>
            function test(divisionName, address) {

                window.opener.document.getElementById('billToAddress').value = divisionName + '\n' + address;
                window.close();
            }
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:forEach items="${billToLocList}" var="type">

                                        <tr onclick="test('${type.divisionName}', '${type.address}');">                                           
