                ...
                <c:choose>
                    <c:when test="${fn:length(requiDocument) > 0}">
                        <c:forEach items="${requiDocument}" var="attach">
                            <c:choose>
                                ...
                                <td><c:if test="${not empty attach.content}">
                                        <a   href="../purchase/requiAttachDownload.htm?sno=${attach.sno}&requisitionNo=${attach.requisitionNo}" class="fa fa-file-pdf-o" style="color: #000">${attach.filename}
                    ...
                    <c:otherwise>
                        ...
                        <td><c:if test="${not empty attach.content}">
                                ...
                                <input class="input-file uniform_on"  id="attachmentReference" type="hidden" value="${attach.filename}" name="attachmentReference" onchange="fileCheck(this);">
