    ...
    <body>
        ...
        <script>
            function test(address) {
                ...
                window.opener.document.getElementById('requiredAtLoc').value = address;
                window.close();
            }
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:forEach items="${deliveryLocList}" var="type">

                                        <tr onclick="test('${type.address}');">                                           
                                    ...
                                    <c:forEach items="${deliveryLocList}" var="type">
                                        ...
                                        <tr onclick="test('${type.storeName}');">                                           
                                            <td class="center" >${type.division}</td>
                                            <td class="center">${type.storeType}</td>
                                            <td class="center">${type.storeName}</td>
                                            <td class="center">${type.address}</td>
