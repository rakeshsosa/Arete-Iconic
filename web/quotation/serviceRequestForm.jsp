            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <jsp:include page="../login/headerlink.htm?submodule=Service Request&tab=Service Request&pagetype=form"/>
                        <div class="clearfix"></div>

                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h4>Store Request Form</h4>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="ServiceRequest" class="form-inline" action="../serviceReq/serviceRequestFormSubmit.htm" method="post" onsubmit="return checkGrid();">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(RequestList) > 0}">
                                                        <c:forEach items="${RequestList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" class="form-control"  readonly="" id="propertyName" name="propertyName" maxlength="40" value="${list.propertyName}" onkeypress="return isNumberKey3(event)">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" class="form-control" readonly="" id="propertyName" value="${list.propertyName}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="auto map" readonly="" class="form-control"  id="propertyName" name="propertyName" maxlength="40" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(RequestList) > 0}">
                                                        <c:forEach items="${RequestList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" class="form-control" readonly="" id="propertyNo" name="propertyNo" value="${list.propertyNo}">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" class="form-control" readonly="" id="propertyNo" value="${list.propertyNo}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="auto map" readonly=""  class="form-control"  id="propertyNo" name="propertyNo" value="">
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            ...
                                                            <select id="serviceCategory" class="form-control validate[required]">
                                        ...
                                        <c:if test="${action ne 'view' && action ne 'edit'}">
                                            ...
                                            <div style="overflow: scroll;height: auto;width: 98%;border: 1px solid gray;margin-left:10px;margin-right:10px;background:#f5f6f7;">
                                                <table id="example" class="table table-striped responsive-utilities">
                                                    <thead>
                                                        <tr>
                                                            <th style="background:#425567;color:#fff;"><i class="fa fa-trash fa-lg"></i></th>
                                                            <th style="background:#425567;color:#fff;">Item Category</th>
                                                            ...
                                                            <th style="background:#425567;color:#fff;">Quantity</th>
                                                            <th style="background:#425567;color:#fff;">Req. Quantity</th>
                                                            <th style="background:#425567;color:#fff;">Unit Price</th>
                                                            <th style="background:#425567;color:#fff;">Margin Price</th>
                                                            <th style="background:#425567;color:#fff;">Total Price</th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            <table id="example" class="table table-striped responsive-utilities">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="background:#425567;color:#fff;">Item Name</th>
                                                        <th style="background:#425567;color:#fff;">UOM</th>
                                                        <th style="background:#425567;color:#fff;">Avail. Quantity</th>
                                                        <th style="background:#425567;color:#fff;">Req. Quantity</th>
                                                        <th style="background:#425567;color:#fff;">Unit Price</th>
                                                        <th style="background:#425567;color:#fff;">Margin Price</th>
                                                        <th style="background:#425567;color:#fff;">Total Price</th>
                                                    ...
                                                    <c:forEach items="${RequestListve}" var="list">
                                                        <c:forEach items="${inventory}" var="type">
                                                            <c:if test="${list.itemCode eq type.itemCode}">
                                                                <tr>
                                                                    <td class="center">${list.serviceCategory}</td>
                                                                    <td class="center" >${list.itemCode}</td>
                                                                    <td class="center">${list.serviceItems}</td>
                                                                    <td class="center">${list.uom}</td>
                                                                    <td class="center">${type.totalStock}</td>
                                                                    <td class="center">${list.qty}</td>
                                                                    <td class="center">${list.unitPrice}</td>
                                                                    <td class="center">${list.margin}</td>
                                            ...
                                            <tbody id="resourcetable">
                                                ...
                                                <c:forEach items="${RequestListve}" var="list">
                                                    <c:forEach items="${inventory}" var="type">
                                                        <c:if test="${list.itemCode eq type.itemCode}">
                                                            <tr>
                                                                <td><input  style="width: 100px;text-align:center;" class="form-control" readonly name="serviceCategory" id="serviceCategory" type="text" value="${list.serviceCategory}"><input type="hidden" name="sno" value="${list.sno}"/></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="itemCode" id="itemCode" type="text" value="${list.itemCode}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="itemName" id="serviceItems" type="text" value="${list.serviceItems}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="uom" id="uom" type="text" value="${list.uom}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="totalStock" id="totalStock" type="text" value="${type.totalStock}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;background-color: rgb(246, 246, 229);" class=" form-control input-mini validate[required,custom[integer]] validate[custom[notzero]]" onpaste="return false" autocomplete="off" required="" name="reqQty" id="reqQty${list.sno}" onkeypress="return check_digit(event, this, 6, 0);" onkeypress="return isNumberKey(event)" onkeyup="calTotal(this,${list.sno});" type="text" value="${list.qty}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;background-color: rgb(246, 246, 229);" class=" form-control input-mini validate[required,custom[integer]] validate[custom[notzero]]" onpaste="return false" autocomplete="off" required="" name="unitPrice" id="unitPrice${list.sno}" onkeypress="return check_digit(event, this, 6, 0);" onkeypress="return isNumberKey(event)" onkeyup="calTotal(this,${list.sno});" type="text" value="${list.unitPrice}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;background-color: rgb(246, 246, 229);" class=" form-control input-mini validate[required,custom[integer]] validate[custom[notzero]]" onpaste="return false" autocomplete="off" required="" name="marginPrice" id="marginPrice${list.sno}" onkeypress="return check_digit(event, this, 6, 0);" onkeypress="return isNumberKey(event)" onkeyup="calTotal(this,${list.sno});" type="text" value="${list.margin}"></td>
                                                                <td class="center"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="totalPrice" id="totalPrice${list.sno}" type="text" value="${list.totalPrice}"></td>
                                                            </tr>
                                                            <c:set var="i" value="${i+1}"/>
                                                        </c:if>
                                                    </c:forEach>
