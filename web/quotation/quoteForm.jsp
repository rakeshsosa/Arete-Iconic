    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectSubAssetDetails()
            {
                ...
                var tenantCategory = document.getElementById("tenantCategory").value;
                myWindow = window.open("../CRM/selectSubAssetDetailsQuote.htm?assetCode=" + assetCode + "&tenantCategory=" + tenantCategory + "", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
            }
...
//                        document.getElementById("tenantMailid").value &&
                ...
                var assetM = document.getElementById("assetName").value &&
                        document.getElementById("subClassifiedAssetName").value;

                var contM = document.getElementById("contractCode").value &&
//                        document.getElementById("minimumRentFixed").value &&
                        document.getElementById("quotedRentAmount").value &&
...
//                    $('#tenantMailid').focus();
                ...
                if (assetM == '')
                {
                    ...
                    $('#assetName').focus();
                    $('#subClassifiedAssetName').focus();
                    return false;
                }


                //Commented By Garun to disable the conract Details and billing cycle on date 2017-03-02 
...
//            function numberValidActualRent() {
//                var actualREnt = document.getElementById('actualRentFixed').value;
//                if (actualREnt === "0") {
//                    document.getElementById('actualRentFixed').value = '';
//                    return false;
//                }
//            }
//            function numberValidMinimumFixedRent() {
//                var actualREnt = document.getElementById('minimumRentFixed').value;
//                if (actualREnt === "0") {
//                    document.getElementById('minimumRentFixed').value = '';
//                    return false;
//                }
//            }
        ...
        <script>
            ...
            function test()
            {
                ...
                var tfnm=document.getElementById("tenantFname").value;
                var tfnm1=document.getElementById("tenantFname1").value;
                
                var tlnm=document.getElementById("tenantLname").value;
                var tlnm1=document.getElementById("tenantLname1").value;
                
                var tpstcd=document.getElementById("tenentpostalCode").value;
                var tpstcd1=document.getElementById("tenentpostalCode1").value;
                
                var tpobox=document.getElementById("tenantpostboxNo").value;
                var tpobox1=document.getElementById("tenantpostboxNo1").value;
                
                var jointnm1=document.getElementById("jointeeName1").value;
                var jointnm11=document.getElementById("jointeeName11").value;
                
                var jointaddr1=document.getElementById("jointeeAddress1").value;
                var jointaddr11=document.getElementById("jointeeAddress11").value;
                
                var jointnm2=document.getElementById("jointeeName2").value;
                var jointnm21=document.getElementById("jointeeName21").value;
                
                var jointaddr2=document.getElementById("jointeeAddress2").value;
                var jointaddr21=document.getElementById("jointeeAddress21").value;
                
                var sprnm=document.getElementById("sponcerName").value;
                var sprnm1=document.getElementById("sponcerName1").value;
                
                var crno=document.getElementById("tenantCrNo").value;
                var crno1=document.getElementById("tenantCrNo1").value;
                
                var contno=document.getElementById("tenantContactno").value;
                var contno1=document.getElementById("tenantContactno1").value;
                
                var workcontno=document.getElementById("tenantWorkContactno").value;
                var workcontno1=document.getElementById("tenantWorkContactno").value;
                
                var tmail=document.getElementById("tenantMailid").value;
                var tmail1=document.getElementById("tenantMailid1").value;
                
                var peraddr=document.getElementById("permanentAddress").value;
                var peraddr1=document.getElementById("permanentAddress1").value;
                
                var correaddr=document.getElementById("correspondenceAddress").value;
                var correaddr1=document.getElementById("correspondenceAddress1").value;
                
                var spraddr=document.getElementById("sponcerAddress").value;
                var spraddr1=document.getElementById("sponcerAddress1").value;
                
                var sprpocode=document.getElementById("sopnsorpostalCode").value;
                var sprpocode1=document.getElementById("sopnsorpostalCode1").value;
                        
                var sprpobox=document.getElementById("sponsorpostboxNo").value;
                var sprpobox1=document.getElementById("sponsorpostboxNo1").value;
                
                var thistory=document.getElementById("tenentHistory").value;
                var thistory1=document.getElementById("tenentHistory1").value;
                
                var remarks=document.getElementById("remarks").value;
                var remarks1=document.getElementById("remarks1").value;
                
                var quoteamt=document.getElementById("quotedRentAmount").value;
                var quoteamt1=document.getElementById("quotedRentAmount1").value;
                
               
        if(tfnm!==tfnm1||tlnm!==tlnm1||tpstcd!==tpstcd1||tpobox!==tpobox1||jointnm1!==jointnm11||jointaddr1!==jointaddr11||jointnm2!==jointnm21||jointaddr2!==jointaddr21||sprnm!==sprnm1||crno!==crno1||contno!==contno1||workcontno!==workcontno1||tmail!==tmail1||peraddr!==peraddr1||correaddr!==correaddr1||spraddr!==spraddr1||sprpocode!==sprpocode1||sprpobox!==sprpobox1||thistory!==thistory1||remarks!==remarks1||quoteamt!==quoteamt1)
        {
        ...
        }else{document.forms["quoteForm"].submit();}
            }
        </script>
    </head>
    <body class="nav-md">
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <form class="row" id="quoteForm" action="../CRM/rentQuoteFormSubmit.htm"  method="post" enctype="multipart/form-data">
                                        ...
                                        <c:if test="${fieldStatus_2 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <!--<input type="text" placeholder="Fill" class="form-control" id="tenantType" name="tenantType" value="">-->
                                                        <input type="hidden"  class="form-control" id="tenantQuoteCode" name="tenantQuoteCode" value="">

                                                        <select id="tenantType" name="tenantType" ${mand_status_2} class="form-select validate[required]">
                                        ...
                                        <c:if test="${fieldStatus_3 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <!--<input type="text" placeholder="Fill" class="form-control" ${mand_status_3} id="tenantCategory" name="tenantCategory" value="">-->
                                                        <select id="tenantCategory" name="tenantCategory" ${mand_status_3} class="form-select validate[required]">
                                                            <option value="" disabled selected>Select your option</option>
                                        ...
                                        <c:if test="${fieldStatus_4 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_4}  id="tenantFname1" value="${list.tenantFirstName}" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" style="text-transform: capitalize;" class="form-control" ${mand_status_4} id="tenantFname" name="tenantFname" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_5 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_5}  id="tenantLname1" value="${list.tenantLastName}" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" style="text-transform: capitalize;" ${mand_status_5} id="tenantLname" name="tenantLname" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_6 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_6} id="tenantCitizenship" name="tenantCitizenship" value="">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_7} readonly="" id="tenantId" name="tenantId" value="${list.tenantId}" onkeypress="return isNumberKey3(event)" autocomplete="off" onchange="return  checkTenenatId();">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_7} id="tenantId" name="tenantId" value="" onkeypress="return isNumberKey3(event)" autocomplete="off" onchange="return  checkTenenatId();">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_8 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_8}  maxlength="3" id="tenentpostalCode1" value="${list.tenantpostalCode}" onkeypress="return isNumberKey(event)" onchange="postlcde();" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_8} id="tenentpostalCode" name="tenentpostalCode" maxlength="3" value="" onkeypress="return isNumberKey(event)" onchange="postlcde();" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_9 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_9}  id="tenantpostboxNo1" maxlength="4" value="${list.tenantPostBoxNo}" onkeypress="return isNumberKey(event)" onchange="pstbxno();" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_9} id="tenantpostboxNo" name="tenantpostboxNo" maxlength="4" value="" onkeypress="return isNumberKey(event)" onchange="pstbxno();" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_11 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_11}  id="jointeeName11" value="${list.jointeeName1}" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_11} id="jointeeName1" name="jointeeName1" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_12 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control"  id="jointeeAddress11" value="${list.jointeeAddress1}">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" type="text" rows="1" placeholder="Fill" class="form-control" ${mand_status_12} id="jointeeAddress1" name="jointeeAddress1" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" style="margin-top: -20px;">${field_12}
                                        ...
                                        <c:if test="${fieldStatus_13 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_13}  id="jointeeName21"  value="${list.jointeeName2}" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_13} id="jointeeName2" name="jointeeName2" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_13}
                                        ...
                                        <c:if test="${fieldStatus_14 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="jointeeAddress21" value="${list.jointeeAddress2}">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" type="text" rows="1"  placeholder="Fill" class="form-control" ${mand_status_14} id="jointeeAddress2" name="jointeeAddress2" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" style="margin-top: -20px;">${field_14}
                                        ...
                                        <c:if test="${fieldStatus_15 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_15}  id="sponcerName1" value="${list.sponsorname}" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_15} id="sponcerName" name="sponcerName" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
...
<!--                                                                    <select class="form-control " id="ifWorking" name="ifWorking" value="${list.ifWorking}" onchange="checkavl(this.value);">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <select class="form-select " id="ifWorking" name="ifWorking" value="" onchange="compNameAndAddre(this.value);"  >
                                        ...
                                        <c:if test="${fieldStatus_17 eq 'y'}">
                                            <div class="col-md-4 form-floating">                                                
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_17} id="companyName" name="companyName" value="" onkeypress="return isNumberKey4(event)" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea style="resize: none" rows="1" maxlength="200" type="text" class="form-control" ${mand_status_18}  id="companyAddress" name="companyAddress" value="${list.companyAddress}">${list.companyAddress}</textarea>
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" rows="1" maxlength="200" type="text" placeholder="Fill" class="form-control" ${mand_status_18} id="companyAddress" name="companyAddress" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" style="margin-top: -20px;">${field_18}
                                        ...
                                        <c:if test="${fieldStatus_19 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_19}  id="tenantCrNo1"  value="${list.crno}" onkeypress="return isNumberKey3(event)" autocomplete="off" onchange="return checkTenenatCRId();">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_19} id="tenantCrNo" name="tenantCrNo" value="" onkeypress="return isNumberKey3(event)" autocomplete="off"  onchange="return checkTenenatCRId();">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_20 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_20}  id="tenantContactno1"  maxlength="11" value="${list.contactNo}" onkeypress="return isNumberKey(event)" onchange="mobileNoValidation()" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_20} id="tenantContactno" name="tenantContactno" value="" maxlength="11" onkeypress="return isNumberKey(event)" onchange="mobileNoValidation()" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_21 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_21}  id="tenantWorkContactno1" maxlength="11" value="${list.tenantWorkContactNo}" onkeypress="return isNumberKey(event)" onchange="mobileNoValidation1()" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_21} id="tenantWorkContactno" name="tenantWorkContactno" value="" maxlength="11" onkeypress="return isNumberKey(event)" onchange="mobileNoValidation1()" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_22}  id="tenantMailid" name="tenantMailid" value="${list.mailId}" onchange="emailValidate();" autocomplete="off">
                                                                    <input type="hidden" class="form-control" ${mand_status_22}  id="tenantMailid1" value="${list.mailId}" onchange="emailValidate();" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_22} id="tenantMailid" name="tenantMailid" value=""  onchange="emailValidate();" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_22}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea type="text" class="form-control" maxlength="200" rows="1" style="resize: none" ${mand_status_23}  id="permanentAddress" name="permanentAddress" value="${list.permanentAddress}">${list.permanentAddress}</textarea>
                                                                    <input type="hidden" class="form-control" ${mand_status_22}  id="permanentAddress1" value="${list.permanentAddress}" autocomplete="off">

                                                                </c:when>
                                                                <c:otherwise>
                                                                    <textarea type="text" class="form-control" maxlength="200" rows="1" style="resize: none" readonly="" id="permanentAddress" value="${list.permanentAddress}">${list.permanentAddress}</textarea>
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <textarea type="text" placeholder="Fill" rows="1" maxlength="200" style="resize: none" class="form-control" ${mand_status_23} id="permanentAddress" name="permanentAddress" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_23}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea type="text" rows="1" maxlength="200" class="form-control" style="resize: none" ${mand_status_24}  id="correspondenceAddress" name="correspondenceAddress" value="${list.correspondingAddress}">${list.correspondingAddress}</textarea>
                                                                    <input type="hidden" class="form-control" ${mand_status_22}  id="correspondenceAddress1" value="${list.correspondingAddress}" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <textarea type="text" rows="1" maxlength="200" class="form-control" style="resize: none" readonly="" id="correspondenceAddress" value="${list.correspondingAddress}">${list.correspondingAddress}</textarea>
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <textarea type="text" placeholder="Fill" maxlength="200" rows="1" style="resize: none" class="form-control" ${mand_status_24} id="correspondenceAddress" name="correspondenceAddress" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" >${field_24}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea type="text" rows="1" maxlength="200" class="form-control" placeholder="Fill" style="resize: none" ${mand_status_25}  id="sponcerAddress" name="sponcerAddress" value="${list.sponsorAddress}">${list.sponsorAddress}</textarea>
                                                                    <input type="hidden" class="form-control" style="resize: none" ${mand_status_25} id="sponcerAddress1" value="${list.sponsorAddress}" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <textarea type="text" rows="1" maxlength="200" class="form-control" placeholder="Fill" style="resize: none" readonly="" id="sponcerAddress" value="${list.sponsorAddress}">${list.sponsorAddress}</textarea>
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" rows="1" placeholder="Fill" maxlength="200" class="form-control" type="text" placeholder="Fill"  ${mand_status_25} id="sponcerAddress" name="sponcerAddress" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" style="margin-top: -20px;">${field_25}
                                        ...
                                        <c:if test="${fieldStatus_26 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_26}  id="sopnsorpostalCode1" maxlength="10" value="${list.sponsorPostalCode}" onkeypress="return isNumberKey(event)" onchange="postlcde1();" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_26} id="sopnsorpostalCode"  name="sopnsorpostalCode" value="" onkeypress="return isNumberKey(event)" maxlength="10" onchange="postlcde1();" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_26}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_27}  id="sponsorpostboxNo" name="sponsorpostboxNo"  value="${list.sponsorPostBoxNo}" maxlength="40" value=""  onchange="return validateEmail1(event);" autocomplete="off">
                                                                    <input type="hidden" class="form-control" ${mand_status_27}  id="sponsorpostboxNo1" value="${list.sponsorPostBoxNo}" maxlength="40" value=""  onchange="return validateEmail1(event);" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_27} id="sponsorpostboxNo" name="sponsorpostboxNo" maxlength="40" value=""  onchange="return validateEmail1(event);" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_27}
                                        ...
                                        <c:if test="${fieldStatus_28 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <label class="control-label">${field_28}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea style="resize: none" rows="1" maxlength="200" type="text" class="form-control" ${mand_status_28}  id="tenentHistory" name="tenentHistory" value="${list.tenantHistory}">${list.tenantHistory}</textarea>
                                                                    <input type="hidden" class="form-control"  ${mand_status_28}  id="tenentHistory1" value="${list.tenantHistory}" maxlength="40" value=""  autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" type="text" rows="1" maxlength="200" placeholder="Fill" class="form-control" ${mand_status_28} id="tenentHistory" name="tenentHistory" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <c:if test="${mand_status_28 eq 'required'}">
                                                    <a   style="color:red;">*</a>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <textarea style="resize: none" rows="1" maxlength="200" type="text" class="form-control" ${mand_status_29}  id="remarks" name="remarks" value="${list.remarks}">${list.remarks}</textarea>
                                                                    <input type="hidden" id="remarks1"  class="form-control"  ${mand_status_29}  style="resize: none" rows="1" maxlength="200" value="${list.remarks}">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <textarea style="resize: none" rows="1" type="text" maxlength="200" placeholder="Fill" class="form-control" ${mand_status_29} id="remarks" name="remarks" value=""></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label" style="margin-top: -20px;">${field_29}
                                        ...
                                        <c:if test="${fieldStatus_30 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_30} readonly="" id="assetName" name="assetName" value="${assetName1}" onkeypress="return isNumberKey3(event)" autocomplete="off">
                                                                    <input type="hidden" id="assetCode" name="assetCode" value="${assetCode1}">
                                                                </c:when>
                                                                <c:otherwise>
                                                ...
                                                <label class="control-label">${field_30}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_31} readonly="" id="subClassifiedAssetName" name="subClassifiedAssetName" value="${subAssetName1}" onkeypress="return isNumberKey3(event)" autocomplete="off">
                                                                    <input type="hidden" id="subassetCode" name="subassetCode" value="${subAssetCode1}">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" class="form-control" readonly="" id="subClassifiedAssetName" value="${subAssetName1}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Select Flat Name" class="form-control" ${mand_status_31} id="subClassifiedAssetName" readonly="" name="subClassifiedAssetName" value="" onkeypress="return isNumberKey3(event)" onclick="selectSubAssetDetails();" autocomplete="off">
                                                        <input type="hidden" id="subassetCode" name="subassetCode" value="">
                                                        <input type="hidden" id="actualRent" name="actualRent" value="">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_31}
                                        ...
                                        <c:if test="${fieldStatus_32 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_32} id="buildingNo" readonly="" name="buildingNo" value="" onkeypress="return isNumberKey(event)">
                                                    </c:otherwise>        
                                                </c:choose>
												<label class="control-label">${field_32}
                                        ...
                                        <c:if test="${fieldStatus_38 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" id="wayNo" name="wayNo" maxlength="50" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_38}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" readonly="" id="assetArea" name="assetArea" maxlength="50" value="${list.area}" onkeypress="return isNumberKey3(event)">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" id="assetArea" name="assetArea" maxlength="50" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_34}
                                        ...
                                        <c:if test="${fieldStatus_40 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" id="blockNo" name="blockNo" maxlength="50" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_40}
                                        ...
                                        <c:if test="${fieldStatus_36 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" ${mand_status_36} id="plotNo" name="plotNo" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_36}
                                        ...
                                        <c:if test="${fieldStatus_39 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" ${mand_status_39} id="streetNo" name="streetNo" value="" onkeypress="return isNumberKey3(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_39}
												<c:if test="${mand_status_39 eq 'required'}">
                                                    <a   style="color:red;">*</a>
                                                </c:if>
												</label>
                                        ...
                                        <c:if test="${fieldStatus_41 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" ${mand_status_41} id="assetPostalCode" name="assetPostalCode" maxlength="3" value="" onkeypress="return isNumberKey(event)" onchange="postlcde2();">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_41}
                                        ...
                                        <c:if test="${fieldStatus_42 eq 'y'}">
                                            <div class="col-md-4 form-floating">                                                
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" ${mand_status_42} id="assetPostboxNo" readonly="" name="assetPostboxNo" value="" maxlength="4" onkeypress="return isNumberKey(event)" onchange="pstbxno2();">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_42}
                                        ...
                                        <c:if test="${fieldStatus_33 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_33} id="waterBillno" readonly="" name="waterBillno" value="" onkeypress="return isNumberKey(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_33}
                                        ...
                                        <c:if test="${fieldStatus_37 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                     
                                                        <input type="text" placeholder="Fill" readonly="" class="form-control" ${mand_status_37} id="electricityBillno" name="electricityBillno" value="" onkeypress="return isNumberKey(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_37}
                                        ...
                                        <c:if test="${fieldStatus_43 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text"  class="form-control" ${mand_status_43} id="contractCode" name="contractCode" required=""  value="" readonly="" placeholder="Select Contract Code" onclick="selectContractName();">
                                                        <input type="hidden" id="contSno" name="contSno" value="">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <label class="control-label">${field_43}
                                        ...
                                        <c:if test="${fieldStatus_44 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <label class="control-label">${field_44}
                                        ...
                                        <c:if test="${fieldStatus_45 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <p>&nbsp;</p>
                                                 <label class="control-label">${field_45}
                                        ...
                                        <c:if test="${fieldStatus_46 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <label class="control-label">${field_46}
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(quoteList) > 0}">
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    <input type="text" class="form-control" ${mand_status_48} id="quotedRentAmount" name="quotedRentAmount" value="${list.quotedRentAmount}" onkeypress="return checkdigit(event, this, 10, 2);" autocomplete="off">
                                                                    <input type="hidden" class="form-control" ${mand_status_48} id="quotedRentAmount1" value="${list.quotedRentAmount}" onkeypress="return checkdigit(event, this, 10, 2);" autocomplete="off">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" class="form-control" readonly="" id="quotedRentAmount" value="${list.quotedRentAmount}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Fill" class="form-control" ${mand_status_48} id="quotedRentAmount" name="quotedRentAmount" value="" onkeypress="return checkdigit(event, this, 10, 2);" autocomplete="off">
                                                    </c:otherwise>        
                                                </c:choose>
                                                <p>&nbsp;</p>
												<label class="control-label">${field_48}
                                        ...
                                        <c:if test="${fieldStatus_50 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${quoteList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                    ...
                                                                    <select id="billingCycle" name="billingCycle"  ${mand_status_50} class="form-select">
                                                                        <option >${list.billingCycle}</option>
                                                                        <c:forEach items="${quoteFormData_dropDown_Category}" var="list">
                                                                            <c:if test="${list[0] eq 'F-15'}">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <!--<input type="text" placeholder="Fill" class="form-control" ${mand_status_50} id="billingCycle" name="billingCycle" value="" Monthly, quarterly, Half yearly, yearly>-->
                                                        <select id="billingCycle" name="billingCycle" ${mand_status_50} class="form-select">
                                                            <option value="" disabled selected>Select your option</option>
                                                            <c:forEach items="${quoteFormData_dropDown_Category}" var="list">
                                                                <c:if test="${list[0] eq 'F-15'}">
                                                 ...
                                                 <label class="control-label">${field_50}
                                        ...
                                        <c:if test="${fieldStatus_51 eq 'y'}">
                                            <div class="col-md-4 form-floating">
                                                ...
                                                <label class="control-label">${field_51}
                                    ...
                                    <c:if test="${recheck_option eq 'Recheck' }">
                                                ...
                                                <c:forEach items="${quoteList}" var="list">
                                                    ...
                                                    <c:if test="${cforemarks ne 'null'}">
                                                        <tr>
                                                            ...
                                                            <td class="center"> <fmt:formatDate pattern="dd-MMM-yyyy" value="${list.startsFrom}" /></td>
                                                            <td class="center">${cforemarks}</td>
                                                        </tr>
                                                    </c:if>
