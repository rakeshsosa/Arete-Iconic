<%-- 
    Document   : bookingDetailsRejForm
    Created on : 28 Dec, 2018, 11:56:33 AM
    Author     : ebs-sdd41
--%>
                    ...
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    <h2>Booking Details Rejected Form</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <br />
                                    <form class="form-inline" id="tenantform" action="../tenant/bookingDetailsAppSubmit.htm"  method="post" enctype="multipart/form-data">
                                        <c:if test="${action eq 'edit'}">
                                            ...
                                            <br/>
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                <a style="color:transparent;">*</a><label class="control-label">Remarks</label>
                                                <c:choose>
                                                    <c:when test="${fn:length(BookingTenantDetails) > 0}">
                                                        <c:forEach items="${BookingTenantDetails}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                    <textarea  class="form-control" required="" readonly="" rows="1" type="text" id="reviewerComments" style="resize: none;" name="reviewerComments" maxlength="120" value="${list.appremarks}" ></textarea> 
                                                                    <!--<input type="text" class="form-control" readonly="" id="reviewerComments" name="reviewerComments" maxlength="50" value="${list.appremarks}">-->
                                                                    <!--<input type="hidden" id="roomCode" name="roomCode" value="${list.appremarks}" >-->
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <!--<textarea  class="form-control" required="" readonly="" rows="1" type="text" id="reviewerComments" style="resize: none;" name="reviewerComments" maxlength="120" value="${list.appremarks}" ></textarea>--> 
                                                                    <input type="text" class="form-control" readonly="" id="reviewerComments" value="${list.appremarks}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <textarea  class="form-control" required="" readonly="" rows="1" type="text" id="reviewerComments" style="resize: none;" name="reviewerComments" maxlength="120" ></textarea> 
                                                        <!--<input type="hidden" id="roomCode" value="" >-->
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
<!--                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <c:if test="${action eq 'edit'}">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                    ...
                                                    <a href="../tenant/bookingDetailsRejList.htm" class="btn btn-danger">Cancel</a>
                                                </div>
                                                <!--</div>--> 
                                            </c:if>
