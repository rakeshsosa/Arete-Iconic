                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectAssetDetails}" var="type">
                                        ...
                                        <tr onclick="test('${type.assetCode}', '${type.assetName}', '${type.assetBuilding}', '${type.way}', '${type.assetArea}', '${type.blockNo}', '${type.assetPlotNo}', '${type.streetNo}', '${type.pinCode}', '${type.poBox}');">                                            
                                            <td class="center" style="text-align: left;">${type.assetCode}</td>
                                            <td class="center" style="text-align: left;">${type.assetName}</td>
                                            <td class="center" style="text-align: left;">${type.assetBuilding}</td>
                                            <td class="center" style="text-align: left;">${type.way}</td>
                                            <td class="center" style="text-align: left;">${type.assetArea}</td>
                                            <td class="center" style="text-align: left;">${type.blockNo}</td>
                                            <td class="center" style="text-align: left;">${type.assetPlotNo}</td> 
                                            <td class="center" style="text-align: left;">${type.streetNo}</td> 
                                            <td class="center" style="text-align: left;">${type.pinCode}</td> 
                                            <td class="center" style="text-align: left;">${type.poBox}</td>
                                        </tr>
                                    </c:forEach>
