    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5,val6,val7) {
                ...
                window.opener.document.getElementById('waterBillno').value = val2;
                window.opener.document.getElementById('electricityBillno').value = val3;
                window.opener.document.getElementById('actualRent').value = val4;
                window.opener.document.getElementById('extra2').value = val4;
                window.opener.document.getElementById('flatNo').value = val5;
                window.opener.document.getElementById('roomCode').value = val6;
                window.opener.document.getElementById('roomName').value = val7;
                window.close();
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                <thead>
                                    <tr class="headings">                                                   
                                        ...
                                        <th>Flat Code</th>       
                                        <th>Flat Name</th>
                                        <th>Room/Unit Code</th>
                                        <th>Room/Unit Name</th>
                                        <th>Utility No1.</th>
                                        <th>Utility No2.</th>
                                        <th>Actual Rent</th>
                                    </tr>
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${roomDetails}" var="type">

                                        <tr onclick="test('${type[1]}', '${type[5]}', '${type[6]}', '${type[7]}', '${type[1]}', '${type[3]}', '${type[4]}');">                                            
                                            ...
                                            <td class="center" style="text-align: left;">${type[4]}</td>
                                            <td class="center" style="text-align: left;">${type[5]}</td>
                                            <td class="center" style="text-align: left;">${type[6]}</td>
                                            <td class="center" style="text-align: right;">${type[7]}</td>
                                        </tr>
                                    </c:forEach>
