        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="propertyNameForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${assetDetails}" var="type">
                                        ...
                                        <tr onclick="window.opener.document.getElementById('Property').value = '${type.assetCode}';
                                             window.opener.document.getElementById('Unit').value = '${type.noOfFloors}';
                                                window.close();">                                           
