        ...
        <script type="text/javascript">
            ...
            function selectSubAssetDetails()
            {
                ...
                if ("Shared" == tenantType) {
                    ...
                    myWindow = window.open("../tenant/selectSubAssetDetails.htm?assetCode=" + assetCode + "&subclassifiedAstno="+subclassifiedAstno+"&tenantCategory=" + tenantCategory + "", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
                }
            }
...
//                }
            ...
            function mandTest1() {
                ...
                var tenantM = document.getElementById("ttenantFname").value &&
                        document.getElementById("ttenantLname").value 
                if (tenantM == '')
                {
                    callM1();
                    alert("Please Fill the fields to ADD");
                    $('#ttenantFname').focus();
                    return false;
                }else {
                return true;
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    ...
                                    <form class="form-inline row" id="tenantform" action="../tenant/tenantDetailsFormSubmit.htm"  method="post" enctype="multipart/form-data">
                                        <c:choose>
                                        ...
                                        <div class="box-header well" data-original-title onclick="call1();" style="cursor: pointer;">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" readonly="" id="tenantId" name="tenantId" maxlength="15" value="${list.tenantId}">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="tenantCrNo" name="tenantCrNo" maxlength="10" value="${list.tenantCrNo}">
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="tenantCrNo"  maxlength="10" value="">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                            3rd Party Tenants? <input type="checkbox" id="myCheck"  onclick="myFunction();">
                                            <div id="text" style="display:none">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">

                                                    <label class="control-label">Tenant First Name</label>
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails1) > 0}">
                                                            <c:forEach items="${tenantDetails1}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="tenantFname" name="ttenantFname" maxlength="50" value="${list.tenantFirstName}" onkeypress="return isNumberKey4(event)" onkeyup="firstToUpperCase();">
                                                                        <input type="hidden" class="form-control" id="tenantFname1" name="ttenantFname1" maxlength="50" value="${list.tenantFirstName}" >
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text" class="form-control" readonly="" id="ttenantFname" value="${list.tenantFirstName}">
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="ttenantFname" name="ttenantFname" maxlength="50" value="" onkeypress="return isNumberKey4(event)" onkeyup="firstToUpperCase();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails1) > 0}">
                                                            <c:forEach items="${tenantDetails1}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="tenantLname" name="ttenantLname" maxlength="50" value="${list.tenantLaststName}" onkeypress="return isNumberKey4(event)"  onkeyup="firstToUpperCase1();">
                                                                        <input type="hidden" class="form-control" id="tenantLname1" name="ttenantLname1" maxlength="50" value="${list.tenantLaststName}" >
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text" class="form-control" readonly="" id="ttenantLname" value="${list.tenantLaststName}">
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="ttenantLname" name="ttenantLname" maxlength="50" value="" onkeypress="return isNumberKey4(event)" onkeyup="firstToUpperCase1();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails1) > 0}">
                                                            <c:forEach items="${tenantDetails1}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="mobile" name="mobile" maxlength="10" value="${list.mobileNumber}" onkeypress="return isNumberKey(event)"  >
                                                                        <input type="hidden" class="form-control" id="mobile" name="mobile" maxlength="10" value="${list.mobileNumber}" >
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text" class="form-control" readonly="" id="mobile" value="${list.mobileNumber}">
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="mobile" name="mobile" maxlength="10" value="" onkeypress="return isNumberKey(event)" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails1) > 0}">
                                                            <c:forEach items="${tenantDetails1}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="email" name="email"  value="${list.emailId}" onchange="return validateEmailID(event);">
                                                                        <input type="hidden" class="form-control" id="email" name="email"  value="${list.emailId}" >
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text" class="form-control" readonly="" id="email" value="${list.emailId}">
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="email" name="email" value="" onchange="return validateEmailID(event);" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails1) > 0}">
                                                            <c:forEach items="${tenantDetails1}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                        <input type="text" class="form-control" id="nationality" name="nationality" maxlength="10" value="${list.nationality}" >
                                                                        <input type="hidden" class="form-control" id="nationality" name="nationality" maxlength="10" value="${list.nationality}" >
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text" class="form-control" readonly="" id="nationality" value="${list.nationality}">
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="nationality" name="nationality" maxlength="10" value=""  >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                                        ...
                                                                        <c:forEach items="${assetAttach}" var="list">
                                                                            ...
                                                                            <div class="removeattach" id="del${i}">
                                                                                <div id="field" class="col-md-12 col-sm-12">
                                                                                    ...
                                                                                    <a href="../tenant/tenantAttachDownload.htm?SNo=${list.SNo}"  >
                                                                                        <input type="text" id="imgtxt" name="imgtxt" readonly="" class="form-control capitalize " value="${list.tenfileName}" > <span> </span>
                                                                                    </a>                                                                        
                                                                        ...
                                                                        <c:forEach items="${assetAttach}" var="list">
                                                                            <div>
                                                                                <div id="field" class="col-md-12 col-sm-12">
                                                                                    ...
                                                                                    <a href="../assets/assetAttachDownload.htm?SNo=${list.SNo}"  >
                                                                                        <input type="text" id="imgtxt" name="imgtxt" readonly="" class="form-control capitalize " value="${list.tenfileName}" > 
                                                                                    </a><br><br/>
                                                                                </div>
                                                                            </div>
                                                                        </c:forEach>
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <button type="button" class="btn btn-succ" style="" onclick="return addOrderRow_test3rd();"><i class="fa fa-plus-circle" style="font-size: 15px"></i> ADD</button>
                                                ...
                                                <div style="overflow: scroll;height: auto;width: 98%;border: 1px solid gray;margin-left:10px;margin-right:10px;background:#f5f6f7;">
                                                    ...
                                                    <table  class="table table-striped responsive-utilities jambo_table" id="membertable11">
                                                        <thead>
                                                            <tr>
                                                                <th><i class="fa fa-trash fa-lg"></i></th>                                                
                                                                <th>Tenant's First Name</th>
                                                                <th>Tenant's Last Name</th>
                                                                <th>Mobile</th>
                                                                <th>E-Mail</th>
                                                                <th>Nationality</th>
                                                                <th>Attachments</th>
                                                        ...
                                                        <tbody id="resourcetable3rd">

                                                        </tbody>

                                                        <script>
                                                            var count = 0;
                                                            function addOrderRow_test3rd() {
                                                                //alert("hiii");
                                                                //$("#llId").dis
                                                                ...
                                                                var valid1 = true;
                                                                var x = document.getElementById('ttenantFname').value &&
                                                                        document.getElementById('ttenantLname').value
                                                                ...
                                                                if (valid1 == true) {
//                                                                    $('#ttenantFname').prop('disabled', 'disabled');
//                                                                    alert("1");
                                                                    var ttenantFname = document.getElementById('ttenantFname').value;
                                                                    var ttenantLname = document.getElementById('ttenantLname').value;
                                                                    var mobile = document.getElementById('mobile').value;
                                                                    var email = document.getElementById('email').value;
                                                                    var nationality = document.getElementById('nationality').value;
                                                                    var attachname1 = document.getElementById('attachname1').value;

                                                                    //alert(attachname1+"   attachname1");
                                                                    $('#resourcetable3rd').each(function () {
                                                                        var a = $(this).find('#ttenantFname').val();
                                                                        var a1 = $(this).find('#ttenantLname').val();
//                                                                        alert("7");
                                                                        if (a == ttenantFname) {
                                                                            alert('Tenant Name is already added!!!');
                                                                            document.getElementById('td').value = "";
                                                                            return false;
                                                                        } else if (a1 == ttenantLname) {
                                                                            alert('Tenant Name is already added!!!');
                                                                            document.getElementById('td').value = "";
                                                                            return false;
                                                                        } else {
...
//                                                                    alert("8");
                                                                    var table = document.getElementById("resourcetable3rd");
...
//                                                                    alert("9");
                                                                    tr.id = 'list_tr_' + slNo;
                                                                    tr.innerHTML = '<td align="center" class="tinput"><button type="button" class="fa fa-trash fa-lg-o" onclick="removeTableRow('+ slNo + ')" ></button> </td>' +
                                                                            '<td ><input class="form-control " style="text-align:left;" type="text" readonly name="ttenantFname" value="' + ttenantFname +
                                                                            '" style="border: none"></td><td><input class="form-control " style="text-align:left;" type="text"readonly name="ttenantLname"  value="' + ttenantLname +
                                                                            '" style="border: none"></td><td><input class="form-control " style="text-align:left;" type="text"readonly name="mobile" value="' + mobile +
                                                                            '" style="border: none"></td><td><input class="form-control " style="text-align:left;" type="text"readonly id="email" name="email" value="' + email +
                                                                            '" style="border: none"></td><td><input class="form-control " style="text-align:left;" type="text"readonly name="nationality" value="' + nationality +
//                                                                            '" style="border: none"></td><td><input class="form-control " style="text-align:left;" type="text"readonly name="attachname1" value="' + attachname1 +
                                                                            '" style="border: none"></td><td><input class="form-control " style="display: inline!important;" maxlength="20" type="text"readonly name="attachname1" value="' + attachname1 +
                                                                            '" style="border: none"></td>';
                                                                    count++;
                                                                    document.getElementById('ttenantFname').value = "";
                                                                    document.getElementById('ttenantLname').value = "";
                                                                    document.getElementById('mobile').value = "";
                                                                    document.getElementById('email').value = "";
                                                                    document.getElementById('nationality').value = "";
                                                                    document.getElementById('attachname1').value = "";
                                                                    //                                                              
...
//                                                                    alert("1");
                                                                    ...
                                                                    var llCategory = document.getElementById('llCategory').value;
