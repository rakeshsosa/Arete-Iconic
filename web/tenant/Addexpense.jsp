                ...
                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                    ...
                    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            ...
                            <br>
                            <div class="text-end">
                                <a class="btn btn-primary btn-sm" href="../tenant/expenseAmountList.jsp"><i class="bi bi-eye"></i> Show Expense Records</a>
                            </div>
                         </div>
                            <div class="pagetitle">
                            ...
                            <section class="section">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                     <form id="paymentform" class="row mt-3" action="../tenant/AddexpenceFormSubmit.htm">
                                                    <div class="row">
                                                      <div class="form-floating col-lg-4 mb-2 pick1"> 
                                                        
                                                <c:choose>
                                                    <c:when test="${fn:length(expenceAmountList) > 0}">
                                                        <c:forEach items="${expenceAmountList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" placeholder="fill" class="form-control datepicker1"autocomplete="off" name="startDate" id="startDate" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.fromDate}"/>" required onchange="return dateValidation()">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" placeholder="fill" class="form-control datepicker1" autocomplete="off" name="startDate" id="startDate" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.fromDate}"/>" required readonly="" onchange="return dateValidation()">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${fn:length(expenceAmountList) > 0}">
                                                        <c:forEach items="${expenceAmountList}" var="list">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <input type="text" placeholder="fill" class="form-control datepicker2" autocomplete="off" name="endDate" id="endDate" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.toDate}"/>" required readonly="" onchange="return dateValidation()">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${fn:length(expenceAmountList) > 0}">
                                                        <c:forEach items="${expenceAmountList}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" id="Property" name="Property" class="form-control" value="${list.property}"  placeholder="xyz" onclick="selectLead();" required> 
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" id="Property" name="Property" class="form-control" value="${list.property}" placeholder="xyz" onclick="selectLead();" readonly="" required> 
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(expenceAmountList) > 0}">
                                                        <c:forEach items="${expenceAmountList}" var="list">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <input type="text" id="Unit" name="Unit" class="form-control"  placeholder="xyz" value="${list.unit}" onclick="selectLead1();" readonly="" required> 
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    ...
                                                    <div class="form-floating col-lg-4  mb-2">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(expenceAmountList) > 0}">
                                                                <c:forEach items="${expenceAmountList}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control" placeholder="Category" readonly id="Expensetype" name="Expensetype" value="${list.expenceType}" required="">
                                                                            
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <input type="text"  placeholder="Category" class="form-control" readonly="" id="Expensetype" name="Expensetype" value="${list.expenceType}" required> 
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
                                                        ...
                                                        <label class="control-label">Expense type</label>
                                                           ...
                                                           <div class="form-floating col-lg-4 mb-2"> 
                                                        <input type="text" id="Paymenttype" name="Paymenttype" class="form-control" placeholder="xyz" required> 
                                                        <label for="custId"><span style="color: red;">*</span>Payment Type</label> 
                                                      </div>
                                                    </div>
                                                    
                                                     <div class="row">
                                                     <div class="form-floating col-lg-4 mb-2"> 
                                                        <input type="text" id="Vendor" name="Vendor" class="form-control" placeholder="xyz" required> 
                                                        <label for="custId"><span style="color: red;">*</span>Vendor </label> 
                                                    </div>
                                                         <div class="form-floating col-lg-4 mb-2"> 
                                                        <input type="text" id="Amount" name="Amount" class="form-control" placeholder="xyz" required onkeypress="isNumberKey(event);"> 
                                                        <label for="custId"><span style="color: red;">*</span>Amount </label> 
                                                    </div>
                                                         <div class="form-floating col-lg-4 mb-2"> 
                                                                   ...
                                                                   var rowlen = slNo1 +1 ;
                                                                    ...
                                                                    tr.id = 'list_tr_' + slNo;
                                                                            tr.innerHTML = '<td><input type="text" readonly class="form-control" name="userName" id="userid" value="' +rowlen  +
                                                                                    '" > </td><td><input class="form-control capitalize  " style="width: 100%;text-align: center" type="text"readonly name="submodulename" id="submodulename1" value="' + paymentType + '" style="border: none">\n\
                                                                                    <td><input class="form-control capitalize  " style="width: 100%;text-align: center" type="text" readonly name="tabname" id="tabname1" value="' + Vendor + '" style="border: none"></td>\n\
                                                                                      <td><input class="form-control capitalize  validate[required]" readonly style="width: 100%;text-align: center" type="text" name="Role" id="Role1" value="' + Amount + '"  style="border: none"></td>\n\
                                                  ...
                                                  <c:if test="${action eq 'view'}">
                                                            ...
                                                            <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                                                ...
                                                                <tbody id="resourcetable">
                                                                      <c:forEach items="${expenceTrackingId}" var="list">
                                                        <tr class="wrk">
                                                            ...
                                                            <td>
                                                                <input class="form-control validate[required]" style="width: 100%;"  readonly="" autocomplete="off" name="submodulename" id="submodulename" type="text" value="${list.paymentType}" >
                                                            </td> 

                                                            <td>
                                                                <input class="form-control validate[required]" style="width: 100%;"  readonly="" autocomplete="off" name="tabname" id="tabname" type="text" value="${list.vendor}" >
                                                            </td> 
                                                             <td>
                                                                <input class="form-control validate[required]" style="width: 100%;"  readonly="" autocomplete="off" name="Role" id="Role" type="text" value="${list.amount}" >
                                                            </td> 
                                                            <td>
                                                    ...
                                                    <c:if test="${action ne 'view' && action ne 'edit'}">
                                                       ...
                                                       <div class="col-md-12 col-sm-9 col-xs-12 col-md-offset-4">
                                                            ...
                                                            <a href="../tenant/expenseAmountList.htm" class="btn btn-danger">Cancel</a>
                                                        </div>
                                                    </c:if>
