...
<html lang="en">
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5, val6, val7, val8, val9, val10, val11, val12) {
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectTenant}" var="type">
                                        ...
                                        <tr onclick="test('${type.tenantCode}', '${type.tenantFname} ${type.tenantLname}', '${type.assetNames}', '${type.buildingNo}', '${type.blockNo}', '${type.streetNo}', '${type.plotNo}', '${type.advanceAmount}', '${type.billingCycle}', '${type.subclassifiedAstno}', '${type.flatNo}', '${type.assetName}');">                                            
                                            ...
                                            <td class="center" style="text-align: right;">${type.advanceAmount}</td> 
                                        </tr>
                                    </c:forEach>
