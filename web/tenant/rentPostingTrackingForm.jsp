...
function openPropertyList() {
    myWindow = window.open("../finance/selectPropertyDetailsInInvoice.htm", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
}
                    ...
                    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include
                                    page="../login/headerlink.htm?submodule=Rent Posting and Tracking&tab=Rent Posting and Tracking&pagetype=form" />
                            </div>
                            <div class="pagetitle">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="invoiceNo" maxlength="98" required />
                                            <label for="groupname"><span style="color: red;">*</span>Invoice</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="invoiceType" maxlength="98" required />
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        ...
                                        <div class="col-md-4 form-floating mb-3 pick55">
                                            <input style="background: #fff;" type="text" class="form-control datepicker55" readonly="" id="QuoExpiryDate" name="QuoExpiryDate" placeholder="" value="<%= (new
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="bookID" maxlength="98" onchange="return openPropertyList()" required />
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 mb-3 d-flex">
                                            <div class="col-md-2">
                                                <label value="yes" onchange="showSubscripeDetails(event)" class="toggleSwitch large" onclick="">
                                                    <input type="checkbox" id="amccustomToggle" name="amcRequired" value="yes" />
                                                    <span>
                                                        <span>OFF</span>
                                                        <span>ON</span>
                                                    </span>
                                        ...
                                        <div class="col-md-4" id="settingHide">
                                            ...
                                            <div>
                                                <label for="invoicenotify"> <input type="radio" name="invoicenotify" id="" /> Send Invoices Automatically</label> <br />
                                                <label for="invoicenotify"> <input type="radio" name="invoicenotify" id="" /> Create Draft Invoice And Send Manually</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body row">
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="invoice-detail-notes">
                                                    ...
                                                    <textarea id="invoice-notes" class="form-control" name="quotationNotes" maxlength="300" style="height: 88px;" maxlength="280"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-row disc-rate-container mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="disc" value="0" name="discountrate" placeholder="" onInput="calculateDiscount()" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                                                <div class="form-group form-row mb-3">
                                                    <label class="control-label col-sm-3" for="discount-rate">Amount Paid</label>
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="amounpaid" name="amounpaid" placeholder="" onInput="calculateBalanceDue()" value="0" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-5 float-right invoice-totals">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col text-right">
                                                    <span class="currency"></span>
                                                    <input type="text" readonly class="border-0" style="user-select: none; outline: none;" size="10" value="0.00" name="amoundpaidFinal" id="amounpaidfinal" />
                                                    <span class="currency-right"></span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col text-right">
                                                    <span class="currency"></span>
                                                    <input type="text" readonly class="border-0" style="user-select: none; outline: none;" size="10" value="0.00" name="balDue" id="balDue" />
                                                    <span class="currency-right"></span>
                                                </div>
                                            </div>
                                        </div>
