        ...
        <script>
            ...
            function reject(tenantCode, status, subAstno)
            {
                ...
                if (remarks == null || remarks == '') {
                    ...
                    window.location.href = "../tenant/tenantReject.htm?tenantCode=" + tenantCode + "&appstatus=" + status + "&appremarks=" + remarks + "&subAstno=" + subAstno + "";
                }
            }
        ...
        <div id="popUpDiv" style="display: none;"></div>
                   <jsp:include page="../login/menu.htm" />
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include page="../login/headerlink.htm?submodule=Tenant Details&tab=Approval 1&pagetype=form"/>
                            </div>
                            <div class="pagetitle">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="card-title">
                                                    <h5>Tenant Details Approval 1</h5>
                                                </div>
                                    <form class="form-inline row" id="tenantform" action="../tenant/tenantDetailsAppSubmit.htm"  method="post" enctype="multipart/form-data">
                                        ...
                                        <c:if test="${action eq 'edit'}">
                                                ...
                                                <c:if test="${fieldStatus_2 eq 'y'}">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                                ...
                                                                <c:forEach items="${landLordDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control"  readonly="" id="llId" name="llId" value="${list.landlordId}">
                                                                            <input type="hidden" id="llSno" name="llSno" value="">
                                                                            <input type="hidden" name="action" value="${action}">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <input type="text" class="form-control" readonly="" id="llId" value="${list.landlordId}">
                                                                            <input type="hidden" id="llSno" name="llSno" value="">
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            ...
                                                            <c:otherwise>
                                                                <input type="text" placeholder="" readonly class="form-control" id="llId" name="llId" value="">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                    </div></c:if>
                                                         ...
                                                         <c:choose>
                                                             <c:when test="${fn:length(tenantDetails) > 0}">
                                                                 <c:forEach items="${tenantDetails}" var="list">
                                                                     ...
                                                                     <c:set var="pk" value="${list.SNo}"></c:set>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control" readonly id="tenantCrNo" name="tenantCrNo" maxlength="40" value="${list.tenantCrNo}" onkeypress="return isNumberKey(event)">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" id="tenantCrNo" name="tenantCrNo" maxlength="40" value="" onkeypress="return isNumberKey(event)" onchange="fetchCrno();">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control" readonly="" id="extra1" name="extra1" value="${list.crIdNo}">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <input type="text" class="form-control" readonly="" id="extra1" value="${list.crIdNo}">
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control" id="totalAmount" name="totalAmount" readonly maxlength=14" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.totalAmount}" />" onkeypress="return check_digit(event, this, 10, 3);" >
                                                                        </c:when>
                                                                        <c:otherwise>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" id="totalAmount" name="totalAmount" maxlength="14" value="" onkeypress="return check_digit(event, this, 10, 3);" onchange="rentCalc();">
                                                            </c:otherwise>        
                                                        </c:choose>
                                            ...
                                            <c:if test="${action eq 'edit'}">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                    ...
                                                    <a href="../tenant/tenantDetailsAppList.htm" class="btn btn-danger">Cancel</a>
                                                </div>
                                                <!--</div>--> 
                                            </c:if>
                                        </c:if>
                                        <c:if test="${action eq 'edit1'}">
                                            ...
                                            <div class="box-header well" data-original-title onclick="call();" style="cursor: pointer;">
                                                ...
                                                <c:if test="${action eq 'edit1' || action eq 'view' }">
                                                    <c:if test="${fieldStatus_8 eq 'y'}">
                                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                            <c:if test="${mand_status_8 eq 'required'}">
                                                                <a style="color:red;">*</a>
