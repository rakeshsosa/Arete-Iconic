...
<html lang="en">
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5, val6, val7, val8, val9) {
...
//                window.opener.document.getElementById('billCycle').value = val8;
                window.opener.document.getElementById('subassetCode').value = val8;
                window.opener.document.getElementById('flotNo').value = val9;
//                window.opener.document.getElementById('assetName').value = val11;
                window.close();
            }
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectTenant}" var="type">
                                        ...
                                        <tr onclick="test('${type.tenantCode}', '${type.tenantFname} ${type.tenantLname}', '${type.assetNames}', '${type.buildingNo}', '${type.blockNo}', '${type.streetNo}', '${type.plotNo}', '${type.subclassifiedAstno}', '${type.flatNo}');">                                            <td class="center" style="text-align: left;">${type.tenantCode}</td>
