...
<jsp:include page="../login/menu.htm" />
   ...
   <main id="main" class="main">
       <div class="mt-3">
      <jsp:include page="../login/headerlink.htm?submodule=Manage Invoice&tab=Other Invoices&pagetype=list"/>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table datatable table-hover table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${otherInvoicesList}" var="type">
                                    <tr>
...
<!--                                        <td id="qtnno">Test</td>-->
                                        ...
                                        <td class="center">${type.pdChequeNo}</td>
                                        ...
                                        <td class="text-nowrap">
                                            <a class="fa fa-search-plus fa-lg" href="../finance/standardInvoiceFormView.htm?SNo=${type.SNo}" data-toggle="tooltip" data-bs-original-title="View" aria-label="View"></a>
                                            &nbsp;
                                            <a href="../finance/standardInvoiceFormEdit.htm?SNo=${type.SNo}" class="fa fa-pencil fa-lg" title="" data-toggle="tooltip" data-bs-original-title="Edit" aria-label="Edit"></a>
    ...
    <!--                                        <a
                                                href="../assets/assetsDetailsForm.htm?pk=59&amp;assetCode=PROPERTY-1&amp;action=edit"
     ...
     <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>Search, Edit, View, Print, Post Rent, Email and Cancel the Invoice Date, Number, PD Cheque, Property Name, Unit Number, Due Date, and Status. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
...
//    if (Array.isArray(selectedIds) && selectedIds.length) {
   if (parseInt(x) != 0) {
        swal({
            ...
            if (isConfirm) {
                 $("#rentInvoice").submit()
//                window.location.href = "../quotation/managingOrederReceivedStatus.htm";
            }
        });
    } else {
