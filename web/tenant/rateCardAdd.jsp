                    ...
                    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            <div>
                                ...
                                <br>
                                <div class="text-end"> 
                                    <a class="btn btn-primary btn-sm " href="../tenant/rateCardList.jsp"><i class="bi bi-eye"></i> Show Rate Card</a>
                                </div>
                            </div>
                            <div class="pagetitle">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form class="form-inline row" action="../tenant/serviceChargeList.jsp">
                                                       <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                                           <input type="text" placeholder="Org Name"  id="propertyname" readonly="" class="form-control" onclick="selectLead();"  name="propertyname" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                               ...
                                               <div class="col-md-4 form-floating mb-3">
                                                ...
                                                <div class="col-md-4 form-floating mb-3">
                                                   ...
                                                   <div class="col-md-4 form-floating mb-3">
                                                      ...
                                                      <div class="col-md-4 form-floating mb-3">
                                                        <input type="text" placeholder="Org Name" id="servicePrice" class="form-control"  name="servicePrice" maxlength="98" required onkeypress="return isNumberKey(event)" oninput="calculateFinalPrice()">
                                                        <label for="groupname"><span style="color:red">*</span>Service Price</label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <label for="groupname"> <span style="color:red">*</span>Service Billing Type</label><br>
                                                         <div class="col-md-12">
                                                             <input class="" type="checkbox" id="myCheck"> Hour Based &nbsp;
                                                             <input class="" type="checkbox" id="myCheck"> Monthly Based 
...
<!--                                                <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                               ...
                                               <div class="col-md-4  mb-3">
                                                   <input class="" type="checkbox" id="vatCheck" name="vatCheck"> 
                                                            <label class="" for="myCheck">Add VAT</label>                                                            
                                                        </div> 
                                             <div class="col-md-4 form-floating mb-3 vatperAmt">
                                                    <input type="text" id="vatamount" placeholder="Org Name" class="form-control"  name="vatamount" maxlength="98" required onkeypress="return isNumberKey(event)" oninput="calculateFinalPrice()">
                                                    <label for="groupname">VAT %</label>
                                                        ...
                                                        <div class="col-md-4 form-floating mb-3">
                                                            ...
                                                            <input type="text" id="finalPrice" name="finalPrice" placeholder="Org Name" class="form-control"  name="total" maxlength="98" readonly="" required onkeypress="return isNumberKey(event)">
                                                              <label for="groupname">Final Price</label>
                                                        </div> 
                                                    <br>
    ...
    function calculateFinalPrice(){
        ...
        if (vatamount === ''){
            document.getElementById("finalPrice").value = servicePrice;
        }
        else{
            debugger
            var percentage = (vatamount/100) * servicePrice;
            var finalPrice = percentage + Number(servicePrice);
