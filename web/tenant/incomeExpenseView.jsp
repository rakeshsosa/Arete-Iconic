            ...
            <div class="card-body">
               ...
               <form class="row validateForm" id="coustmermnForm" accept-charset="UTF-8" method="post" action="../Transactional/calendarPeriodFormSubmit.htm" enctype="multipart/form-data" commandName="calendarPeriod">
                                       ...
                                       <div class="col-md-4 form-floating mb-3">
                                           <input type="text" autocomplete="off" id="incomeExpense" readonly required="" name="incomeExpense" maxlength="10"  class="form-control capitalize validate[required]" value="" placeholder='fill'>   
                                         <label class="control-label"><span style="color:red">*</span>Income /Expense</label>
                                         </div>
                                        <div class="col-md-4 form-floating mb-3">
                                         <select class="form-control capitalize validate[required]" disabled required=""  id="serviceArea" name="serviceArea"  type="text" value="" maxlength="10" placeholder="" data-original-title="Parent Code">                                                
                   ...
                   <div class="col-md-4 form-floating mb-3" id="incomeAmtDiv" style="display: none;">
                                           <input type="text" readonly autocomplete="off" id="incomeAmount" readonly required name="incomeAmount" maxlength="50"  class="form-control capitalize validate[required]" value="" placeholder="Income Amount"> 
                                       <label class="control-label"><span style="color:red">*</span>Income Amount</label>
                                         ...
                                         <div class="col-md-4 form-floating mb-3" id="expenseAmtDiv" style="display: none;">
                                           <input type="text" readonly autocomplete="off" id="expenseAmount" required name="expenseAmount" maxlength="50"  class="form-control capitalize validate[required]" value="" placeholder="Expense Amount"> 
                                       <label class="control-label"><span style="color:red">*</span>Expense Amount</label>
                                          </div>
                                         <div class="col-md-4 form-floating mb-3">
                                           <input type="text" autocomplete="off" id="description" readonly name="description" maxlength="50"  class="form-control capitalize validate[required]" value="" placeholder="Description"> 
