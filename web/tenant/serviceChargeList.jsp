                    ...
                    <main id="main" class="main">
                        <div class="mt-3">
                            <ul class="nav nav-pills">
                                <li class="nav-item "><a class="nav-link active" href="../tenant/serviceChargeList.jsp">Service</a></li> &nbsp;
                                <li class="nav-item"><a class="nav-link" href="../tenant/rateCardList.jsp">Rate Card</a></li>&nbsp; 
                            </ul>  
                            <br>                           
                            <div class="text-end"> 
                                <a class="btn btn-primary btn-sm " href="../tenant/serviceChargeForm.jsp"><i class="bi bi-plus"></i> Create Service</a>
                            </div>
                        </div> 
...
<!--                                                <h5>Units Contract Template List</h5>-->
					...
					<thead>
                                                                <tr class="headings">
                                                                    <!--<th>Contract Code</th>-->
                                                                    <th>Adhoc Service Category</th>
                                                                    <th>Adhoc Service Name</th>
                                                                    <th>Adhoc Bill Type</th>
                                                                    <th>Bill Per Service Charge</th>
                                                                    <!--<th>Renewal Date</th>-->
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="even pointer"> 
                                                                            ...
                                                                            <td style="text-align: left;">house painting</td>
...
<!--                                                                             <a href="../insurance/tenantContractFormView.htm?contractCode=${list[0]}" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
                                                                            ...
                                                                            <a href="../tenant/serviceChargeView.jsp" class="fa fa-eye fa-lg" title="View"></a>&nbsp;
                                                                              <a href="../tenant/serviceChargeEdit.jsp" class="fa fa-edit fa-lg" title="Edit"></a>&nbsp;
                                                                             <a href="../tenant/rateCardAdd.jsp" class="fa fa-plus-circle fa-lg" title="Add Rate" data-toggle="tooltip"></a>&nbsp;
