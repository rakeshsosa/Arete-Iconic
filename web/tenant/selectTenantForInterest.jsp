...
//                window.opener.document.getElementById('billCycle').value = val8;
                window.opener.document.getElementById('advanceAmount').value = val8;
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectTenantForInterest}" var="type">

                                        <tr onclick="test('${type.tenantCode}', '${type.tenantFname} ${type.tenantLname}', '${type.assetNames}', '${type.buildingNo}', '${type.blockNo}', '${type.streetNo}', '${type.plotNo}', '${type.advanceAmount}');">                                          
