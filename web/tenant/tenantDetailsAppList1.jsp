...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <main id="main" class="main">
            <div>
                <jsp:include page="../login/headerlink.htm?submodule=Tenant Details&tab=Approval 2&pagetype=list"/>
            </div>
            <div class="pagetitle">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title"><h5>Tenant Details Approval 2 List</h5></div> 
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${tenantDetails}" var="list">
                                                ...
                                                <tr class="even pointer">                                                                   
                                                    ...
                                                    <td class=" "style="text-align: left;">${contractCode}</td>
                                                    ...
                                                    <td class=" last" style="width: 250px;text-align: center;">
                                                        <a href="../tenant/tenantDetailsAppForm1.htm?pk=${list.SNo}&llId=${list.llId}&contractPeriod=${list.contractPeriod}&assetName=${list.assetName}&subclassifiedAstno=${list.subclassifiedAstno}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
                                                        <c:if test="${list.appstatus ne 'CFO Approved'}">
                                                            <c:if test="${approve eq 'y'}">
                                                                <a href="../tenant/tenantDetailsAppForm1.htm?pk=${list.SNo}&llId=${list.llId}&contractPeriod=${list.contractPeriod}&assetName=${list.assetName}&subclassifiedAstno=${list.subclassifiedAstno}&action=edit" class="fa fa-check-circle-o fa-lg" title="Need Approval" style="">
                                            ...
                                            <c:if test="${TenantCode ne null || TenantCode ne ''}">
                                                    ...
                                                    <c:forEach items="${tenantDetails1}" var="list">
                                                        ...
                                                        <tr class="even pointer">                                                                   
                                                            ...
                                                            <td class=" "style="text-align: left;">${list.appstatus}</td>
                                                            <td class=" last" style="width: 250px;text-align: center;">
                                                                <a href="../tenant/tenantDetailsAppForm1.htm?pk1=${list.SNo}&llId1=${list.llId}&contractPeriod1=${list.contractPeriod}&assetName1=${list.assetName}&subclassifiedAstno1=${list.subclassifiedAstno}&action=view1" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
                                                                <c:if test="${list.appstatus ne 'CFO Approved'}">
                                                                    <c:if test="${approve eq 'y'}">
                                                                        <a href="../tenant/tenantDetailsAppForm1.htm?pk1=${list.SNo}&llId1=${list.llId}&contractPeriod1=${list.contractPeriod}&assetName1=${list.assetName}&subclassifiedAstno1=${list.subclassifiedAstno}&action=edit1" class="fa fa-check-circle-o fa-lg" title="Need Approval" style="">
