                        ...
                        <div class="row top_tiles">
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Penalty&tab=Penalty&pagetype=list"/>
                                        <div class="row">
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${penaltyDetails}" var="list">
                                                                    <tr class="even pointer">                                                                   
                                                                        <td class=" " style="text-align: left;"><fmt:formatDate pattern="dd-MMM-yyyy" value="${list.penaltyFromDate}"/></td>
                                                                        <td class=" " style="text-align: left;"><fmt:formatDate pattern="dd-MMM-yyyy" value="${list.penaltyToDate}"/></td>
                                                                        <td class=" " style="text-align: left;">${list.penaltyType}</td>
...
<!--                                                                            <a href="../tenant/penaltyDetailsForm.htm?pk=${list.SNo}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;-->
                                                                            ...
                                                                            <a href="../tenant/penaltyDetailsForm.htm?pk=${list.SNo}&action=edit" class="fa fa-pencil fa-lg"title="Edit"></a>&nbsp;
                                                                            <%--</c:if>--%>
                                                                        </td>
                                                                    </tr>
