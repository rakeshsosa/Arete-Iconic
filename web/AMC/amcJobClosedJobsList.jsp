<%-- Document : assetDetailsList Created on : Sep 15, 2016, 10:42:18 AM Author : Kondal Reddy N --%>
    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <body class="nav-md">
                    ...
                    <main id="main" class="main">
                        <div class="mt-3">
                           <jsp:include page="../login/headerlink.htm?submodule=AMC Job Tracking&tab=Closed Jobs&pagetype=list"/>
                        </div>
                        <div class="pagetitle">
        ...
        tippy('#information', {
            content: '<p>Search and View  Property Name, AMC Id, AMC Type, Service, Priority, Due date and Status.</p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
