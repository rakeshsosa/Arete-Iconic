<%-- 
    Document   : uomMasterPopup
    Created on : 12 Oct, 2016, 3:12:58 PM
    ...
    <body>
        <script>
            function test(val1, val2, val3) {
                window.opener.document.getElementById('uomId').value = val1;
                window.opener.document.getElementById('itemUom').value = val2;
                window.opener.document.getElementById('uomDesc').value = val3;
                window.close();
            }
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:forEach items="${uomList}" var="type">
                                        <tr onclick="test('${type.uomId}', '${type.uomName}', '${type.uomDesc}');">
                                            <td class="center" >${type.uomId}</td>
                                            <td class="center" >${type.uomName}</td>
                                            <td class="center" >${type.uomDesc}</td>
                                        </tr>
                                    </c:forEach>
