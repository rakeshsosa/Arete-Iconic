        ...
        <main id="main" class="main">
            <div class="mt-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" href="../insurance/contractApprovalList.htm">Pending Approval</a>
                    </li>
                    <!--                                        <li class="nav-item">
                                        ...
                                        <c:forEach items="${contCreat}" var="list">
                                            <tr class="even pointer">                                                                   
                                                ...
                                                <c:if test="${approve eq 'y'}">
                                                    <a class="fa fa-check-circle-o fa-lg" style="color: green;" title="Need Approval" class=""  href="../insurance/contractApprovalForm.htm?contractCode=${list.contractCode}">
                                                                                                 
                                                    </a></c:if>
                                                </td>-->
                                                    <td style="text-align: left;" class=" ">

                                                        <a class="fa fa-check-circle-o fa-lg" style="color: green;" title="Need Approval" href="../insurance/contractApprovalForm.htm?contractCode=${list.contractode}">
