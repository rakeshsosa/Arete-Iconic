        ...
        <main id="main" class="main">
            <div class="mt-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../insurance/approvedContraList.htm">Approved Contract List</a>
                    </li>
                    <li class="nav-item">
...
<!--                                                                        <td style="">
                                                                            <a href="../insurance/acceptedContractView.htm?contractCode=${list.contractode}" class="fa fa-eye fa-lg"title="View"></a>&nbsp; 

                                                                            <a href="../insurance/contractNoEditForm.htm?pk=${list.sno}&contractCode=${list.contractode}&action=edit1" class="fa fa-pencil fa-lg"title="Edit"></a>&nbsp;    
