<%-- 
    Document   : acceptedContractView
    Created on : 11 Nov, 2016, 6:51:31 PM
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Contract Creation&tab=Approved Contract List&pagetype=form"/>

                                <div class="x_title">
                                    <h2>Approved Contract Form</h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="contractCreation" class="form-inline" action="../insurance/contractCreationFormSubmit.htm" method="post" enctype="multipart/form-data">
                                        ...
                                        <c:forEach items="${contract}" var="type">
                                            <c:set var="approvar2Remark" value="${type.approvar2Remark}"/>
                                            <c:set var="approvar3Remark" value="${type.approvar3Remark}"/>
                                                    ...
                                                    <c:when test="${fn:length(subAssetDetail) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                ...
                                                                <input type="hidden" placeholder="" class="form-control"  id="assetCode" >
                                                            </c:when>
                                                            <c:otherwise>

                                                                <input type="text" class="form-control"  readonly="" name="assetName" value="${assetName}">  
                                                            </c:otherwise> 
                                                        </c:choose>

                                                    </c:when>
                                                    <c:otherwise> 
                                                        <input type="text" placeholder="Select Property" class="form-control" ${mand_status_614}  id="assetName" name="assetName"  readonly="" value="${assetName}">
                                        ...
                                        <c:if test="${fieldStatus_615 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(subAssetDetail) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                ...
                                                                <input type="text" class="form-control"  readonly="" id="subAssetName" name="flatCod" value="${list[1]}" > 
                                                                <input type="hidden" placeholder="" class="form-control"  id="subAssetCode" >
                                                            </c:when>
                                                            <c:otherwise>
                                                    ...
                                                    <c:otherwise> 
                                                        <input type="text"  class="form-control" ${mand_status_615}  id="subAssetName" name="subAssetName"  readonly="" value="${subAssetName}">
                                        ...
                                        <c:if test="${fieldStatus_106 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">     
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <textarea  class="form-control" id="remarks"  rows="1" style="resize: none" maxlength="300"></textarea>
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
...
//                                     
                                                    ...
                                                    <script>
                                                        //To delete Grid date in edit form
