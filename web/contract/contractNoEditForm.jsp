<%-- 
    Document   : contractNoEditForm
    Created on : 16 Dec, 2016, 12:43:38 PM
    Author     : ebs-sdd10
--%>
...
//                    (document.getElementById('contractTitle').value) &&
        ...
        function test()
        {
            ...
            var desc = document.getElementById("contStatus").value;
            var desc1 = document.getElementById("contStatus1").value;
            var sasset = document.getElementById("subAssetName").value;
            var sasset1 = document.getElementById("subAssetName1").value;
            var rmark = document.getElementById("remarks").value;
            var rmark1 = document.getElementById("remarks1").value;
            var cat = document.getElementById("contractCategory").value;
            var cat1 = document.getElementById("contractCategory1").value;
            var ren = document.getElementById("contReviewDate").value;
            var ren1 = document.getElementById("contReviewDate1").value;
            var start = document.getElementById("contStartDate").value;
            var start1 = document.getElementById("contStartDate1").value;
            var end = document.getElementById("contEndDate").value;
            var end1 = document.getElementById("contEndDate1").value;
            var ctype = document.getElementById("contClassification").value;
            var ctype1 = document.getElementById("contClassification1").value;
            var insu = document.getElementById("insuranceTagged").value;
            var insu1 = document.getElementById("insuranceId").value;
            var asset = document.getElementById("assetName").value;
            var asset1 = document.getElementById("assetName1").value;
            
            var attach = document.getElementById("attachname1").value;
//            var attach1 = document.getElementById("attsno").value;





            if (comp !== comp1 || rmark !== rmark1 || desc !== desc1 || ren !== ren1 || start !== start1 || end !== end1 || cat !== cat1 || ctype !== ctype1 || insu !== insu1 || asset !== asset1 || sasset !== sasset1 || attach !== '') {
                if (confirm('Do you really want to Save this updated record')) {
                    document.forms["contractCreation"].submit();
                    return true;
                } else {
                ...
                alert("You have not changed anything,please press Cancel!");
            }
        ...
        function SelectProperty() {
            ...
            myWindow = window.open("../insurance/propTagPopUp.htm?", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=99,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
        }
...
//            if (diff1 < 0 || diff2 < 0)
//            {
//                alert("Review Date Should Be Greater Than Start Date and End Date");
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="contractCreation" class="form-inline" action="../insurance/contractNoEditFormSubmit.htm" method="post" enctype="multipart/form-data">
                                        <c:choose>
                                                        ...
                                                        <c:forEach items="${catId}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="hidden"  class="form-control" readonly=""  ${mand_status_96}   id="categoryId" name="categoryId"  value="${list[1]}"> 
                                                                    <input type="hidden" class="form-control" ${mand_status_96} readonly="" id="contractCategory1" name="contractCategory1" value="${list[0]}" onclick="SelectCategory();">
                                                                    <input type="hidden"  class="form-control" readonly=""  ${mand_status_96}   id="categoryId1" name="categoryId1"  value="${list[1]}"> 
                                                                </c:when>
                                                                <c:otherwise>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(contCreat) > 0}">
                                                        <c:forEach items="${contCreat}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    <input class="form-control  input-xlarge" ${mand_status_97} name="contStartDate" id="contStartDate" readonly type="text" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.contStartDate}"/>" onclick="NewCssCal('contStartDate', 'ddMMMyyyy', '', '', '', '', '');" onchange="dateValid();"> 
                                                                    <input class="form-control  input-xlarge" ${mand_status_97} readonly type="hidden" name="contStartDate1" id="contStartDate1" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.contStartDate}"/>">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>
                                                        <input class="form-control  input-xlarge" ${mand_status_97} id="contStartDate" name="contStartDate"   placeholder="Select Date" readonly="" type="text" onclick="NewCssCal('contStartDate', 'ddMMMyyyy', '', '', '', '', '');" onchange="dateValid();">                                                    
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(contCreat) > 0}">
                                                        <c:forEach items="${contCreat}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    <input class="form-control  input-xlarge" ${mand_status_98} name="contEndDate" id="contEndDate" readonly type="text" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.contEndDate}"/>" onclick="NewCssCal('contEndDate', 'ddMMMyyyy', '', '', '', '', '');" onchange="dateValid();"> 
                                                                    <input class="form-control  input-xlarge" ${mand_status_98} readonly type="hidden" name="contEndDate1" id="contEndDate1"value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.contEndDate}"/>">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>
                                                        <input class="form-control  input-xlarge" ${mand_status_98} id="contEndDate" name="contEndDate"  placeholder="Select Date" readonly="" type="text" onclick="NewCssCal('contEndDate', 'ddMMMyyyy', '', '', '', '', '');" onchange="dateValid();">                                                    
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                                        ...
                                                        <c:forEach items="${contCreat}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input style="margin-top:-10px;" class="form-control  input-xlarge" ${mand_status_99} readonly type="hidden" name="contReviewDate1" id="contReviewDate1" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.contReviewDate}"/>">
                                                                </c:when>
                                                                <c:otherwise>
                                                        ...
                                                        <c:forEach items="${contCreat}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="hidden" class="form-control" ${mand_status_100}  name="contStatus1" id="contStatus1" value="${list.contStatus}" >
                                                        ...
                                                        <c:forEach items="${classId}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="hidden" placeholder="" class="form-control"  id="classificationId" name="classificationId" value="${list[1]}">
                                                                    <input style="margin-top: -10px;" type="hidden" class="form-control" ${mand_status_101} readonly="" id="contClassification1" name="contClassification1" value="${list[0]}" onclick="SelectClassif();">
                                                                    <input type="hidden" placeholder="" class="form-control"  id="classificationId1" name="classificationId1" value="${list[1]}">
                                                                </c:when>
                                                                <c:otherwise>
                                                        ...
                                                        <c:forEach items="${contCreat}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Select Insurance" readonly="" id="insuranceTagged" name="insuranceTagged" value="" onclick="SelectInsurance();"> 
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="hidden" placeholder="" class="form-control"  id="assetCode" name="assetCode" value="${list[2]}">
                                                                       <input type="hidden" class="form-control" placeholder="Select Property" readonly="" id="assetName1" name="assetName1" value="${list[0]}" onclick="SelectProperty();"> 
                                                                    <input type="hidden" placeholder="" class="form-control"  id="assetCode1" name="assetCode1" value="${list[2]}">
                                                                </c:when>
                                                                <c:otherwise>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">
                                                                    ...
                                                                    <input type="hidden" placeholder="" class="form-control"  id="subAssetCode" name="subAssetCode" value="${list[3]}">
                                                                     <input type="hidden" class="form-control"  readonly="" id="subAssetName1" name="subAssetName1" value="${list[1]}" > 
                                                                    <input type="hidden" placeholder="" class="form-control"  id="subAssetCode" name="subAssetCode" value="${list[3]}">
                                                                </c:when>
                                                                <c:otherwise>
                                                        ...
                                                        <c:forEach items="${contCreat}" var="list">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit1'}">  
                                                                    ...
                                                                    <textarea name="remarks" id="remarks"  class="form-control" maxlength="300" rows="1" style="resize: none">${list.remarks}</textarea>
                                                ...
                                                <div style="overflow: scroll;height: auto;width: 98%;border: 1px solid gray;margin-left:10px;margin-right:10px;background:#f5f6f7;">
                                                    <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                                        <thead>
                                                            <tr>
                                                                <th style=" ">Action</th>                                                           
                                                                <th style=" "><span style="color: red">*</span>Contract Term (YEAR)</th>                                              
                                                        ...
                                                        <script>
                                                            ...
                                                            function addToGrid(val1, val2, val3, val4, val5) {
                                                                ...
                                                                if (valid1 === true) {
                                                                    ...
                                                                    if (val1 != "")
                                                                    {
                                                                        ...
                                                                        <input name="contractTitle" type="hidden" value="' + contractTitle + '"></td>' +
                                                                                '<td class="tinput"><input style="width: 100%; text-align:left;" class="form-control" type="text" readonly name="contractTerm" id="contractTerm" value="' + contractTerm + '" style="border: none"></td>' +
                                                                    ...
                                                                    document.getElementById('contractTerm').disabled = true;
                                                            ...
                                                            function removeRow(id) {
                                                                ...
                                                                if (count == 0)
                                                                {
                                                                    ...
                                                                    document.getElementById('contractTerm').disabled = false;
                                                        ...
                                                        <tbody id="resourcetable">
                                                            ...
                                                            <c:forEach items="${contraEditList}" var="type">
                                                                <tr class="item-row"> 
                                                                    ...
                                                                    <td><input class="form-control" style="text-align: left;width:100%;"  name="contClassification" id="contClassification" readonly autocomplete="off" type="text" min="8" maxlength="11" value="${type[9]}">
                                                                        <input class="form-control" style="text-align: left;width:100%;"  name="classificationId" id="classificationId" readonly autocomplete="off" type="hidden" min="8" maxlength="11" value="${type[0]}"></td>
                                                                    <td><input class="form-control" style="text-align: left;width:100%;" name="insuranceTagged" id="insuranceTagged" readonly autocomplete="off" type="text" maxlength="30" value="${type[12]}">
                                                                        <input class="form-control" style="text-align: left;width:100%;" name="insuranceId" id="insuranceId" readonly autocomplete="off" type="hidden" maxlength="30" value="${type[7]}"></td>
                                        ...
                                        <c:if test="${action eq 'edit1'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                <button type="button" id="save1" class="btn btn-primary" style="" onclick="test();">Save</button>
                                                <a href="../insurance/approvedContraList.htm" class="btn btn-danger">Cancel</a>
                                            </div>
