...
<!--          <div class="col-md-12">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                                                ...
                                                                <input type="text" class="form-control" readonly="" id="" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.startDate}"/>">
                                                            
                                            <label class="control-label">Contract Start Date <a class="text-danger">*</a></label>
                                        </div>
                  <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                            
                                                                <input type="text" class="form-control" readonly="" id="" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.endDate}"/>">
                                                            
                                            <label class="control-label">Contract End Date <a class="text-danger">*</a></label>
                                        </div>
                  <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                            
                                                                <input type="text" class="form-control" readonly="" id="" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.renewalDate}"/>">
      ...
      <div class="accordion-body row">
          <c:forEach items="${additionalDetailsList}" var="list">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                                                ...
                                                                <input type="text" class="form-control" readonly id="" name="" value="${list.maintenanceCharges}" autocomplete="off">
          ...
          <div class="col-md-12">
              <table class="table table-bordered mb-3" id="poCheckTable">
                  ...
                  <tbody>
                      ...
                      <tr>
                              ...
                              <td><input type="text" readonly name="pdCheque" value="${list.pdCheque}"></td>
                              <td><input type="date" readonly name="pdDate" value="${list.pdDate}"></td>
                          <td><i class="fa fa-plus text-primary" onclick="addBasicDetailsRow(event)"></i> &nbsp; <i onclick="removeBasicDetailsRow(event)" class="fa fa-times text-danger"></i></td>
           ...
           <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                                                ...
                                                                <input type="text" class="form-control" readonly="" id="" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.billingDueDate}"/>">
          ...
          <div class="col-md-12">
              <table class="table table-bordered mb-3 table-responsive" id="poCheckTable">
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td><input type="text" name="serviceName" readonly value="${list.serviceName}"></td>
                          <td><input type="text" name="description" readonly value="${list.description}"></td>
                          <td><input type="text" name="serviceCharge" readonly value="${list.serviceCharge}"></td>
                          <td><input type="text" name="fixedServiceCharge" readonly value="${list.fixedServiceCharge}"></td>
                          <td><i class="fa fa-plus text-primary" onclick="addBasicDetailsRow(event)"></i> &nbsp; <i onclick="removeBasicDetailsRow(event)" class="fa fa-times text-danger"></i></td>
                      </tr>
                      </c:forEach>
                  </tbody>
          ...
          <div class="col-md-12">
              <table class="table table-bordered mb-3" id="poCheckTable">
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td><input type="text" name="utilityCategory" readonly value="${list.utilityCategory}"></td>
                          <td><input type="text" name="utilityName" readonly value="${list.utilityName}"></td>
                          <td><i class="fa fa-plus text-primary" onclick="addBasicDetailsRow(event)"></i> &nbsp; <i onclick="removeBasicDetailsRow(event)" class="fa fa-times text-danger"></i></td>
                      </tr>
                      </c:forEach>
                  </tbody>
