<%-- 
    Document   : complaintApprovalList
    Created on : 3 Oct, 2016, 2:43:43 PM
    Author     : ebs-sdd27
--%>
    ...
    <body class="nav-sm">
         ...
         <jsp:include page="../login/menu.htm" />
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include page="../login/headerlink.htm?submodule=Complaints&tab=Approval 1"/>
                            </div>
                            <div class="pagetitle">
                                                        ...
                                                        <c:set var="approve" value="${type.approve}"></c:set>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <c:forEach items="${complaintList}" var="type">
                                                                    ...
                                                                    <c:if test="${type.attribute2 ne 'GFC Approved' && type.attribute2 ne 'Rejected'}">
                                                                        <tr>
                                                                            ...
                                                                            <td class="center" style="text-align: left;">
                                                                                ...
                                                                                <%--<c:if test="${type.attribute2 eq 'Approved'}">--%>     

                                                                                <%--<c:if test="${type.recordStatus ne 'Approved'}">--%>     
                                                                                <c:if test="${type.attribute2 ne 'GFC Approved'}"> 
                                                                                    <c:if test="${approve eq 'y'}">
                                                                                        <a class="fa-file-exclamation" title="Need Approval" href="../CRM/complaintApprovalForm.htm?sno=${type.sno}&action=edit">
