      ...
      <div class="accordion-body row">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                            <c:choose>
                                                ...
                                                <c:otherwise>                                                    
                                                    <input type="text" placeholder="Fill" class="form-control" id="baserent" name="baserent" value="">
                                                </c:otherwise>        
                                            </c:choose>
      ...
      <div class="accordion-body row">
          ...
          <hr class="my-3">
                                    ...
                                    <table class="table table-bordered my-3" id="basicDetailsTable">
                                        <thead>
                                        <th>Contact Person <a class="text-danger">*</a></th>
                                        <th>Registered Email Id <a class="text-danger">*</a></th>
                                        <th>Phone No <a class="text-danger">*</a></th>
                                        <th>Action</th>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input maxlength="10" type="text" placeholder="Fill" class="form-control" id="phoneNo" name="phoneNo" value="">
                                                </td>
                                                <td>
