    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5) {
                window.opener.document.getElementById('subClassifiedAssetName').value = val1;
                ...
                window.opener.document.getElementById('subassetCode').value = val4;
                window.opener.document.getElementById('actualRent').value = val5;
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectSubAssetDetails}" var="type">
                                        ...
                                        <tr onclick="test('${type.subAssetName}', '${type.utilityNo1}', '${type.utilityNo2}', '${type.subAssetCode}', '${type.actualRent}');">                                            
                                            ...
                                            <td class="center" style="text-align: left;">${type.actualRent}</td>
                                        </tr>
                                    </c:forEach>
