    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4) {
                window.opener.document.getElementById('campaignMediaCode').value = val1;
                window.opener.document.getElementById('campaignMedia').value = val2;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${campaignDetails}" var="type">

                                        <tr onclick="test('${type.mediaCode}', '${type.mediaName}', '${type.mediaDesc}');">                                            
                                            <td class="center" style="text-align: left;">${type.mediaCode}</td>
                                            <td class="center" style="text-align: left;">${type.mediaName}</td>
                                            <td class="center" style="text-align: left;">${type.mediaDesc}</td>
                                        </tr>
                                    </c:forEach>
