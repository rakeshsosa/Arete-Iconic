...
var rowTemp9 = [
    '<tr class="item-recipe">' +
            '<td onclick=""><button type="button" id="deleteRecipe"><i class="fa fa-trash fa-lg-o"></i></button></td>' +
            '<td>' + catadd + '</td>' +
            '<td><input name="sn" type="hidden" value="-1"><input name="sn1" type="hidden" value="-1"><input class="form-control ui-autocomplete-input validate[required]" maxlength="100" required name="itemnameMenu" id="itemnameMenu"  onkeypress="" type="text" value=""></td>' +
            '<td><input class="form-control validate[required,custom[notzero]]"  autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="menuItemQty" id="menuItemQty" type="text" value=""></td>' +
            ...
            '<td><input class="form-control validate[required]" readonly onkeypress="return check_digit(event, this, 10, 3);" autocomplete="off" name="menuPrice" id="menuPrice" type="text" value=""></td>' +
            '<td><input class="form-control validate[required]" readonly autocomplete="off" name="menuPriceT" id="menuPriceT" type="text" value="">' +
