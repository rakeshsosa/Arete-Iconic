<%-- 
    Document   : quoteApprovalProcessViewForm1
    Created on : 17 Nov, 2016, 2:37:15 PM
    Author     : Garun Mishra
--%>
...
//            }
        ...
        <script>
            ...
            function reject(status)
            {
                ...
                if (remarks == null || remarks == '') {
                    ...
                    window.location.href = "../CRM/quoteReject1.htm?tenantQuoteCode=" + tenantQuoteCode + "&appstatus=" + status + "&appremarks=" + remarks + "";
                }
            }
        </script>
    </head>
    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            <div>
                       <jsp:include page="../login/headerlink.htm?submodule=Rent Quote&tab=Approval 2&pagetype=form"/>     
                            </div>
                            <div class="pagetitle">
                        ...
                        <form class="row" id="userform" action="../CRM/approveRentQuoteSubmit1.htm"  method="post" enctype="multipart/form-data">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
	  ...
	  <c:if test="${fn:length(message) > 0}"><a class="successalert" style="margin-left: 250px;">${message}</a></c:if>
                                        ...
                                        <tbody> 
                                            <c:forEach items="${quoteList}" var="list">
                                               ...
                                               <c:set var="gfcremarks" value="${list.approverRemarks2}" /> 
                                                ...
                                                <c:set var="cforemarks" value="${list.approverRemarks2}" /> 


                                                <c:if test="${gfcremarks ne 'null'}">
                                                    <tr>
                                                        <td ><b>GFC</b></td>
                                                        <!--<td class="" style="text-align: center;">${list.userId}</td>-->
                                                        <td > <fmt:formatDate pattern="dd-MMM-yyyy" value="${list.lastmodefiedDate}" /></td>
                                                        <td >${gfcremarks}</td>
                                                    </tr>
                                                </c:if>
                                                <c:if test="${cforemarks ne 'null'}">
                                                    <tr>
                                                        <td ><b>CFO</b></td>
                                                        <!--<td class="" style="text-align: center;">${list.userId}</td>-->
                                                        <td class="" > <fmt:formatDate pattern="dd-MMM-yyyy" value="${list.lastmodefiedDate}" /></td>
                                                        <td class="" >${cforemarks}</td>
                                                    </tr>
                                                </c:if>
