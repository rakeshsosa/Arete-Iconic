<%-- 
    Document   : quoteApprovalProcessForm
    Created on : 17 Sep, 2016, 11:17:36 AM
    Author     : ebs-sdd27
--%>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#llContactno").change(function () {
                    var phoneremarks = $('input[name="llContactno"]').val();
                    intRegex = /[0-9 -()+]+$/;
...
//                    document.getElementById("contractSigningDate").value = '';
        ...
        <script>
            ...
            //method for Reject the Approval              
            function reject(status) {

                var remarks = $('#approverRemarks').val();
                var tenantQuoteCode = $('#tenantQuoteCode').val();

                if (remarks == null || remarks == '') {
                    alert('Please fill the Remarks');
                    return  false;
                } else {
                    window.location.href = "../CRM/quoteReject.htm?tenantQuoteCode=" + tenantQuoteCode + "&appstatus=" + status + "&appremarks=" + remarks + "";
                }
            }

            //method for Recheck at the Approval 1              
            function quoteRecheck(status) {
                var remarks = $('#approverRemarks').val();
                var tenantQuoteCode = $('#tenantQuoteCode').val();
                ...
                if (remarks == null || remarks == '') {
                    ...
                    window.location.href = "../CRM/quoteRecheck.htm?tenantQuoteCode=" + tenantQuoteCode + "&appstatus=" + status + "&appremarks=" + remarks + "";
                }
            }
            function quotesubmit() {
                ...
                if (remarks == null || remarks == '') {
                    ...
                    document.forms["quotesubmit"].submit();
                    return true;
                }
            }
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Rent Quote&tab=Approval 1&pagetype=form"/>
                                <div class="x_title">
                                    <h2>Rent Quote Details</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <form class="form-inline" id="quotesubmit" action="../CRM/approveRentQuoteSubmit.htm"  method="post" enctype="multipart/form-data">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                        <textarea style="resize: none" type="text" rows="1" maxlength="500" class="form-control" ${mand_status_12} readonly="" id="jointeeAddress1" name="jointeeAddress1" value="${list.jointeeAddress1}">${list.jointeeAddress1}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <textarea style="resize: none" rows="1" maxlength="500" type="text" class="form-control" readonly="" id="jointeeAddress1" value="${list.jointeeAddress1}">${list.jointeeAddress1}</textarea>
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" rows="1" maxlength="500" type="text" placeholder="" class="form-control" ${mand_status_12} id="jointeeAddress1" name="jointeeAddress1" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                        <textarea style="resize: none" rows="1" maxlength="500" type="text" class="form-control" ${mand_status_14} readonly="" id="jointeeAddress2" name="jointeeAddress2" value="${list.jointeeAddress2}">${list.jointeeAddress2}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <textarea style="resize: none" rows="1" maxlength="500"  type="text" class="form-control" readonly="" id="jointeeAddress2" value="${list.jointeeAddress2}">${list.jointeeAddress2}</textarea>
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" type="text" rows="1" maxlength="500"  placeholder="" class="form-control" ${mand_status_14} id="jointeeAddress2" name="jointeeAddress2" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                        <textarea style="resize: none" rows="1" maxlength="300" type="text" class="form-control" ${mand_status_18} readonly="" id="companyAddress" name="companyAddress" value="${list.companyAddress}">${list.companyAddress}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <textarea style="resize: none" rows="1" maxlength="300" type="text" class="form-control" readonly="" id="companyAddress" value="${list.companyAddress}">${list.companyAddress}</textarea>
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" rows="1" maxlength="300" type="text" placeholder="" class="form-control" ${mand_status_18} id="companyAddress" name="companyAddress" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                        <textarea type="text" class="form-control" rows="1" maxlength="300" style="resize: none" ${mand_status_24} readonly="" id="correspondenceAddress" name="correspondenceAddress" value="${list.correspondingAddress}">${list.correspondingAddress}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <textarea type="text" class="form-control" rows="1" maxlength="300" style="resize: none" readonly="" id="correspondenceAddress" value="${list.correspondingAddress}">${list.correspondingAddress}</textarea>
                                                                    </c:otherwise> 
                                                                </c:choose>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>                                                    
                                                            <textarea type="text" placeholder="" rows="1" maxlength="300" style="resize: none" class="form-control" ${mand_status_24} id="correspondenceAddress" name="correspondenceAddress" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'||action eq 'recheck'}">
                                                                        <input type="text" class="form-control" ${mand_status_31} readonly="" id="subclassifiedAstno" name="subclassifiedAstno" value="${subAssetName1}" onkeypress="return isNumberKey3(event)" autocomplete="off">
                                                                    </c:when>
                                                                    <c:otherwise>
                                        ...
                                        <div class="box-header well" data-original-title onclick="call3();" style="cursor: pointer;display: none;">
                                            ...
                                            <c:if test="${fieldStatus_29 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <label class="control-label" style="margin-top: -20px;"><a style="font-size: 15px;margin-top: -20px;color:red;font-weight: bold;">*</a>Approver Remarks</label>
                                                    <c:choose>
                                                        <c:when test="${fn:length(quoteList) > 0}">
                                                            <c:forEach items="${quoteList}" var="list">
                                                                <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" type="text" placeholder="" maxlength="200" rows="1" required class="form-control" required="" id="approverRemarks" name="approverRemarks" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                        ...
                                        <c:if test="${action ne 'view'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                <button type="button" class="btn btn-primary" style="" onclick="quotesubmit();">Approve</button>
                                                <button type="button" class="btn btn-dark" style=""  onclick="quoteRecheck('recheck');">Recheck</button>
                                                <button type="button" class="btn btn-warning" style="" onclick="reject('Rejected');">Reject</button>
                                                <a href="../CRM/quoteApprovalProcess.htm"  class="btn btn-danger"  style="">Cancel</a>
                                            </div>
                                            <!--</div>--> 
                                        </c:if>
                                    </form>
