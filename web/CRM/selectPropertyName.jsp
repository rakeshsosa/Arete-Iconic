<%-- 
    Document   : selectPropertyName
    Created on : 6 Sep, 2016, 11:50:19 AM
    Author     : ebs-sdd27
--%>
    ...
    <body>
        <script>
            function test(val1, val2) {
                window.opener.document.getElementById('propertyName').value = val1;
                window.opener.document.getElementById('propertyNo').value = val2;
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${selectLandLord}" var="type">
                                        ...
                                        <%--                                        <tr onclick="test('${type.propertyName}','${type.propertyNo}');">                                            
