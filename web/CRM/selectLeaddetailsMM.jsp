<%-- 
    Document   : selectLeaddetailsMM
    Created on : 1 Aug, 2016, 1:08:13 PM
    Author     : ebs-sdd05
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                $(window.opener.document).find('#${rowid} #leadName').val(val1);
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${LeadList}" var="type">
                                        ...
                                        <tr onclick="test('${type.leadName}', '${type.leadType}');">                                            
                                            <td class="center" >${type.leadName}</td>
