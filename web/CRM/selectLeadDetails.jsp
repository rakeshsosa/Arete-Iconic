<%-- 
    Document   : selectLeadMM
    Created on : 7 Apr, 2016, 5:37:57 PM
    Author     : ebs-sdd05
--%>
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:set var="y" value="${id2}"/>
                                    <c:set var="h" value="${followUp}"/>
                                    <c:set var="z" value="${h}${id2}"/>

                                    <c:forEach items="${leadmanagmentList}" var="type">
                                        <c:if test="${type.leadCode!=leadCode1}">
                                            <tr onclick="window.opener.document.getElementById('leadCode').value = '${type.leadCode}';
                                                    window.opener.document.getElementById(${y}).value = '${type.leadName}';
                                                    window.close();">

                                                <td class="center" style="font-size:13px;">${type.leadName}</td>
                                                <td class="center" style="font-size:13px;">${type.leadType}</td>
