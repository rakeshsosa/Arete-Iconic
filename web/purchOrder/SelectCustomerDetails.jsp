                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${assetDetails}" var="type">
                                        ...
                                        <tr onclick="    <%--test('${type[0]}', '${type[1]}', '${type[2]}', '${type[6]}', '${type[4]}');">        --%>
                                            window.opener.document.getElementById('contactPersonName').value = '${type[1]}';
                                            window.opener.document.getElementById('contactNumber').value = '${type[3]}';
                                            window.opener.document.getElementById('contactEmail').value = '${type[4]}';
//                                            window.opener.document.getElementById('supplierAddress').value = '${type[5]}';
//                                               
                                            window.close();">
