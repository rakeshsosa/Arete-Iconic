...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            {
                myWindow = window.open("../purchase/selectPropertyListInLedger.htm", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
                window.close();
            }
            function selectAssetDetails1()
            {
                myWindow = window.open("../purchase/selectVendorDetails.htm", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
                window.close();
            }
            function selectAssetDetails2()
            {
                myWindow = window.open("../purchase/SelectDeliveryLocation.htm", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
                window.close();
            }
                        ...
                        <form id="poForm" class="form-inline" method="post" action="../purchase/directPOFormSubmit.htm" enctype="multipart/form-data" onsubmit="return checkGrid();">
                            <div  class="row">
                                <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">
                                  ...
                                  <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <select  name="purchaseType" id="purchaseType" data-rel="chosen" class="form-select validate[required]">
                                                    ...
                                                    <label class="control-label"><span style="color: red">*</span> Purchase Category</label>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <select  name="purchaseType" id="purchaseType" data-rel="chosen" class="form-select validate[required]">
                                                        <option value="" disabled="" selected>Select Options</option>
                                                        <option value="Cash/Contract - Based">Cash/Contract - Based</option>
                                                        <option value="General">General</option>
                                                    </select>
                                                    <!--<input class="form-control  input-xlarge validate[required]" required=""  type="text" value="" name="purchaseType" id="purchaseType"  placeholder="Select Project">-->
                                                </c:otherwise>        
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 row my-5 ">
                                    <div class="col-md-4">
                                                      <div class="card card-body cardTopppading">
                                                      <div class="d-flex mb-3 align-items-center">
                                                          <label class="col-md-6">Select Vendor Details </label>
                                                        <div class="col-md-6"><button class="btn btn-primary btn-sm" onclick="return selectAssetDetails()"> Select Customer</button></div>
                                                        ...
                                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control text-capitalize" id="supplierAddress" name="supplierAddress"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <div>Contact Number</div>
                                                            <input type="tel" class="form-control" id="supplierContactNumber" name="supplierContactNumber" maxlength="15" onkeypress="isNumberKey(event)">
                                                        </div>
                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control" id="supplierEmail" name="supplierEmail"
                                                                       placeholder="Enter Company Name" maxlength="50" onblur="validateEmail(this);">
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="card card-body cardTopppading">
                                                      <div class="d-flex mb-3 align-items-center">
                                                          <label class="col-md-6">Select Vendor Contact</label>
                                                        <div class="col-md-6"><button class="btn btn-primary btn-sm" onclick="return selectAssetDetails1()">Select Person</button></div></div>

                                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control text-capitalize" id="contactPersonName" name="contactPersonName"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Name</label>
                                                        </div>
                                                        ...
                                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control text-capitalize" id="contactAddress" name="contactAddress"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <div>Contact Number</div>
                                                                <input type="tel" class="form-control" id="contactNumber" name="contactNumber" maxlength="15" onkeypress="isNumberKey(event)">
                                                        </div>
                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control" id="contactEmail" name="contactEmail"
                                                                       placeholder="Enter Company Name" maxlength="50" onblur="validateEmail(this);">
                                                                <label class="control-label" for="name">Email ID</label>
                                                        </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                                     <div class="card card-body cardTopppading">
                                                      <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <div class="col-md-6"><button class="btn btn-primary btn-sm" onclick="return selectAssetDetails2()">Select Location</button></div></div>

                                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control text-capitalize" id="deliveryName" name="deliveryName"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Name</label>
                                                        </div>
                                                        ...
                                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control text-capitalize" id="deliveryAddress" name="deliveryAddress"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <div>Contact Number</div>
                                                            <input type="tel" class="form-control" id="deliveryContact" name="deliveryContact" maxlength="15" onkeypress="isNumberKey(event)">
                                                        </div>
                                        <div class="form-floating mb-3">
                                                                <input type="text" placeholder="Fill" class="form-control" id="deliveryEmail" name="deliveryEmail"
                                                                       placeholder="Enter Company Name" maxlength="50" onblur="validateEmail(this);">
                                                                <label class="control-label" for="name">Email ID</label>
                                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3 form-floating">
                                            ...
                                            <select onchange="showOther(event)" id="payTerms" name="payTerms" data-rel="chosen"  class="form-select  validate[required]" >
                                        ...
                                        <div class="col-md-4 mb-3 form-floating">
                                            ...
                                            <select  id="delTerms" onchange="showOther(event)" name="delTerms" data-rel="chosen"  class="form-select  validate[required]" >
                                                <option value="">Select an option</option>
                                ...
                                <div class="col-md-4 mb-3 form-floating" id="agentNamhide">
                                          <input  class="form-control validate[required]"   placeholder="fill" style="text-transform: capitalize" autocomplete="off" id="agentNam" name="agentNam" maxlength="180"  type="text" value="">                                                  
                                        ...
                                        <div class="col-md-4 mb-3 form-floating">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input class="form-control " placeholder="terms"   style="resize: none;" name="warrentyTerms" id="remarks" type="text" value="" maxlength="200">
                                                ...
                                                <tbody class="invoice-items" id="commontbody">
                                                    <tr class="item-row item-row-1 with-tax" id='myRow'>
                                                        <td class="item-row-actions">
                                                            ...
                                                            <input type="" class="form-control" id="sno" name="sno"
                                                                   value="Product" >
...
<button id="invoice-item-add" title="Add Item" class="btn btn-primary border my-2" onClick="addRow(event)"><i
                                        ...
                                        <div class="">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                                            <input type="number" class="form-control additionalTaxAmt validate[required]" placeholder="0" autocomplete="off" id="additionalTax" value="0" name="additionalTax" onInput="calcTotal()" onkeyup="return isNumberWithDot(event)" max="100" min="0" required="">
                                                                <label class="control-label"><span style="color: red">*</span> Additional Tax Percentage</label>
                                                            </div>
                                                            </div>
                                </div>  
                                </div>
...
autosize($('textarea'));
                ...
                $("#additionalTax").on('keyup', function(event){
                    var additionalTax  = $("#additionalTax").val();
                    if(Number($("#additionalTax").val()) <= 100){
                       $(".taxlabel").text("Additional Tax ("+Number(additionalTax).toFixed(2)+" %)")
                    } else {
                        event.target.value = '';
                        $(".taxlabel").text("Additional Tax (0 %)")
                    }
                })
            });
...
<script>
    $(function (){
        var input = document.querySelector("#supplierContactNumber");
        ...
        $("#supplierContactNumber").change(function () {
            var full_number = myinput.getNumber(intlTelInputUtils.numberFormat.E164);
            $("#supplierContactNumber").val(full_number);
...
<script>
    $(function (){
        var input = document.querySelector("#deliveryContact");
        var myinput = window.intlTelInput(input, {
            initialCountry: "om",
            onlyCountries: ["om", "in", "ae"],
            hiddenInput: "full",
        ...
        $("#deliveryContact").change(function () {
            var full_number = myinput.getNumber(intlTelInputUtils.numberFormat.E164);
            $("#deliveryContact").val(full_number);
            if (myinput.isValidNumber() == false) {
                $("#deliveryContact").val("");
                swal("Please enter valid mobile number");
                return false;
        ...
        <script src="../purchOrder/directPO.js"></script>
