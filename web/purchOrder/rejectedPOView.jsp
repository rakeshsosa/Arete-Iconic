...
//                });
    ...
    <body class="nav-sm">
        ...
        <main id="main" class="main">
            <div>
                <jsp:include page="../login/headerlink.htm?submodule=Purchase Order&tab=Rejected Purchase Orders&pagetype=form"/>
            </div>
            <div class="pagetitle">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <form id="quotform" class="form-inline" method="post" action="../purchase/statusUpdate.htm" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${poList}" var="type"> 
                                            <tr id="quotPoForm" >
                                                ...
                                                <td style="text-align: right;"><input style="width: 100px;"  class=" form-control input-mini validate[required,custom[float5]]" readonly="" autocomplete="off" required="" name="qty" id="qty" onkeypress="return isNumberKey(event)"  type="hidden" value="${type.qty}">${type.qty}</td>  
                                                <td>${type.uom}</td>
                                                <td style="text-align: right;"><input style="width: 100px;"  class="form-control  input-mini validate[required,custom[float5]]" required="" autocomplete="off" readonly="" onkeypress="return check_digit(event, this, 6, 3);" name="price" id="price" type="hidden" value="${type.unitPrice}"><fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" pattern="0.000" value="${type.unitPrice}"/></td>
                                                ...
                                                <td><input style="width: 100px;"  class=" form-control input-small" readonly=""  name="delDate" readonly="" id="reqBefore${type.SNo}" type="hidden" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.requiredDate}"/>" onclick="javascript:NewCssCal('reqBefore${type.SNo}', 'ddMMMyyyy', '', '', '', '', 'future')"><fmt:formatDate pattern="dd-MMM-yyyy" value="${type.requiredDate}"/></td>
