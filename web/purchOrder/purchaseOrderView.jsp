        ...
        <main id="main" class="main">
            ...
            <section class="section">
                <div class="row">
                    ...
                    <c:forEach items="${poListView}" var="list">
                        
                        
                  
                        
                        <c:set value="${list.SNo}" var="pk"/>
                        <c:set value="${list.purchaseType}" var="purchaseType"/>
                        <c:set value="${list.purchaseOrderNo}" var="purchaseOrderNo"/>
                        <c:set value="${list.supplierName}" var="supplierName"/>
                        <c:set value="${list.supplierAddress}" var="supplierAddress"/>
                        <c:set value="${list.supplierEmail}" var="supplierEmail"/>
                        <c:set value="${list.supplierContactNumber}" var="supplierContactNumber"/>
                        <c:set value="${list.supplierCode}" var="supplierCode"/>
                        <c:set value="${list.contactPersonName}" var="contactPersonName"/>
                        <c:set value="${list.contactAddress}" var="contactAddress"/>
                        <c:set value="${list.contactNumber}" var="contactNumber"/>
                        <c:set value="${list.contactEmail}" var="contactEmail"/>
                        <c:set value="${list.contactCode}" var="contactCode"/>
                        <c:set value="${list.deliveryName}" var="deliveryName"/>
                        <c:set value="${list.deliveryAddress}" var="deliveryAddress"/>
                        <c:set value="${list.deliveryContact}" var="deliveryContact"/>
                        <c:set value="${list.deliveryEmail}" var="deliveryEmail"/>
                        <c:set value="${list.deliveryCode}" var="deliveryCode"/>
                        <c:set value="${list.paymentTerms}" var="paymentTerms"/>
                        <c:set value="${list.deliveryTerms}" var="deliveryTerms"/>
                        <c:set value="${list.warrentyTerms}" var="warrentyTerms"/>
                        <c:set value="${list.purchaseOrderDate}" var="purchaseOrderDate"/>
                        <c:set value="${list.expectedDeliveryDate}" var="expectedDeliveryDate"/>
                        
                        <c:forEach items="${poItemDescListView}" var="type">
                            
                          
                            <c:set value="${type.sno}" var="snoItem"/>
                         <c:set value="${type.poCode}" var="poCode"/>
                         <c:set value="${type.itemdetails}" var="itemdetails"/>
                         <c:set value="${type.productCategory}" var="productCategory"/>
                         <c:set value="${type.itemrate}" var="itemrate"/>
                         <c:set value="${type.vatAmount}" var="vatAmount"/>
                         <c:set value="${type.itemqty}" var="itemqty"/>
                         <c:set value="${type.itemtotal}" var="itemtotal"/>
                         <c:set value="${type.subTotal}" var="subTotal"/>
                          <c:set value="${type.taxpercent}" var="taxpercent"/>
                          <c:set value="${type.total}" var="total"/>
                            <c:set value="${type.itemvattotal}" var="itemvattotal"/>
                             <c:set value="${type.uomType}" var="uomType"/>
                              <c:set value="${type.discAmount}" var="discAmount"/>
                             <c:set value="${type.itemdisctotal}" var="itemdisctotal"/>
                            ...
                            <div  class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input class="form-control  input-xlarge validate[required]" readonly value="${purchaseOrderNo}"  id="poNo" name="poNo" type="text">
                                            ...
                                            <c:choose>
                                                <c:when test="${fn:length(itemCreatList) > 0}">
                                                    <c:forEach items="${itemCreatList}" var="type">
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input class="form-control  input-xlarge validate[required]" disabled="" name="purchaseType" id="purchaseType" data-rel="chosen"  value="${type.purchaseType}"> 
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <c:otherwise>
                                                    <select  name="purchaseType" id="purchaseType" data-rel="chosen" class="form-control validate[required]" disabled="">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 row my-5 ">
                                    <div class="col-md-4 card card-body">
                                                      ...
                                                      <div class="d-flex mb-3 align-items-center">
                                                          ...
                                                          <!--<div class="col-md-6"><button readonly class="btn btn-primary btn-sm">Select Customer</button></div></div>-->
                                                        <div class="col-md-6"><input type="button" class="btn btn-primary btn-sm" value="Select Customer"></div></div>

                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="supplierName" value="${supplierName}"
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="supplierAddress" value="${supplierAddress}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="supplierContactNumber" value="${supplierContactNumber}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Contact Number</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="supplierEmail" value="${supplierEmail}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="card card-body">
                                                      <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <!--<div class="col-md-6"><button readonly class="btn btn-primary btn-sm">Select Person</button></div></div>-->
                                                          <div class="col-md-6"><input type="button" class="btn btn-primary btn-sm" value="Select Person"></div></div>
                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="contactPersonName" value="${contactPersonName}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Name</label>
                                                        </div>
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="contactAddress" value="${contactAddress}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="contactNumber" value="${contactNumber}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Contact Number</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="contactEmail" value="${contactEmail}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Email</label>
                                                        </div>
                                        </div>
...
<!--                                                        <div class="col-md-6"><button  readonly class="btn btn-primary btn-sm">Select Location</button></div></div>-->
                                                        <div class="col-md-6"><input type="button" class="btn btn-primary btn-sm" value="Select Location"></div></div>
                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="deliveryName" value="${deliveryName}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Name</label>
                                                        </div>
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="deliveryAddress" value="${deliveryAddress}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Address</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="deliveryContact" value="${deliveryContact}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Contact Number</label>
                                                        </div>
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" placeholder="Fill" class="form-control text-capitalize" id="customCompanyName" name="deliveryEmail" value="${deliveryEmail}"
                                                                       placeholder="Enter Company Name" maxlength="50">
                                                                <label class="control-label" for="name">Email</label>
                                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                                    ...
                                                    <input class="form-control  input-xlarge" id="reqDate" name="poDate" readonly="" type="text" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${expectedDeliveryDate}"/>">
                                                    <input class="form-control  input-xlarge" id="" name="ReqDateNo" readonly="" type="hidden" value="">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                            ...
                                            <select  id="payTerms" name="payTerms" data-rel="chosen"  class="form-select  validate[required]" disabled="" >
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating">
                                            ...
                                            <select  id="delTerms" name="delTerms" data-rel="chosen"  class="form-select  validate[required]" disabled>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-floating mt-3 ">
                                            
                                           
                                                    <textarea class="form-control " placeholder="terms" readonly   style="resize: none;" name="warrentyTerms" id="remarks" type="text" value="" maxlength="200">${warrentyTerms}</textarea>
...
<!--                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline" style="display: none">
            ...
            <div id="productDetails">
                <div class="card-body">
                                    ...
                                    <div class="my-1" >
                                        <input type="button" class="btn btn-primary mt-3 ml-3" value="Product">
                                        <div class="col-lg-12 invoice-body-list">
                                            ...
                                            <table class="table" id="myTable" style="border: 1px solid black;width:auto;overflow:scroll;width:1300px">
                                                ...
                                                <tbody class="invoice-items" id="commontbody">
                                                    <c:forEach items="${poItemDescListView}" var="type" varStatus="tbodytStatus">
                                                ...
                                                <td>
                                                    <input type="text" placeholder="Item Name" class="form-control" id="category0" name="productCategory" maxlength="100" required value="${type.productCategory}">
                                                </td>
                                                ...
                                                <td style="width: 150px">
                                                    ...
                                                    <span class="item-row-description">
                                                        <input class="item-description-input form-control" maxlength="100" placeholder="Item Description" name="itemdetails" id="itemdetails" value="${type.itemdetails}">
                                                    </span>
                                                </td>
                                                <td>
                                                    <input type="text" placeholder="UOM" class="form-control" id="uomType" name="uomType" maxlength="100" required value="${type.uomType}">
                                                ...
                                                <td><input style="width: 70px;" type="text" class="form-control itemrate" placeholder="0.00" autocomplete="off" id="itemrate0" name="itemrate" onkeypress="return isNumber(event)" onInput="calcTotal();calculateTotal(event)" 
                                                           value="${type.itemrate}" maxlength="10">
                                                </td>
                                                <td><input style="width: 60px;" type="text" class="form-control vatpersAmt" placeholder="0" autocomplete="off" id="vatAmount" name="vatAmount" onInput="calcTotal()" onkeyup="return isNumberWithDot(event)"
                                                           value="${type.vatAmount}"  size="3" maxlength="6"></td>
                                                <td><input style="width: 60px;" type="text" class="form-control discperAmount" placeholder="0" autocomplete="off" id="itemDiscount" name="itemDiscount" onInput="calcTotal()" onkeyup="return isNumberWithDot(event)"
                                                           value="${type.discAmount}"  size="3" maxlength="6"></td>
                                                <td><input style="width: 50px;" type="text" class="form-control itemQty" autocomplete="off" placeholder="0" value="${itemqty}" id="itemqty" name="itemqty" onInput="calcTotal();calculateTotal(event)" onkeypress="return isNumber(event)"
                                                           size="3" maxlength="5">
                                                    <input type="hidden" class="form-control" value="0" name="stock" id="stock">
                                                </td>
                                                <td class=""><div class="d-flex"><span class="currency"></span><span><input style="width:60px;" type="text" size="10" readonly class="border-0" style="user-select: none;outline: none;"  value="${type.itemvattotal}" name="itemvattotal" id="itemvattotal"></span></div></td>
                                                <td class=""><div class="d-flex"><span class="currency"></span><span><input style="width:60px;" type="text" size="10" readonly class="border-0" style="user-select: none;outline: none;"  value="${type.itemdisctotal}" name="itemdisctotal" id="itemdisctotal"></span></div></td>
                                                <td class=""><div class="d-flex"><span class="currency"></span><span><input style="width:60px;" type="text" size="10" readonly class="border-0" style="user-select: none;outline: none;"  value="${type.itemtotal}" name="itemtotal" id="itemtotal"></span></div></td>
...
<!--                                                    <input name="incsummary" id="incsummary" type="text" readonly class="border-0 incsummary" style="user-select: none;outline: none;" size="2" value="">-->
                                                    <span class="currency"></span>
                                                    <input type="text" readonly class="border-0" style="user-select: none;outline: none;" size="10" value="${taxpercent}" name="taxpercent" id="taxpercent">
                                                    <span class="currency-right"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col text-right">
                                                    <span class="currency"></span>
                                                    <input type="text" readonly class="border-0" style="user-select: none;outline: none;" size="10" value="${total}" name="total" id="total">
                                                    <span class="currency-right"></span>
                                                </div>
                                            </div>
                                      ...
                                      <c:if test="${action eq 'view'  }">
                                       ...
                                       <a href="../purchase/poList.htm" class="btn btn-danger">Cancel</a>
                                         </div>
                                          </c:if>
