        ...
        <div class="container body">
                            ...
                            <div class="x_panel" >
                                ...
                                <div class="x_content">
                                    ...
                                    <c:forEach items="${leadmanagmentList}" var="type">
                                        <c:set value="${type.attribute1}" var="leadSource"/>
                                    </c:forEach>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <c:choose>
                                                    ...
                                                    <c:forEach items="${leadmanagmentList}" var="type" end="0">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                ...
                                                                <select id="leadType" name="leadType" class="form-control validate[required]" ${mand_status_3}>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <select id="leadType" name="leadType" class="form-control validate[required]" ${mand_status_3} onchange="leadTypeFirstName(this.value);">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <input type="text" id="leadName" name="leadName" maxlength="100" value="" class="form-control " ${mand_status_2} autocomplete="off" onchange="uniqueLeadName();" onkeypress="return isNumberKey4(event)" onkeyup="firstToUpperCase3();">
                                    ...
                                    <c:if test="${status5 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline" id="contacts">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input type="text" id="contactNo" name="contacts" maxlength="11"  autocomplete="off" class="form-control" value="" onkeypress="return isNumberKey(event)" onchange="return contactNoValidation();" >
                                                </c:otherwise>        
                                            </c:choose>
                                        </div>
                                    </c:if>
                                    ...
                                    <c:if test="${status6 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <label style="" class="control-label">${name6}
                                            </label>
                                            <c:choose>
                                                <c:when test="${fn:length(leadmanagmentList) > 0}">
                                                    <c:forEach items="${leadmanagmentList}" var="type" end="0">
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <textarea rows="1" class="form-control" style="resize: none" maxlength="200" name="leadaddressPermanent"  id="leadaddressPermanent" type="text" value="${type.leadAddress}" autocomplete="off">${type.leadAddress} </textarea>
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <c:otherwise>
                                                    <textarea rows="1" class="form-control" style="resize: none;text-transform: capitalize;"  maxlength="200" value="" name="leadaddressPermanent"  id="leadaddressPermanent" type="text" autocomplete="off"></textarea>
                                    ...
                                    <c:if test="${status7 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <a style="font-size: 15px;margin-top:-21px;color:transparent;font-weight: bold;">*</a>
                                            <label style="" class="control-label">${name7}
                                            </label>
                                            <c:choose>
                                                <c:when test="${fn:length(leadmanagmentList) > 0}">
                                                    <c:forEach items="${leadmanagmentList}" var="type" end="0">
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <textarea rows="1" type="text" id="remarks" maxlength="200"  name="remarks" class="form-control" style="resize: none;" value="${type.remarks}">${type.remarks}</textarea>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <textarea rows="1" type="text" id="remarks" maxlength="200"  name="remarks" readonly class="form-control" style="resize: none;" value="${type.remarks}">${type.remarks}</textarea>
                                                            </c:otherwise> 
                                                        </c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <textarea rows="1" class="form-control" style="resize: none;text-transform: capitalize;" maxlength="200" value="" id="remarks"  name="remarks" style="resize: none;" type="text"></textarea>
                                                </c:otherwise>        
                                            </c:choose>
                                        </div>
                                    </c:if>
                                    ...
                                    <c:if test="${status512 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline"style="margin-top:9px;">
                                                ...
                                                <c:when test="${fn:length(leadmanagmentList) > 0}">
                                                    <c:forEach items="${leadmanagmentList}" var="type" end="0">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <input name="leadSource" class="form-control" type="text" readonly  value="${leadSource}">
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </c:forEach>
                                                </c:when>
                                    ...
                                    <%--<c:if test="${status513 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline" id="others" style="margin-top:13px;margin-left:-2px;">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(leadmanagmentList) > 0}">
                                                        <c:forEach items="${leadmanagmentList}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <select id="salutation" class="form-control" style="width: 50px;" onclick="checkavl(this.value);">
                                                                        <option value="" disabled selected></option>
                                                                        <option value="Ms">Ms</option>
                                                                        <option value="Mr">Mr</option>

                                                                    </select>
                                                                    <input type="text" id="firstName" name="firstName" maxlength="100" style="width: 121px;" class="form-control" ${mand_status_8} autocomplete="off" value="${type.firstName}" onkeyup="firstToUpperCase();">
                                                                </c:when>
                                                                <c:otherwise>
                                                    ...
                                                    <c:otherwise>
                                                        ...
                                                        <input type="text" id="firstName"  name="firstName" maxlength="100" value="" style="width: 121px;" autocomplete="off" class="form-control"  onkeyup="firstToUpperCase();" onkeypress="return isNumberKey4(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                        ...
                                        <c:if test="${status9 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline" id="lastNameid">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" id="lastName" name="lastName"  maxlength="100" value="" class="form-control validate[contactPerson]" autocomplete="off" onkeyup="firstToUpperCase1();" onkeypress="return isNumberKey4(event)">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${status13 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <input id="country" class="form-control"  type="text" readonly value="India">
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(leadmanagmentList) > 0}">
                                                        <c:forEach items="${leadmanagmentList}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                     <!--<input id="city" class="form-control" ${mand_status_14} type="text" readonly value="${type.city}">-->
                                                    ...
                                                    <c:otherwise>
                                                        <select id="city"  class="form-control" ${mand_status_14} name="city">
                                                            <option value="" disabled selected>Select your option</option>
                                                            <c:forEach items="${LeadFormData_dropDown_category}" var="list">
                                                                <c:if test="${list[0] eq 'F-13'}">
                                                                    <option>${list[1]}</option>                                     
                                    ...
                                    <c:if test="${status22 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <!--                                                <input type="hidden" id="subAssetName" name="subAssetName" class="form-control" maxlength="30" readonly="" placeholder="Asset Plot No" autocomplete="off">-->
                                        </div>
                                    </c:if>
                                    ...
                                    <c:if test="${status24 eq 'y'}">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <textarea class="form-control" rows="1" style="resize: none;text-transform:capitalize; " maxlength="100" value="" autocomplete="off" name="followUpRemarks" id="followUpRemarks" type="text"></textarea>
                                        </div>
                                    </c:if>
                                            ...
                                            <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:5%"><span style="color:red">*</span> First Name</th>
                                                        <th> Last Name</th>
                                                        <th> Designation</th>
                                                        <th> Email</th>
                                                        <th><span style="color:red">*</span> Mobile</th>
                                                        <th> DOB</th>
                                                        <th> Post Box</th>
                                                        <th> Postal Code</th>
                                                        ...
                                                        if (valid1 == true) {
                                                            ...
                                                            for (var i = 0; i < mobile1.length; i++) {
                                                                ...
                                                                tr.innerHTML = '<td align="center" class="tinput"><button type="button" class="fa fa-trash fa-lg-o" onclick="removeRow('
                                                                        ...
                                                                        '" ><input class="form-control" style="text-align:center; width:50%"  type="hidden" readonly name="salutation" value="' + salutation +
                                        ...
                                        <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                            ...
                                            <tbody id="currencytablemed">
                                                <c:forEach items="${leadmanagmentList}" var="type">
                                                    ...
                                                    <tr class="item-row"> 
                                                        <td><input class="form-control" style="text-align: left;" name="firstName" id="firstName" readonly="" autocomplete="off" type="text" maxlength="30" value="${type.firstName}"></td>
                                                        <td><input class="form-control" style="text-align: left;" name="lastName" id="lastName" readonly autocomplete="off" type="text" maxlength="30" value="${type.lastName}"></td>
                                                        <td><input class="form-control" style="text-align: left;" name="designation" id="designation" readonly autocomplete="off" type="text" maxlength="30" value="${type.designation}"></td>
                                                        <td><input class="form-control" style="text-align: left;" name="email" id="email" readonly autocomplete="off" type="text" maxlength="100" value="${type.email}"></td>
                                                        <td><input class="form-control" style="text-align: right;"  name="mobile" id="mobile" readonly autocomplete="off" type="text" min="8" maxlength="11" value="${type.mobileNo}"></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <c:if test="${not empty type.businessFilename}">
                                                                <a style="color: black" href="../Lead/leadAttachDownload.htm?sno=${type.sno}" title="Click to download">
                                                        ...
                                                        <td>
                                                            <input id="dob" readonly="" onmouseover="" name="assetCode" style="cursor: pointer;width:200px;text-align: left;" class="form-control"   value="${type.assetCode}" >
                                                        </td> 
                                                        <td>
                                                            <input class="form-control" style="text-align: left;" name="assetName" id="postbxno" readonly autocomplete="off" type="text" maxlength="30" value="${assetName1}">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" style="text-align: left;" name="assetPlotCode" id="pincode" readonly autocomplete="off" type="text" maxlength="30" value="${type.assetPlotCode}">

                                                        </td>
                                                        <td>
                                                            <input class="form-control" style="text-align: left;" name="assetPlotNo" id="city" readonly autocomplete="off" type="text" maxlength="30" value="${subAssetName1}">

                                                        </td>
                                                        <td><input class="form-control" style="text-align: left;" name="folloeUpDate" id="country" readonly autocomplete="off" type="text" maxlength="30" value="<fmt:formatDate pattern="dd-MMM-yyyy"  value="${type.folloeUpDate}"/>" ></td>
                                                        <td><input class="form-control" style="text-align: left;" name="followUpRemarks" id="addressDifferent" readonly autocomplete="off" type="text" maxlength="30" value="${type.followUpRemarks}"></td>
            ...
            <script>
                ...
                function ckeckDOB1()
                {
                    ...
                    var CD = dd1 + '-' + mmm1 + '-' + yyyy;

                    var DOB = document.getElementById("dob").value;
                    var dob1 = DOB.split("-");
                    var DOB1 = dob1[0] + '-' + months[dob1[1]] + '-' + dob1[2];

                    if (DOB1 > CD) {
                        alert("Please Enter DOB LessThen Current Date.")
                    }
