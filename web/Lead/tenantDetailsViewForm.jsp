<%-- 
    Document   : tenantDetailsViewForm
    Created on : 15 Sep, 2016, 10:59:27 AM
    Author     : ebs-sdd27
--%>
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Lead management&tab=Tenant&pagetype=form"/>
                                <div class="x_title">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form class="form-inline" action="../Lead/leadConvertFormSubmit.htm"  method="post" enctype="multipart/form-data">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <div class="form-control" style="border: none">
                                                                <input class="input-file uniform_on" ${mand_status_8} id="llAttachment"  type="file" value="" name="llAttachment"  onchange="Validate(this)">
                                            ...
                                            <c:if test="${fieldStatus_20 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    <c:if test="${mand_status_20 eq 'required'}">
                                                        <a style="font-size: 15px;color:red;font-weight: bold; margin-top: -20px">*</a>
                                                    </c:if>
                                                    <a style="font-size: 15px; margin-top: -20px;color:transparent;font-weight: bold;">*</a>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <textarea type="text" class="form-control" rows="1" style="resize: none" ${mand_status_20} readonly="" id="permanentAddress" name="permanentAddress" maxlength="250" value="${list.permanentAddress}">${list.permanentAddress}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea type="text" placeholder="" style="resize: none" rows="1" class="form-control" ${mand_status_20} id="permanentAddress" name="permanentAddress" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <textarea type="text" class="form-control" rows="1" style="resize: none" ${mand_status_21} readonly="" id="correspondenceAddress" name="correspondenceAddress" maxlength="250" value="${list.correspondenceAddress}">${list.correspondenceAddress}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea type="text" placeholder="" style="resize: none" rows="1" class="form-control" ${mand_status_21} id="correspondenceAddress" name="correspondenceAddress" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <textarea type="text" class="form-control" rows="1" placeholder="" style="resize: none" ${mand_status_25} readonly="" id="sponcerAddress" name="sponcerAddress" maxlength="250" value="${list.sponcerAddress}">${list.sponcerAddress}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" class="form-control" rows="1" type="text" placeholder=""  ${mand_status_25} id="sponcerAddress" name="sponcerAddress" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_27 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" type="text" placeholder="" rows="1" class="form-control" ${mand_status_27} id="companyAddress" name="companyAddress" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_31 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" type="text" rows="1" placeholder="" class="form-control" ${mand_status_31} id="jointeeAddress1" name="jointeeAddress1" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <textarea style="resize: none" type="text" rows="1" class="form-control" ${mand_status_33} readonly="" id="jointeeAddress2" name="jointeeAddress2" maxlength="250" value="${list.jointeeAddress2}">${list.jointeeAddress2}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea style="resize: none" type="text" placeholder="" rows="1" class="form-control" ${mand_status_33} id="jointeeAddress2" name="jointeeAddress2" maxlength="250" value=""></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <textarea style="resize: none" type="text" rows="1" class="form-control" ${mand_status_34} readonly="" id="remarks" name="remarks" maxlength="250" value="${list.remarks}">${list.remarks}</textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                            ...
                                            <c:if test="${fieldStatus_15 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="type">
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <!--                                                                    <c:if test="${not empty type.tenOrgfileName}">
                                                                                                                                               // ../tenant/tenanttAttachDownload.htm?sno=${type.SNo}  //
                                                        ...
                                                        <c:otherwise>
                                                            <div class="form-control" style="border: none">
                                                                <input class="input-file uniform_on" ${mand_status_15} id="tenantAttachment"  type="file" value="" name="tenantAttachment"  onchange="Validate(this)">
                                                                <!--                                                            <p style="float: left"><a href="#" id="attachmentReference" class="btn btn-upload" onclick="add1();">Attach Documents</a></p><br>
                                                                                                                            <label class="control-label" style="padding-right: 20px;">(PDF,XLS,DOC,Image)</label>-->
                                                            </div>
                                                            <input name="pk" type="hidden" value="${type.SNo}">
                                            ...
                                            <c:if test="${fieldStatus_50 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <div class="form-control" style="border: none">
                                                                <input class="input-file uniform_on" ${mand_status_50} id="contractAttachment"  type="file" value="" name="contractAttachment"  onchange="Validate(this)">
                                                                <!--                                                            <p style="float: left"><a href="#" id="attachmentReference" class="btn btn-upload" onclick="add1();">Attach Documents</a></p><br>
                                                                                                                            <label class="control-label" style="padding-right: 20px;">(PDF,XLS,DOC,Image)</label>-->
                                                            </div>
                                                            <input name="pk" type="hidden" value="${type.SNo}">
                                            ...
                                            <c:if test="${fieldStatus_54 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    <c:if test="${mand_status_54 eq 'required'}">
                                                        <a class="control-label-required" style="color:red;">*</a>
                                                    </c:if><a style="font-size: 15px; margin-top: -20px;color:transparent;font-weight: bold;">*</a>
