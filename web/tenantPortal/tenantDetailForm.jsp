<%-- 
    Document   : tenantDetailForm
    Created on : 17 May, 2018, 6:26:55 PM
    Author     : ebs
--%>
...
//                }
                    ...
                    if (tfname !== tfname1 || tlname !== tlname1 || tcrno !== tcrno1 || tcno !== tcno1
                            ...
                            || joname !== joname1 || joaddrs !== joaddrs1 || rmark !== rmark1) {
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Tenant Detail&tab=Tenant Detail&pagetype=form"/>
                                <div class="x_title">
                                    <h2>Tenant Detail</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <br />
                                    <form class="form-inline" id="tenantform" action="../tenantPortal/tenantDetailFormSubmit.htm"  method="post" enctype="multipart/form-data">
                                        <c:choose>
                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                <c:forEach items="${tenantDetails}" var="list">
                                                    <c:choose>
                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'||action eq 'edit1'}">
                                                            <script type="text/javascript">
                                                                $(document).ready(function () {
                                        ...
                                        <c:forEach items="${levellist}" var="list">
                                            <c:if test="${list.userId eq userId}">
                                                <c:if test="${list.submoduleName eq 'Tenant Detail'}">
                                                    <c:if test="${list.tabName eq 'Tenant Portal'}">
                                                ...
                                                <c:if test="${fieldStatus_11 eq 'y'}">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" id="tenantId"  maxlength="15" value="" onkeypress="return isNumberKey3(event)" onchange="fetchTid();">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="tenantFname" name="tenantFname" maxlength="50" value="${list.tenantFname}" onkeypress="return isNumberKey4(event)" onkeyup="firstToUpperCase();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="tenantLname" name="tenantLname" maxlength="50" value="${list.tenantLname}" onkeypress="return isNumberKey4(event)" onchange="fetchTName();" onkeyup="firstToUpperCase1();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="tenantCitizenship" name="tenantCitizenship" value="${list.tenantCitizenship}">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="tenantCrNo" name="tenantCrNo" maxlength="15" value="${list.tenantCrNo}" onkeypress="return isNumberKey3(event)" onchange="fetchCrno();">
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" id="tenantCrNo"  maxlength="15" value="" onkeypress="return isNumberKey3(event)" onchange="fetchCrno();">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="tenantContactno" name="tenantContactno" maxlength="11" value="${list.tenantContactno}" onkeypress="return isNumberKey(event)" onchange="fetchTCono();">
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" id="tenantContactno"  maxlength="11" value="" onkeypress="return isNumberKey(event)" onchange="fetchTCono();">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" id="companyName" name="companyName" value="${list.companyName}" maxlength="50" onkeypress="return isNumberKey4(event)">
                                                                ...
                                                                <c:forEach items="${tenantDetails}" var="type">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            ...
                                                                            <input type="hidden" class="form-control" id="tenOrgfileName" name="tenOrgfileName" maxlength="50" value="${type.tenOrgfileName}">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                ...
                                                <c:if test="${fieldStatus_35 eq 'y'}">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="Select Property" readonly="" class="form-control" id="assetName"  maxlength="50" value="" onkeypress="return isNumberKey3(event)" onclick="selectAssetDetails();">
                                                ...
                                                <c:if test="${fieldStatus_36 eq 'y'}">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="Select Flat Name" readonly="" class="form-control" id="flatNo"  maxlength="50" value="" onkeypress="return isNumberKey3(event)"  >
                                                ...
                                                <c:if test="${fieldStatus_44 eq 'y'}">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" readonly="" class="form-control" id="electricityBillno"  maxlength="50" value="" onkeypress="return isNumberKey(event)">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                ...
                                                <fieldset>
                                                    <div id="menuDiv">
                                                                    ...
                                                                    <tbody >                                                            
                                                                        <c:if test="${action eq null}">
                                                                            <tr class="item-enquiry">
                                                                                ...
                                                                                <td><select class="input-large validate[required]" id="utility" name="utility" style="width: 220px;">
                                                                                        <option value="">Select Utility Name</option>
                                                                                        <c:forEach items="${utilityDetails}" var="product">
                                                                                            <option>${product}</option>
                                                                                        </c:forEach>                                                                                
                                                                                    </select></td>
                                                                                <td><select class="input-large validate[required]" id="utilityBillType" name="utilityBillType" style="width: 220px;">
                                                                        ...
                                                                        <c:if test="${action eq 'view'}">
                                                                            <c:forEach items="${assetDetails1}" var="item">
                                                                                ...
                                                                                <tr class="item-enquiry">
                                                                                    ...
                                                                                    <td><input class="form-control  right validate[required,custom[notzero]]" name="utilityBillType" id="utilityBillType" type="text" value="${item.utilityBillType}" readonly="" style=""></td>                                                                        
                                                                                    <td><input class="form-control  right validate[required,custom[notzero]]" name="utilityBill" id="utilityBill" type="text" value="${item.utilityBill}" readonly="" style=""></td>                                                                        
                                                                                </tr>
                                                                            </c:forEach>
                                                                        </c:if>        
                                                        ...
                                                        <c:if test="${action eq 'edit'}">
                                                            ...
                                                            <div class="x_title">
                                                                <label class="control-label"><strong>Total Amount : <div id="totalitemAmount"></div><input type="hidden" id="itmTot" name="itmTot"></strong> </label>                                                   
                                                                <div class="clearfix"></div>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                ...
                                                <fieldset>
                                                    <div id="menuDiv">
                                                                ...
                                                                <table  class="table table-striped responsive-utilities jambo_table" id="enquirytable1">
                                                                    ...
                                                                    <tbody >
                                                                        <c:if test="${action eq null}">
                                                                            <tr class="item-enquiry">
                                                                                <td align="center" onclick=""><button type="button" id="deleteEnquiry"><i class="fa fa-trash-o"></i></button></td>
                                                                                <td><select class="input-large validate[required]" id="comUtility" name="comUtility" style="width: 220px;">
                                                                                        <option value="">Select Utility Name</option>
                                                                                        <c:forEach items="${comUtilityDetails}" var="product">
                                                                                            <option>${product}</option>
                                                                                        </c:forEach>
                                                                                    </select></td>   
                                                                                <td><select class="input-large validate[required]" id="comUtilityBillType" name="comUtilityBillType" style="width: 220px;">
                                                                                        <option value="">Select Utility Bill Type</option>
                                                                                        <option value="Monthly">Monthly</option>
                                                                                        <option value="Quarterly">Quarterly</option>
                                                                                        <option value="Yearly">Yearly</option>
                                                                        ...
                                                                        <c:if test="${action eq 'edit'}">
                                                                            <c:forEach items="${assetDetails1}" var="item">
                                                                                ...
                                                                                <tr class="item-enquiry">
                                                                                    <td align="center" onclick=""><button type="button" id="deleteEnquiry"><i class="fa fa-trash-o"></i></button></td>
                                                                                    <td><input class="form-control  right validate[required,custom[notzero]]" readonly autocomplete="off" name="comUtility" id="comUtility" type="text" value="${item.comUtility}" style=""></td>   
                                                                                    <td><input class="form-control  right validate[required,custom[notzero]]" readonly autocomplete="off" name="comUtilityBillType" id="comUtilityBillType" type="text" value="${item.comUtilityBillType}" style=""></td>                                                                        
                                                                                    <td><input class="form-control  right validate[required,custom[notzero]]" readonly autocomplete="off" name="comutilityBill" id="comutilityBill" type="text" value="${item.comutilityBill}" style=""></td>                                                                        
                                                                                </tr>
                                                        ...
                                                        <c:if test="${action eq 'edit'}">
                                                            ...
                                                            <div class="x_title">
                                                                <label class="control-label"><strong>Total Amount : <div id="commontotalitemAmount"></div><input type="hidden" id="commonitmTot" name="commonitmTot"></strong> </label>                                                   
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(contractNamee) > 0}">
                                                                <c:forEach items="${contractNamee}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="contractName" name="contractName" maxlength="50" value="${list.contractCode}" onkeypress="return isNumberKey3(event)">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="crIdNo" name="crIdNo" value="${list.crIdNo}" maxlength="50" onkeypress="return isNumberKey3(event)">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="hidden" class="form-control" readonly="" name="billingCycle1" id="billingCycle1" value="${list.billingCycle}" >

                                                                        <!--<input type="text" class="form-control" readonly id="billingCycle" name="billingCycle" value="${list.billingCycle}">-->
                                                                            <select id="billingCycle" name="billingCycle" readonly="" class="form-control" onchange="rentPMonth();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="advanceAmount" name="advanceAmount" maxlength="14" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.advanceAmount}" />" onkeypress="return check_digit(event, this, 10, 3);" onchange="rentCalc();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="extra2" name="extra2" value="${list.extra2}" maxlength="14" onkeypress="return check_digit(event, this, 10, 3);" onchange="rentCalc();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="DiscountforAdvance" name="DiscountforAdvance" value="${list.discountforadvance}" maxlength="50" onkeypress="return check_digit(event, this, 10, 3);" onchange="darentCalc();">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'|| action eq 'Recheck'}">
                                                                            <input type="text" class="form-control" readonly="" id="DiscountforRent" name="DiscountforRent" value="${list.discountforrent}" maxlength="50" onkeypress="return check_digit(event, this, 10, 3);" onchange="drentCalc();">
                                        ...
                                        <c:if test="${action eq 'edit1' || action eq 'view1'}">
                                            ...
                                            <div class="box-header well" data-original-title onclick="call();" style="cursor: pointer;">
                                                ...
                                                <c:if test="${action eq 'edit1' || action eq 'view1' || action eq 'Recheck'}">
                                                    <c:if test="${fieldStatus_8 eq 'y'}">
                                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                            <c:if test="${mand_status_8 eq 'required'}">
                                                                <a style="color:red;">*</a>
                                                            ...
                                                            <c:when test="${fn:length(tenantDetails) > 0}">
                                                                <c:forEach items="${tenantDetails}" var="type">
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <c:if test="${not empty type.tenOrgfileName}">
                                                                                <a style="color: black" href="../tenantPortal/tenanttAttachDownload.htm?sno=${type.SNo}" title="Click to download">
                                                                                    <i class="fa fa-file-pdf-o" style="font-size: 15px" ></i>
                                                                                    ${type.tenOrgfileName}
                                                                                </a>
                                                                            </c:if> 
                                        ...
                                        <c:if test="${action eq 'edit' || action eq 'Recheck'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-4">
                                                ...
                                                <a href="../tenant/tenantDetailList.htm" class="btn btn-danger">Cancel</a>
                                            </div>
                                            <!--</div>--> 
                                        </c:if>
                                        <c:if test="${action eq 'edit1' || action eq 'Recheck' }">
