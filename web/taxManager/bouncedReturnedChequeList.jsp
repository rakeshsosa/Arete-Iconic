...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
           <jsp:include page="../login/headerlink.htm?submodule=cheque manager&tab=Bounced or Returned Cheques&pagetype=list"/>
       </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Bounced Cheque List</h5></div> 
									  ...
									  <tr class="even pointer">    
                                                                        ...
                                                                        <td class=" last " style="text-align: center;">
                                                                            <a href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
                                                                              <a href="../taxManager/paymentReconsilationBouncedForm.htm?action=view" class="fa fa-money fa-lg" data-toggle="tooltip" title="Payment Reconsilation"></a>&nbsp;
...
<button type="button" class="btn btn-danger ms-2" data-bs-dismiss="modal">Cancel</button>
   ...
   <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>Search and View PD Cheque, Voucher Number, Date, Property Name, Unit Number, Tenant Name, Due Date, and Reason. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
