...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
           <jsp:include page="../login/headerlink.htm?submodule=cheque manager&tab=Paid Cheques&pagetype=list"/>
       </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Paid Cheques List</h5></div> 
...
<button type="button" class="btn btn-danger ms-2" data-bs-dismiss="modal">Cancel</button>
   ...
   <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>Search, and View PD Cheque, Voucher Number, Date, Property Name, Unit Number, Tenant Name, Due Date and Payment Status. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
