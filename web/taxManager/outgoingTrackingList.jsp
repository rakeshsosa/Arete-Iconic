...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
           <jsp:include page="../login/headerlink.htm?submodule=Incoming Tax Tracking&tab=Outgoing Tax Tracking&pagetype=list"/>
       </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Outgoing Tax Tracking List</h5></div> 
                <div class="row">
                 ...
                 <div class="col-md-4 form-floating mb-3">
                                        <input class="form-control capitalize validate[required]" required placeholder="Start Date" id="startDate" name="startDate" type="text" value="" placeholder="DD/MM/YYYY" maxlength="10">
                                            <label class="control-label"><span style="color:red">*</span>Customer Name</label>
                                         </div>  
                </div>
                <div class="row">
                                                                    ...
                                                                    <c:set var="status" value="${list.status}"></c:set>
                                                                       ...
                                                                       <td style="text-align: left;">${list.insuranceCompanyName}</td>
                                                                        ...
                                                                        <td class=" last text-nowrap">
                                                                            <a href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=view" class="fa fa-file-image-o fa-lg"title="Attach Tax Payment Certificate"></a>&nbsp;
