...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
        <jsp:include page="../login/headerlink.htm?submodule=Utility Master&tab=Property Services&pagetype=list"/>
    </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Property Services List</h5></div> 
...
<!--                                                                            <td style="text-align: center;">${list.SNo}</td>-->
   ...
   <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>View and Edit Property Name, Service Name, and Descriptions. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
