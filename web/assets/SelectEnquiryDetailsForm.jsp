<%-- 
    Document   : SelectEnquiryDetailsForm
    Created on : 13 Jun, 2023, 2:42:21 PM
    Author     : dipal
--%>
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                               ...
                               <c:forEach items="${enquiryId}" var="type">
                                     <tr onclick="test('${type.enquiryId}');">                                            
                                        <td class="center" style="text-align: left;">${type.enquiryId}</td>
                                    </tr>
                                </c:forEach>	
