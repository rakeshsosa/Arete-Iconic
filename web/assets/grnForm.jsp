                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Good Receipt Note&tab=GoodReceiptNote&pagetype=form"/>
                                <div class="x_title">
                                    <h2>GRN Details</h2>
                                    <div class="clearfix"></div>
                                </div>
                                            ...
                                            <c:if test="${fieldStatus_2 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <input type="text" readonly="" placeholder="Select Date" ${mand_status_2} class="form-control" id="grnDate" name="grnDate" value="" maxlength="20" onclick="javascript:NewCssCal('grnDate', 'ddMMMyyyy', '', '', '', '', '')" onchange="return RecievedDatevalidate();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                            ...
                                            <c:if test="${fieldStatus_32 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <input type="text" ${mand_status_32} class="form-control" autocomplete="off" id="discount" name="discount" value="" maxlength="20" onchange="sumOfTotalCalculate();" onkeypress="return checkdigit(event, this, 2, 0);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                            ...
                                            <c:if test="${fieldStatus_33 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                                          
                                                            <input type="text"  ${mand_status_33}  autocomplete="off" class="form-control" id="grandTotal" name="grandTotal" value="${qualitySumTotal[0]}" maxlength="20" >
                                                            <input type="hidden" ${mand_status_33} class="form-control" id="grandTotalHidden" name="grandTotalHidden" value="${qualitySumTotal[0]}"  >
                                                            <input type="hidden"  ${mand_status_33}  autocomplete="off" class="form-control" id="grandTotal1" name="grandTotal1" value="${qualitySumTotal[0]}" maxlength="20" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${qualityList}" var="list">
                                                                ...
                                                                <c:set var="qtyAccepted" value="${list.qtyAccepted}"/>
                                                                <c:set var="qtyRejected" value="${list.qtyRejected}"/>
                                                                <c:set var="unitPrice" value="${list.unitPrice}"/>
                                                                <c:set var="totalPrice" value="${list.qtyAccepted * list.unitPrice}"/>
                                                                ...
                                                                <tr class="even pointer">
                                                                    ...
                                                                    <td>
                                                                        <input class="form-control" style="width: 100%; text-align: left;" name="manufacturer" id="manufacturer" maxlength="60" value="" type="text">
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control" style="width: 100%; text-align: left;" name="model" id="model" maxlength="60" value="" type="text">
                                                                    </td>
                                                                    <td>
                                        ...
                                        <div>
                                            <c:if test="${action ne 'view'}">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                    <button id="saveInvoiceBtn" class="btn btn-primary" name="saveInvoice" value="Save" type="button" onclick="mandatoryFields();">Save</button>
                                                    <a href="../quality/grnList.htm" class="btn btn-danger">Cancel</a>
                                                </div>
