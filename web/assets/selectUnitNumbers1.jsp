<%-- 
    Document   : selectUnitNumbers1
    Created on : 20 Apr, 2023, 5:11:37 PM
    Author     : dipal
--%>
        ...
        <script>
            function test1() {
              ...
              $("table tbody tr input:checkbox:checked").each(function(){
                ...
                unitNumbers1.push(tmpVal1)
                });
                   
            
              opener.addUnitNumbers1(unitNumbers1,window.currIndexFromOpener);
//                window.opener.document.getElementById('assetName').value = val1;
//                window.opener.document.getElementById('areaCode').value = val2;
//                window.opener.document.getElementById('assetCode').value = val3;
//                window.opener.document.getElementById('noOfFloors').value = val4;
               window.close();
            }
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${subAssetDetails}" var="type">
                                        ...
                                        <tr>  
                                            <td><input type="checkbox" name="selectUnitNumbers" id="selected+employee" value="${type.subAssetName}"/>
                                        </td>
                            ...
                            <button class="btn btn-primary" onclick="test1()">Add to grid</button>
                        </div>
                        </form>
                    </div>
                </div>
