    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3) {
                ...
                window.opener.document.getElementById('accessoryCategory').value = val2;
                window.opener.document.getElementById('accessoryName').value = val3;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${accDetails}" var="type">

                                        <tr onclick="test('${type.itemCode}', '${type.itemCategory}', '${type.itemName}');">                                            
                                            <td class="center" style="text-align: left;">${type.itemCode}</td>
                                            <td class="center" style="text-align: left;">${type.itemCategory}</td>
                                            <td class="center" style="text-align: left;">${type.itemName}</td>
                                            <td class="center" style="text-align: left;">${type.itemDesc}</td>
                                        </tr>
                                    </c:forEach>
