<%-- 
    Document   : assetsRevalApproval2Form
    Created on : 8 Feb, 2018, 5:52:44 PM
    Author     : ebs05
--%>
        ...
        <script>
            ...
            function reject(SNo, status)
            {
                ...
                if (remarks == null || remarks == '') {
                    ...
                    window.location.href = "../assetsm/assetsRevalrejectedSubmit.htm?SNo=" + SNo + "&reviewerRecordStatus=" + status + "&reviewerComments2=" + remarks + "";
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Property Revaluation&tab=Approval 2&pagetype=form"/>
                                    ...
                                    <form id="userform" method="post" enctype="multipart/form-data" name="form" class="form-inline" action="../assetsm/assetsRevalApproval2Submit.htm" onsubmit="return formValidate();">
                                        ...
                                        <c:if test="${action ne 'view'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                ...
                                                <a href="../assets/assetsRevalrejectedList.htm" class="btn btn-danger">Cancel</a>
                                            </div>
