                        ...
                        <div class="row top_tiles">
                            ...
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Inventory List&tab=Inventory List&pagetype=list"/>
                        ...
                        <script>
                            ...
                            $(document).ready(function () {
                                $('#example').dataTable({
                                    ...
                                    "bServerSide": true,
                                    "aaSorting": [[0, 'desc']],
                                    "sAjaxSource": "../quality/paginationList.htm?listPage=inventoryList",
                                    "aoColumnDefs": [
                                        {
                                            "aTargets": [0],
                                            "sWidth": "200px",
