                                        ...
                                        <c:choose>
                                            <c:when test="${fn:length(assetDetails) > 0}">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(assetDetails) > 0}">
                                                        <c:forEach items="${assetDetails}" var="list">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" readonly class="form-control" ${mand_status_1}  id="assetCode" name="assetCode" maxlength="40" value="${list.assetName}" onkeypress="return isNumberKey3(event)">
                                                                    
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" readonly class="form-control" id="assetCode"  value="${list.assetCode}">
                                                                    <input type="text" readonly id="assetCode" name="assetCode" value="${list.assetCode}">
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" disabled placeholder="Fill" class="form-control"  id="assetCode" name="assetCode" maxlength="40" value="${list.assetCode}"   onclick="return selectAccAssetDetails();">
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <c:choose>
                                                        ...
                                                        <c:forEach items="${assetDetails}" var="list">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    ...
                                                                    <input type="text" readonly class="form-control" ${mand_status_1}  id="assetName1" name="assetName1" maxlength="40" value="${list.assetName}" >
                                                                    <input type="text" name="pk" value="${list.SNo}">
                                                                    <input type="text" name="status" value="${list.status}">
                                                                    <input type="text" id="assetCode" name="assetCode" value="${list.assetCode}">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" readonly class="form-control" id="assetName" readonly="" value="${list.assetName}">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" readonly placeholder="Fill" class="form-control" ${mand_status_1} id="assetName" name="assetName" maxlength="40" value="${list.assetName}" onkeypress="return isNumberKey3(event)" >
                                                    </c:otherwise>        
                                                </c:choose>
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(assetDetails) > 0}">
                                                        <c:forEach items="${assetDetails}" var="list">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" readonly class="form-control"   id="reminderNote" name="reminderNote" maxlength="40" value="${list.reminderNote}" onkeypress="return isNumberKey3(event)">
                                                                    
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" readonly class="form-control" id="reminderNote"  value="${list.reminderNote}">
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" readonly placeholder="Fill" class="form-control" ${mand_status_1} id="reminderNote"  maxlength="40" value=""  >
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(assetDetails) > 0}">
                                                        <c:forEach items="${assetDetails}" var="list">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" readonly placeholder="Org Name" id="reminderDate" value="${type.reminderDate}" class="form-control datepicker2"  name="reminderDate" maxlength="98" >
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" readonly placeholder="Org Name" id="reminderDate" value="${type.reminderDate}" readonly class="form-control datepicker2"  name="reminderDate" maxlength="98" >
                                                    ...
                                                    <c:otherwise>                                                    
                                                       <input type="text" disabled placeholder="Org Name" id="reminderDate" class="form-control datepicker2" maxlength="98" >
                                                    </c:otherwise>        
                                                </c:choose>
...
<!--                                                    <div class="col-md-4 form-floating mb-3">
                                            ...
                                            <div class="col-md-4 form-floating mb-3">
                                               ...
                                               <div class="col-md-4 form-floating mb-3">
                                                       ...
                                                       <div class="col-md-4 form-floating mb-3">
                                                           <input type="text" readonly="" placeholder="Org Name" id="docname" class="form-control"  name="groupName" maxlength="98"  value="${list.assetName}" onkeypress="firstToUpperCase1(event);">
                                                        <label for="groupname"><span style="color:red">*</span> Document Name</label>
                                                    </div>
                                               <div class="col-md-4 form-floating mb-3">
                                                   <input type="text" readonly=""class="form-control" name="clientType" placeholder="Category" id="doccategory" maxlength="98">
...
<input type="text" readonly="" class="form-control" name="clientType" placeholder="Category" id="doctype" maxlength="98" >
<!-- <select class="form-control" name=''>
                                                    ...
                                                    <div class="col-md-4 form-floating mb-3 pick1">
                                                        <input disabled type="text" placeholder="Org Name" id="docexpiry" class="form-control datepicker1"  name="groupName" maxlength="98"  onkeypress="firstToUpperCase1(event);">
                                                  ...
                                                  <div class="mt-3 col-lg-12" style="height: auto;width: 100%;border: 1px solid grey;overflow-x: scroll">
                                                    ...
                                                    <tbody id="resourcetable">
                                                        ...
                                                        <tr>
                                                                        ...
                                                                        <td class=" "style="text-align: left;">${list.documentDateOfUploadDate}</td>
                                                                        <td class=" "style="text-align: left;">${list.documentExpirtyDate}</td>
