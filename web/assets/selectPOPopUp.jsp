<%-- 
    Document   : selectSubAssetPopUp
    Created on : 11 Nov, 2016, 10:47:59 AM
    Author     : Garun Mishra
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                window.opener.document.getElementById('poName').value = val1;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <c:forEach items="${poList}" var="type">
                                    ...
                                    <tr onclick="test('${type.purchaseOrderNo}', '${type.purchaseOrderDate}');">
                                        <td class="center" style="text-align: left;">${type.purchaseOrderNo}</td>
                                        <td class="center" style="text-align: left;">${type.purchaseOrderDate}</td>
                            ...
                            <input type="hidden" id="acessCode" value="${accessoryCode}">
                        </form>
                    </div>
                </div>
            </div>
