<%-- 
    Document   : gmcApprovalForm
    Created on : Oct 18, 2016, 10:00:34 AM
    Author     : EBS-SDD15
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function mandatoryFilds() {
                ...
                if (document.getElementById("approverRemarks1").value == "") {
                    alert("Enter remarks");
                    return false;
                }
                else {
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Material Return&tab=Approval 1&pagetype=form"/>
                                <div class="x_title">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form class="form-inline" id="rejectFormid" action="../quality/gmcApprovalSubmit.htm"  method="post" enctype="multipart/form-data">
                                        ...
                                        <div>
                                            <c:if test="${action ne 'view'}">
                                                ...
                                                <!--                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                            <br/>
                                                                                            <br/>
                                                                                            <input type="text" name="approverRemarks1" id="approverRemarks1"  autocomplete="off" placeholder="Remarks" maxlength="100" style="width:450px;  height:50px"/>
                                                                                        </div>-->
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <textarea class="form-control" rows="1" style="resize: none" maxlength="200" value="" autocomplete="off"  name="approverRemarks1" id="approverRemarks1" type="text"></textarea>
                                                </div>

                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                    <input class="btn btn-primary" value="Save" type="button" onclick="mandatoryFilds();">
                                                    <a href="../quality/gmcApprovalList.htm" class="btn btn-danger">Cancel</a>
                                                </div>
