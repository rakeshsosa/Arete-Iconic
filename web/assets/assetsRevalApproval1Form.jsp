<%-- 
    Document   : assetsRevalApproval1Form
    Created on : 8 Feb, 2018, 5:49:30 PM
    Author     : ebs05
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function reject(SNo, status)
            {
                var remarks = $('#reviewerComments1').val();
                if (remarks == null || remarks == '') {
                    alert("Please Write Remarks..!!");
                    return  false;
                } else {
                    window.location.href = "../assetsm/assetsRevalrejectedSubmit.htm?SNo=" + SNo + "&reviewerRecordStatus=" + status + "&reviewerComments1=" + remarks + "";
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Property Revaluation&tab=Approval 1&pagetype=form"/>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="userform" method="post" enctype="multipart/form-data" name="form" class="form-inline" action="../assetsm/assetsRevalApproval1Submit.htm" onsubmit="return formValidate();">
                                        <%-- Set the Attribute  --%>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <textarea  rows="2" class="form-control" id="reviewerComments1" required="" style="resize: none" name="reviewerComments1" maxlength="120"></textarea> 
                                        </div>
                                        ...
                                        <c:if test="${action ne 'view'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                ...
                                                <button type="button" class="btn btn-warning" style="" onclick="reject('${SNo}', 'REJECTED');">Reject</button>
                                                <a href="../assets/assetsRevalApproval1List.htm" class="btn btn-danger">Cancel</a>
                                            </div>
