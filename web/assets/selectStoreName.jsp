    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                ...
                window.opener.document.getElementById('storeName').value = val1;
                window.opener.document.getElementById('storeID').value = val2;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${storeName}" var="type">

                                        <tr onclick="test('${type.storeName}', '${type.storeID}');">                                            
                                            <td class="center" style="text-align: left;">${type.storeName}</td>
                                            <td class="center" style="text-align: left;">${type.storeID}</td>
