<%-- 
    Document   : assetsRevalApproval1List
    Created on : 8 Feb, 2018, 5:52:30 PM
    Author     : ebs05
--%>
                        ...
                        <div class="row top_tiles">
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Property Revaluation&tab=Approval 1&pagetype=list"/>
                                        <div class="row">
                                                                    ...
                                                                    <tr class="even pointer">
                                                                        ...
                                                                        <td class=" last " style="text-align: left;">
                                                                            <c:if test="${approve eq 'y'}">           
                                                                                <a class="fa-file-exclamation" title="Need Approval"  href="../assetsm/assetsRevalApproval1Form.htm?SNo=${list.SNo}&assetCode=${list.assetCode}&revaluationNo=${list.revaluationNo}&action=edit">
