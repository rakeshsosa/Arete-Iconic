...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <table  class="table table-striped responsive-utilities jambo_table" id="itemsTableDocuments">
            ...
            <tbody id="">               
                <c:choose>
                    <c:when test="${fn:length(revaluationDocuments) > 0}">
                        <c:forEach items="${revaluationDocuments}" var="attach">
                            <c:choose>
                                ...
                                <td><c:if test="${not empty attach.filename}">
                                        <a   href="../assets/assetAttachDownload.htm?sno=${attach.SNo}" class="fa fa-file-pdf-o" style="color: #000">${attach.filename}
