    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function rejected()
            {
                ...
                document.getElementById("qualityStatus").value = "Rejected";
            ...
            function validateExpiryDate(obj1) {
                var curId1 = obj1.id;
                var val1 = curId1.charAt(0);
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-inline" id="quality" action="../quality/qualityFormSubmit.htm"  method="post" enctype="multipart/form-data">
                                        ...
                                        <c:set var="j" value="0"/>
                                        <c:forEach items="${qualityList}" var="list">
                                            ...
                                            <c:if test="${j eq 0}">
                                                ...
                                                <c:set var="qaBy" value="${list.userId}"/>
                                                ...
                                                <c:set var="qaDate" value="${list.qaDate}"/>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                            ...
                                            <div class="col-md-5  form-inline">   <label class="control-label">Supplier Invoice Date:</label></div> <div class="col-md-5 col-sm-6 col-xs-6 form-inline"> <fmt:formatDate pattern="dd-MMM-yyyy" value="${customerInvoiceDate}" />
                                                <input name="customerInvoiceDate" type="hidden" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${customerInvoiceDate}" />" tabindex="-1"/>
                                            </div>
                                            <p>&nbsp;</p>  
                                            <div class="col-md-5 form-inline"> <label class="control-label">QA Date:</label></div> <div class="col-md-5 col-sm-6 col-xs-6 form-inline"> <fmt:formatDate pattern="dd-MMM-yyyy" value="${qaDate}" />
                                                <input name="qaDate" type="hidden" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${qaDate}" />" tabindex="-1"/>
                                            </div>
                                            ...
                                            <c:if test="${fieldStatus_19 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <input type="text" readonly=""  class="form-control" ${mand_status_19} id="batchNo" name="batchNo" maxlength="40" value="${batchNo}">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                            ...
                                            <c:if test="${fieldStatus_2 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <input type="text" readonly=""  class="form-control" ${mand_status_2} id="qaBy" name="qaBy" maxlength="60" value="${qaBy}">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(accessoryDetails) > 0}">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>                                                    
                                                                    <input type="text" placeholder="" class="form-control" ${mand_status_3} id="customerInvoiceNo" readonly="" name="customerInvoiceNo"  maxlength="60" value="${customerInvoiceNo}" >
                                                                </c:otherwise>        
                                                            </c:choose>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <input type="text" readonly=""  class="form-control" ${mand_status_3} id="customerInvoiceNo" name="customerInvoiceNo" maxlength="60" value="${customerInvoiceNo}">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                            ...
                                            <c:if test="${fieldStatus_9 eq 'y'}">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <input type="text" readonly=""  class="form-control" ${mand_status_9} id="inventoryLocation" name="inventoryLocation" maxlength="40" value="${inventoryLocation}" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <table class="table table-striped responsive-utilities jambo_table bulk_action" id="">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${qualityList}" var="type">
                                                                ...
                                                                <c:set var="foc1" value="${type.foc}"/>
                                                                <c:set var="qty" value="${type.orderedQty}"/>                                                                      
                                                                <c:set var="receivedQty" value="${type.receivedQty}"/>
                                                                <c:set var="qtyAccepted" value="${type.qtyAccepted}"/>
                                                                <c:set var="qtyRejected" value="${type.qtyRejected}"/>
                                                                <c:set var="expiryDate" value="${type.expiryDate}"/>
                                                                <c:set var="warrantyPeriod" value="${type.warrantyPeriod}"/>
                                                                ...
                                                                <tr class="even pointer">
                                                                    ...
                                                                    <td >
                                                                        <input class="form-control " style="text-align: right;" readonly="" name="orderedQty"  value="${qty}" type="text">
                                                                    </td>
                                                                    <td >
                                                                        <input class="form-control " style="text-align: right;" readonly required name="receivedQty"  value="${receivedQty}" onkeypress="return isNumberKey1(event)" onchange="return valRecQty(this);" type="text">
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control " style="text-align: right;" readonly required name="qtyAccepted"  value="${qtyAccepted}" type="text" onkeypress="return isNumberKey1(event)" onchange="return qryVal(this);">
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control " style="text-align: right;" readonly required name="qtyRejected" value="${qtyRejected}" type="" readonly="">
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control " style="text-align: right;" readonly required name="foc" id="foc" value="${foc1}"  type="text">
                                                                    </td>

                                                                    <td>
                                                                        <input class="form-control validate[required]"  required style="text-align: left;"  readonly="" type="text" name="expiryDate" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${expiryDate}" />">   

                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control " style="text-align: right;" readonly name="warrantyPeriod" required  value="${warrantyPeriod}" type="text" >                                                 
                                                                    </td>
                                                                </tr>
