...
//                var basement01 = document.getElementById("basement").value;
//                var basement02 = document.getElementById("basement").value;
//
//                if (mezzanineFloor1 == 'Y' || basement01 == 'Y' || basement02 == 'Y') {
...
//                var floor2 = new Option(base1, base1);
//                var floor3 = new Option(base2, base2);
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Property Details&tab=Floor Details&pagetype=form"/>
                                <div class="x_title">
                                    <h2>Floor Details</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <br />
                                    <form class="form-inline" id="subassetsForm" action="../assets/subAssetsDetailsFormSubmit.htm"  method="post" enctype="multipart/form-data" onsubmit="return checkGrid();">
                                        ...
                                        <c:if test="${fieldStatus_2 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" placeholder=""  class="form-control" ${mand_status_2} id="assetName" readonly="" name="assetName" maxlength="40" value="" onkeypress="return isNumberKey3(event)" onfocus="return changeFloor();">
                                            ...
                                            <c:if test="${fieldStatus_3 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
    <!--                                                        <input type="text" placeholder="" class="form-control" ${mand_status_3} id="floor"  maxlength="40" value="" onkeypress="return isNumberKey3(event)">-->
                                                            ...
                                                            <input type="hidden" id="mezzanineFloor" value="" onfocus="return changeFloor();">
                                                            <input type="hidden" id="basement" value="" onfocus="return changeFloor();">
                                                            <!--<input type="hidden" id="basement2" value="" onfocus="return changeFloor();">-->
                                            ...
                                            <c:if test="${fieldStatus_4 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="subAssetName"  maxlength="40" value="" onkeypress="return isNumberKey3(event)" onchange="return checkSubAssetName();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(assetDetails) > 0}">
                                                            <c:forEach items="${assetDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" ${mand_status_5} readonly="" id="subAssetType"  value="${list.subAssetType}">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <select id="subAssetType" ${mand_status_5} class="form-control">
                                                                <option value="" disabled selected>Select your option</option>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(assetDetails) > 0}">
                                                            <c:forEach items="${assetDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" id="area"  maxlength="20" value="${list.area}" onkeypress="return checkdigit(event, this, 10, 2);">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>   
                                                            <input type="text" placeholder=""  class="form-control" id="area" ${mand_status_8} maxlength="20" value="" onkeypress="return checkdigit(event, this, 10, 2);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_10 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control"  id="utilityNo1"  maxlength="20" value="" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_11 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control"  id="utilityNo2"  maxlength="20" value="" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_13 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise> 
                                                            <input type="text" placeholder="" class="form-control" id="valueOfSubAsset"  maxlength="10" value="" onkeypress="return checkdigit(event, this, 10, 2);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_14 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="minimumRentFixed"  maxlength="10" value="" onchange="return calcArea();" onkeypress="return checkdigit(event, this, 10, 2);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_15 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder=""  class="form-control"  id="actualRent"  maxlength="10" value="" onkeypress="return checkdigit(event, this, 10, 2);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_16 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <a style="font-size: 15px;margin-top:-21px;color:transparent;font-weight: bold;">*</a>
                                                    <label style="margin-top:-21px;" class="control-label">${field_16}</label>
                                                    <c:choose>
                                                        <c:when test="${fn:length(assetDetails) > 0}">
                                                            <c:forEach items="${assetDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" ${mand_status_16} readonly="" id="remarks"  maxlength="200" value="${list.remarks}" onkeypress="return isNumberKey(event)">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <textarea  class="form-control" ${mand_status_16} id="remarks" style="resize: none" maxlength="200" value="" type="text"></textarea>
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_17 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_17} id="attr1" name="attr1" maxlength="35" value="" onchange="return validateEmail(event);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_18 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_18} id="attr2" name="attr2" maxlength="35" value="" onchange="return validateEmail(event);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_19 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_19} id="attr3" name="attr3" maxlength="35" value="" onchange="return validateEmail(event);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_20 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_20} id="attr4" name="attr4" maxlength="35" value="" onchange="return validateEmail(event);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_21 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_21} id="attr5" name="attr5" maxlength="35" value="" onchange="return validateEmail(event);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                            <c:if test="${fieldStatus_12 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>   
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_12} id="valueOfSubClassifiedAsset"  maxlength="10" value="" onkeypress="return checkdigit(event, this, 10, 2);">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_6 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" ${mand_status_6} id="width"  maxlength="10" value="" onchange="return calcArea();" onkeypress="return isNumberKey(event)">
                                                        </c:otherwise>        
                                                    </c:choose>
                                            ...
                                            <c:if test="${fieldStatus_7 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder=""  class="form-control" ${mand_status_7} id="length"  maxlength="10" value="" onchange="return calcArea();" onkeypress="return isNumberKey(event)">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <table  class="table table-striped responsive-utilities jambo_table" id="membertable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><span style="color:red">*</span> Flat Type</th>
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${action eq 'edit'}">
                                                                                <select id="floor" name="floor"  autocomplete="off" class="form-control" value="${type.floor}"  onfocus="return changeFloor();">
                                                                                    ...
                                                                                    <input type="hidden" id="mezzanineFloor" value="${type.floor}" onfocus="return changeFloor();">
                                                                                     <input type="hidden" id="basement" value="${type.floor}" onfocus="return changeFloor();">
                                                                                    <input type="hidden" id="subCode1" value="">
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when test="${action eq 'edit'}">
                                                                                ...
                                                                                <select id="subAssetType" ${mand_status_5} class="form-control" value="${type.subAssetType}">
                                                                                    <option value="" disabled selected>${type.subAssetType}</option>
                                                                                    <c:forEach items="${flattypes}" var="types1">
                                                                                        <option value="${types1}" >${types1}</option>                                            
                                                                                    </c:forEach>
                                                                            ...
                                                                            <c:otherwise>
                                                                                <input class="form-control" style="text-align: left;" readonly autocomplete="off" type="text" maxlength="100" value="${type.subAssetType}">
                                                                            </c:otherwise> 
                                                                        </c:choose>
                                                                    </td>
                                                                    <td>
