...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <main id="main" class="main">
            <div>
                <jsp:include page="../login/headerlink.htm?submodule=Service Request&tab=Approval 1&pagetype=list"/>
            </div>
            <div class="pagetitle">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title"><h5>Service Request Approval 1 List</h5></div> 
                                                ...
                                                <tr class="even pointer">                                                                   
                                                    ...
                                                    <td class="center" style="text-align: left;">
                                                        <c:if test="${approve eq 'y'}">
                                                            <a class="fa-file-exclamation" title="Need Approval" style="" href="../serviceReq/serviceRequestAppForm.htm?pk=${list.sno}&serviceRequestNo=${list.serviceRequestNo}&propertyName=${list.propertyName}&propertyNo=${list.propertyNo}&action=edit">
