        ...
        <script>
            ...
            function calTotal($this, sno)
            {
                ...
                if (qty === "0") {
                    ...
                    alert("Please Check the Issuing Quantity...!!")
                    $itemRow.find('#issuingqty' + sno).val("");
                    return false;
                }
        ...
        <div class="container body">
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="x_panel">
                            <jsp:include page="../login/headerlink.htm?submodule=Material Issue&tab=Material Issue&pagetype=form"/>
                            ...
                            <form class="form-inline" method="post" action="../serviceReq/materialIssueSubmit.htm" id="imForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12" style="float:right">
                                        ...
                                        <c:if test="${action eq 'edit'}">
                                            <div> <h5> <strong><a style="color:red;">*</a>Issued By:</strong> <input class="form-control" name="issuedBy" value="" required type="text" onkeypress="return isNumberKey4(event)"></h5>
                                            </div>
                                            <div> <h5> <strong><a style="color:red;">*</a>Issued To:</strong> <input class="form-control" name="issuedTo" required value="" type="text" onkeypress="return isNumberKey4(event)"></h5>
                                            </div>
                                        </c:if>
                                                                            ...
                                                                            <c:if test="${list.itemCode eq mass.itemCode}">
                                                                                <c:if test="${list.itemCode eq type.itemCode}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="center" style="text-align: right;">${type.stockQty}<input  style="width: 100px;text-align:center;" class=" form-control" readonly name="totalStock" id="totalStock${list.sno}" type="hidden" value="${type.stockQty}"></td>
                                                                                        <td class="center" style="text-align: right;">${list.qty}<input  style="width: 100px;text-align:center;" class=" form-control" readonly name="reqQty" id="reqQty${list.sno}"type="hidden" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.qty}" />"><input type="hidden" id="price${list.sno}" name="price" value="${list.unitPrice + list.margin}"/></td>
                                                                                        <td class="center" style="text-align: right;"><input  style="width: 100px;text-align:center;background-color: rgb(246, 246, 229);" class=" form-control input-mini" onpaste="return false" autocomplete="off" required="" name="issuingqty" id="issuingqty${list.sno}" maxlength="14" onkeypress="return check_digit(event, this, 10, 3);" onkeyup="calTotal(this,${list.sno});" type="text" value=""></td>
                                                                                        <td class="center" style="text-align: right;"><input  style="width: 100px;text-align:center;" class=" form-control" readonly name="totalPrice" id="totalPrice${list.sno}" type="text" value=""><input type="hidden" id="invent${list.sno}" name="invent" value=""/></td>
                                                                                    </tr>
                                    ...
                                    <br/><c:if test="${action ne 'view'}">
                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                            ...
                                            <a href="../serviceReq/materialIssueList.htm" class="btn btn-danger">Cancel</a>
                                        </c:if>
