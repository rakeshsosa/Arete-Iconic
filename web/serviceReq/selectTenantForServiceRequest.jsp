<%-- 
    Document   : selectTenantForServiceRequest
    Created on : 21 May, 2018, 12:40:12 PM
    Author     : ebs-sdd10
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5) {
                window.opener.document.getElementById('tenantUniqueNo').value = val1;
                window.opener.document.getElementById('propertyName').value = val4;
                window.opener.document.getElementById('propertyNo').value = val5;
                window.opener.document.getElementById('assetCode').value = val2;
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectTenant}" var="type">
                                        ...
                                        <tr onclick="test('${type.tenantCode}', '${type.assetName}', '${type.subclassifiedAstno}', '${type.assetNames}', '${type.flatNo}');">                                            
                                            ...
                                            <td class="center" style="text-align: left;">${type.flatNo}</td>
                                        </tr>
                                    </c:forEach>
