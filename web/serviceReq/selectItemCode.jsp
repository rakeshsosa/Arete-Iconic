                                ...
                                <tbody class="vamsi">
                                    <c:forEach items="${itemmaster}" var="list">
                                        <tr>
                                            ...
                                            <td><input type="checkbox" id="chk1" name="chk1" onclick="getVal(this);" value="${list[0]}/${list[1]}/${list[2]}/${list[3]}/"/></td>
                                            <td class="center" style="text-align: left;"onclick="test('${list[0]}', '${list[1]}', '${list[2]}', '${list[3]}');">${list[0]}</td>
                                            <td class="center" style="text-align: left;"onclick="test('${list[0]}', '${list[1]}', '${list[2]}', '${list[3]}');">${list[1]}</td>
                                            <td class="center" style="text-align: left;"onclick="test('${list[0]}', '${list[1]}', '${list[2]}', '${list[3]}');">${list[2]}</td>
                                            <td class="center" style="text-align: left;"onclick="test('${list[0]}', '${list[1]}', '${list[2]}', '${list[3]}');">${list[3]}</td>
