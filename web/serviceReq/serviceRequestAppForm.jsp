...
//                $itemRow.find('#reqQty' + sno).val("");
    ...
    function reject(srNo, status)
    {
        ...
        if (remarks == null || remarks == '') {
            ...
            window.location.href = "../serviceReq/serviceRequestAppFormReject.htm?srNo=" + srNo + "&recordstatus=" + status + "&appremarks=" + remarks + "";
        }
    }
    function recheck(srNo, status)
    {
        var remarks = $('#appremarks').val();
        if (remarks == null || remarks == '') {
            alert("Please Write Remarks..!!");
            ...
            window.location.href = "../serviceReq/srreCheckSubmit.htm?srNo=" + srNo + "&recordstatus=" + status + "&appremarks=" + remarks + "";
        }
    }
</script>
...
<body class="nav-md">
        ...
        <main id="main" class="main">
            <div>
                <jsp:include page="../login/headerlink.htm?submodule=Service Request&tab=Approval 1&pagetype=form"/>
            </div>
            <div class="pagetitle">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h5>Service Request Approval 1</h5>
                                </div>
                                <form id="ServiceRequest" class="form-inline row" action="../serviceReq/serviceRequestAppFormSubmit.htm" method="post" onsubmit="return checkGrid();">
...
//
                                                                            ...
                                                                            <c:if test="${list.itemCode eq mass.itemCode}">
                                                                                <c:if test="${list.itemCode eq type.itemCode}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="center" style="text-align: left;">${type.stockQty}</td>
                                                                                        <td class="center" style="text-align: left;"><fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.qty}" /></td>
                                                                                        <td class="center" style="text-align: left;"><fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.unitPrice}" /></td>
                                                                                        <td class="center" style="text-align: left;"><fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.margin}" /></td>
                                                                                        <td class="center" style="text-align: left;"><fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.totalPrice}" /></td>
                                                                                    </tr>
                                                                        ...
                                                                        <c:if test="${list.itemCode eq mass.itemCode}">
                                                                            <c:if test="${list.itemCode eq type.itemCode}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="center"><input  style="width: 100px;text-align:right;background-color: rgb(246, 246, 229);" class=" form-control input-mini" onpaste="return false" autocomplete="off" required="" name="reqQty" id="reqQty${list.sno}" maxlength="14" onkeypress="return check_digit(event, this, 10, 3);" onkeyup="calTotal(this,${list.sno});" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.qty}" />"></td>
                                                                                    <td class="center"><input  style="width: 100px;text-align:right;background-color: rgb(246, 246, 229);" class=" form-control input-mini" onpaste="return false" autocomplete="off" required="" name="unitPrice" id="unitPrice${list.sno}" maxlength="14" onkeypress="return check_digit(event, this, 10, 3);" onkeyup="calTotal(this,${list.sno});" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.unitPrice}" />"></td>
                                                                                    <td class="center"><input  style="width: 100px;text-align:right;background-color: rgb(246, 246, 229);" class=" form-control input-mini" onpaste="return false" autocomplete="off" required="" name="marginPrice" id="marginPrice${list.sno}" maxlength="14" onkeypress="return check_digit(event, this, 10, 3);"  onkeyup="calTotal(this,${list.sno});" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.margin}" />"></td>
                                    ...
                                    <c:if test="${action ne 'view'}">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                            ...
                                            <button type="button" class="btn btn-dark" onclick="recheck('${serviceRequestNo}', 'Recheck');">Recheck</button>
                                            <button type="button" class="btn btn-warning" style="" onclick="reject('${serviceRequestNo}', 'Rejected');">Reject</button>
                                            <a href="../serviceReq/serviceRequestAppList.htm" class="btn btn-danger" style="">Cancel</a>
                                        </div>
                                        <!--</div>-->  
                                    </c:if>
                                </form>
