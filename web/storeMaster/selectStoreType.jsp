    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                alert(val1);
                  window.opener.document.getElementById('storeType').value = val1;
//                window.opener.document.getElementById('storeTypeID').value = val2;         
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${storeTypelist}" var="type">

                                        <tr onclick="test('${type[2]}', '${type[3]}');">                                            
