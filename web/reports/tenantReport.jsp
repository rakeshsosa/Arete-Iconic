                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="control-label" style="padding-right: 40px;"><span style="color: red">*</span>Report&nbsp&nbspType</label>
                                                ...
                                                <select id="name" class="form-select" required onchange="showReports();" class="hello">
                                                    ...
                                                    <option id="name" value="tenant">Tenant&nbsp&nbspReport&nbsp&nbspGeneration</option>  
                                                </select>
                                          
                                        </div>
                                        
                                  <div class="col-md-4 mb-3" id="report1">
                                            <label class="control-label"><span style="color: red">*</span>Tenant Report Name</label>
...
<!--                                                      <option value="AgingReport">Aging Report</option>
                                                       <option value="AccReceivableReport">Account Receivable Report</option> note : - This two report added under Finance Module-->
...
<!--                                       <div class="col-md-4 mb-3 pickledger1" id="agingFromDate">
 ...
 <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>  Select Tenant Report Generation and select the format:  PDF, HTML, EXCEL, and CSV, and Click Generate or Reset. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
...
//                   $('#accReceivableToDate').hide();
                    $('#ledgerNoHide').show();
                    $('#ledgerUserIdHide').show();
                     $('#ledgerFromDate').show();
                        $('#ledgerToDate').show();
                        
                }
                  else if (a == "ProfitAndLoss")
                  {   
//                 $('#userIDForAgingHide').hide();
//                     $('#reportTypeAgingHide').hide();
//                       $('#selectTypeAgingHide').hide();
