<%-- 
    Document   : workflowViewEdit
    Created on : 17 Jan, 2018, 11:55:46 AM
    Author     : ebs05
--%>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="paymentform" class="form-inline" action="../login/workflowSubmit.htm">
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-inline">
                                            ...
                                            <input type="hidden" class="form-control" name="submodulename1" id="submodulename1" value="${submodulename}" >
                                            ...
                                            <select   id="submodulename" name="submodulename" class="form-control validate[required]"data-toggle="tooltip" data-placement="right" title="Sub Module Name">
                                                <option selected="true" value="${submodulename}">${submodulename}</option>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-inline">
                                            ...
                                            <input type="hidden" class="form-control" name="tabname1" id="tabname1" value="${tabname}" >
                                            ...
                                            <select   id="tabname" name="tabname" class="form-control validate[required]"data-toggle="tooltip" data-placement="right" title="Tab Name" >
                                                <option selected="true" value="${tabname}">${tabname}</option>
...
<!--                                            <input type="hidden" class="form-control" name="Role1" id="Role1" value="${list1.roleName}" >-->
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-inline">
                                            ...
                                            <!--                                            <input type="user1" class="form-control" name="user1" id="Role1" value="" >-->
