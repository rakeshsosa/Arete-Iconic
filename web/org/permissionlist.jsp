...
<title>Arete Iconic</title>
    ...
    <body class="nav-md">
        ...
        <main id="main" class="main">
            <div class="mt-3">
                <jsp:include page="../login/headerlink.htm?submodule=User Role&tab=Role Permission&pagetype=list"/>
            </div>
            <div class="pagetitle">
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr class="headings">
                                                <th style="width:35%;">Organisation Name</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${permlist}" var="list">
                                                ...
                                                <tr class="even pointer">
                                                    ...
                                                    <td class="" >
                                                        <a href="../login/permissionedit.htm?roleName=${list[1]}" class="fa fa-pencil-square-o fa-lg" title="Edit"></a>&nbsp;
                                                    </td>
        ...
        tippy('#information', {
            content: '<p>  Edit, Create, and Search Organisation Name, and Role Name. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
