...
<title>Arete Iconic</title>
                    ...
                    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            <div class="mt-3">
                                <jsp:include page="../login/headerlink.htm?submodule=User Role&tab=Department Module&pagetype=form"/>
                            </div>
                            <div class="pagetitle">
                                                ...
                                                <form class="row" action="../login/rolesubmit.htm">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>                                                    
                                                                <select class="form-control" required="" onchange="test(this.value)">
                                                                    <option></option>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:length(rolelist) > 0}">
                                                                <c:forEach items="${rolelist}" var="list">
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input type="text" class="form-control" required="" name="deptCode" value="${list.departmentCode}">
                                                                        </c:when>
                                                                        <c:otherwise>
            
                                                                            <input type="text" class="form-control" value="${list.departmentCode}">
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
            ...
            //                    alert("Please Enter Only Alphabets");
                                                            ...
                                                            <c:when test="${fn:length(rolelist) > 0}">
                                                                <c:forEach items="${rolelist}" var="list">
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <input type="text" class="form-control" value="${list.roleCode}">
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" required="" name="rolecode">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                            ...
                                                            <c:when test="${fn:length(rolelist) > 0}">
                                                                <c:forEach items="${rolelist}" var="list">
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <input type="text" class="form-control" value="${list.roleName}">
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
                                                            <c:otherwise>                                                    
                                                                <input type="text" placeholder="" class="form-control" required="" name="rolename" onkeypress="return isNumberKey4(event)">
                                                            </c:otherwise>        
                                                        </c:choose>
                                                            ...
                                                            <c:when test="${fn:length(rolelist) > 0}">
                                                                <c:forEach items="${rolelist}" var="list">
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <textarea  class="form-control"  rows="1" style="resize: none">${list.roleDesc}</textarea>
                                                                        </c:otherwise> 
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </c:when>
                                                    ...
                                                    <c:if test="${action ne 'view'}">
                                                        <div class="col-md-12 col-sm-9 col-xs-12 col-md-offset-4">
                                                            ...
                                                            <a href="../login/modulelist.htm" class="btn btn-danger">Cancel</a>
