<%-- 
    Document   : selectAssetDetails1
    Created on : 14 Dec, 2018, 5:15:28 PM
    Author     : Lakshmi
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4, val5) {
                ...
                window.opener.document.getElementById('blockNo').value = val4;
                window.opener.document.getElementById('plotNo').value = val5;
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectAssetDetails}" var="type">
                                        ...
                                        <tr onclick="test('${type.assetCode}', '${type.assetName}', '${type.assetBuilding}', '${type.blockNo}', '${type.assetPlotNo}');">                                            
