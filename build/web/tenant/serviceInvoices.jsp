...
<jsp:include page="../login/menu.htm" />
   ...
   <main id="main" class="main">
       <div class="mt-3">
     <jsp:include page="../login/headerlink.htm?submodule=Manage Invoice&tab=Service Invoices&pagetype=list"/>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table datatable table-hover table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${serviceInvoicesList}" var="type">
                                        <tr>
...
<!--                                         <td id="qtnno">Test</td>-->
                                         ...
                                         <td class="text-nowrap">
                                            ...
                                            &nbsp;
                                            <a href="../finance/standardInvoiceFormView.htm?SNo=${type.SNo}" class="fa fa-pencil fa-lg" title="" data-toggle="tooltip" data-bs-original-title="Edit" aria-label="Edit"></a>                                    
                                            <a
