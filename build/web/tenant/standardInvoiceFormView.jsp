                        ...
                        <form id="coustmermnForm" autocomplete="off" name="frm" accept-charset="UTF-8" method="post" action="../finance/standardInvoiceFormSubmit.htm" enctype="multipart/form-data">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="description" class="form-control" name="description" readonly="" value="${description}" maxlength="98" required>${description}</textarea>
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Vat Applicable" id="bookID" class="form-control" name="taxCode" readonly="" value="${taxCode}" maxlength="98" required />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="propertyName" class="form-control" name="propertyName" readonly="" value="${propertyName}" maxlength="98" required onclick="return selectProperty()"/>
                                            <label for="groupname"><span style="color: red;">*</span>Property Name</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="bookID" class="form-control" name="servcieAreaDescription" readonly="" value="${servcieAreaDescription}" maxlength="98" required>${servcieAreaDescription}</textarea>
                                            <label for="groupname"><span style="color: red;">*</span>Service Area Description</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="customerName" readonly="" value="${customerName}" maxlength="98" required />
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="invoice-detail-notes">
                                                    ...
                                                    <textarea id="invoice-notes" class="form-control" name="bankAccountDetails" readonly="" value="${bankAccountDetails}" maxlength="300" style="height: 88px;" maxlength="280">${bankAccountDetails}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-row disc-rate-container mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="disc" name="discount" placeholder="" onInput="calculateDiscount()" readonly="" value="${discount}" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
