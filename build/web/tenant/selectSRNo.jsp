    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3) {
                window.opener.document.getElementById('srNo').value = val1;
                window.opener.document.getElementById('serviceDues').value = val2;
                window.opener.document.getElementById('serviceRequestedCost').value = val3;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectSRNo}" var="type">

                                        <tr onclick="test('${type[0]}', '${type[1]}', '${type[2]}');">                                            
                                            <td class="center" style="text-align: left;">${type[0]}</td>
                                            <td class="center" style="text-align: left;">${type[1]}</td>
                                            <td class="center" style="text-align: right;">${type[2]}</td>
                                            <td class="center" style="text-align: right;">${type[3]}</td>
