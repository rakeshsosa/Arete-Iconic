                ...
                <div class="card">
                        ...
                        <form id="coustmermnForm" autocomplete="off" name="frm" accept-charset="UTF-8" method="post" action="../finance/standardInvoiceFormSubmit.htm" enctype="multipart/form-data">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="invoiceNo" maxlength="98" readonly="" required value="${invoiceNo}"/>
                                            <input type="hidden" id="invoice" class="form-control" name="invoice" maxlength="98" required value="Standard Invoice" />
                                            <input type="hidden" readonly id="SNo" name="SNo" class="form-control" maxlength="500" value="${SNo}" required>
                                            <label for="groupname"><span style="color: red;">*</span>Invoice</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <select class="form-select" placeholder="Category" id="invoiceType" name="invoiceType" value="${invoiceType}" maxlength="98" required>
                                                <option value="${invoiceType}" selected="selected">${invoiceType}</option>
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="description" class="form-control" name="description" value="${description}" maxlength="98" required>${description}</textarea>
                                            <label for="groupname"><span style="color: red;">*</span>Description</label>
                                        </div>

                                        <div class="col-md-4 form-floating mb-3 pick">
                                            <input type="text" class="form-control datepicker" style="pointer-events: none;" id="date" name="createdDate" placeholder="" value="<%= (new SimpleDateFormat("dd-MM-yyyy")).format(new
                                            java.util.Date())%>">
                                            <label class="control-label" for="date">Creation Date</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Vat Applicable" id="bookID" class="form-control" name="taxCode" value="${taxCode}" maxlength="98" required />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="propertyName" class="form-control" name="propertyName" value="${propertyName}" maxlength="98" required onclick="return selectProperty()"/>
                                            <label for="groupname"><span style="color: red;">*</span>Property Name</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="bookID" class="form-control" name="servcieAreaDescription" value="${servcieAreaDescription}" maxlength="98" required>${servcieAreaDescription}</textarea>
                                            <label for="groupname"><span style="color: red;">*</span>Service Area Description</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="customerName" value="${customerName}" maxlength="98" required />
                                        ...
                                        <div class="col-md-4 form-floating mb-3 pick56">
                                            <input style="background: #fff;" type="text" class="form-control datepicker56" readonly="" id="QuoFromDate" name="fromDate" value="${fromDate}" placeholder="" 
                                            <label class="control-label" for="QuoExpiryDate">From Period</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3 pick57">
                                            <input style="background: #fff;" type="text" class="form-control datepicker57" readonly="" id="QuoExpDate" name="toPeriod" value="${toPeriod}" placeholder="" 
                  ...
                  <%--          <div class="accordion-item">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="invoice-detail-notes">
                                                    ...
                                                    <textarea id="invoice-notes" class="form-control" name="bankAccountDetails" value="${bankAccountDetails}" maxlength="300" style="height: 88px;" maxlength="280">${bankAccountDetails}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-row disc-rate-container mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="disc" name="discount" placeholder="" onInput="calculateDiscount()" value="${discount}" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                                                <div class="form-group form-row mb-3">
                                                    <label class="control-label col-sm-3" for="discount-rate">Amount Paid</label>
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="amounpaid" name="amountPaid" placeholder="" onInput="calculateBalanceDue()" value="${amountPaid}" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5 my-3">
                                ...
                                <a href="../finance/rentInvoiceList.htm" class="btn btn-danger ms-1">Cancel</a>
