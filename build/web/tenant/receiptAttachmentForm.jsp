<%-- 
    Document   : receiptAttachmentForm
    Created on : 27 Mar, 2018, 10:28:17 AM
    Author     : ebs-sdd41
--%>
...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <table  class="table table-striped responsive-utilities jambo_table" id="itemsTableDocuments">
            ...
            <tbody id="">               
                <c:choose>
                    <c:when test="${fn:length(receiptDocuments) > 0}">
                        <c:forEach items="${receiptDocuments}" var="attach">
                            <c:choose>
                                ...
                                <td><c:if test="${not empty attach.filename}">
                                        <a   href="../tenant/subAssetAttachDownload.htm?sno=${attach.SNo}" class="fa fa-file-pdf-o" style="color: #000">${attach.filename}
