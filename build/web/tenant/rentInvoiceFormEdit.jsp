            ...
            <div class="col-lg-12">
                        ...
                        <form id="coustmermnForm" autocomplete="off" name="frm" accept-charset="UTF-8" method="post" action="../finance/rentInvoiceFormSubmit.htm" enctype="multipart/form-data">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="invoiceNo" maxlength="98" required value="${invoiceNo}"/>
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="invoiceType" value="${invoiceType}" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Invoice Type</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="bookID" class="form-control" name="description" value="${description}" maxlength="98">${description}</textarea>
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Vat Applicable" id="bookID" class="form-control" name="taxCode" value="${taxCode}" maxlength="98" />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="bookID" value="${pdChequeNo}" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>PD Cheque No</label>
                                        </div>

                                        <div class="col-md-4 form-floating mb-3 pick55">
                                            <input style="background: #fff;" type="text" class="form-control datepicker55" readonly="" id="QuoExpiryDate" name="dueDate" value="${dueDate}" placeholder="" value="<%= (new
                                            SimpleDateFormat("dd-MM-yyyy")).format(new java.util.Date())%>">
                                            <label class="control-label" for="QuoExpiryDate">Due Date</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="lpNo" value="${lpNo}" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Lpo Number</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="propertyName" value="${propertyName}" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Property Name</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="unitName" value="${unitName}" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Unit Name / Unit Number</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="bookID" class="form-control" name="customerName" value="${customerName}" maxlength="98" />
              ...
              <%--              <div class="accordion-item">
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 mb-3 d-flex">
                                            ...
                                            <label class="control-label col-md-10 ms-2 text-left" id="amcrequire" for="amcRequired">Make Recurring</label>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="invoice-detail-notes">
                                                    ...
                                                    <textarea id="invoice-notes" class="form-control" name="bankAccountDetails" maxlength="300" value="${bankAccountDetails}" style="height: 88px;" maxlength="280">${bankAccountDetails}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-row disc-rate-container mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="disc"  name="discount" value="${discount}" placeholder="" onInput="calculateDiscount()" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                         ...
                         <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5 my-3">
                            ...
                            <a href="../contract/LeadManagementListNew.htm" class="btn btn-danger ms-1">Cancel</a>
