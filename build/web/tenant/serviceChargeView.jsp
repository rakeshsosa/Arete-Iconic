...
<!--                                                       <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                                           <input type="text" placeholder="Org Name" readonly=""  id="propertyname" class="form-control"  name="propertyname" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                                            <label class="control-label"> <a class="text-danger">*</a> Property Name</label>
                                                     </div>-->
                                            
                                        
                                                     <div class="col-md-4 form-floating mb-3">
                                                         <input type="text" placeholder="Org Name" readonly="" id="servicecategory" class="form-control"  name="servicecategory" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                                        <label for="groupname"><span style="color:red">*</span>Adhoc Service Category</label>
                                                    </div>
                                               <div class="col-md-4 form-floating mb-3">
                                                   <input type="text" placeholder="Org Name" readonly="" id="servicename" class="form-control"  name="servicename" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                                        <label for="groupname"><span style="color:red">*</span>Adhoc Service Name</label>
                                                    </div>     
                                                <div class="col-md-4 form-floating mb-3">
                                                        <select type="text" required autocomplete="off" id="adhocBillType" disabled="" name="adhocBillType" maxlength="20"  class="form-select capitalize validate[required]" value="" >
...
<!--                                                <div class="col-md-4 form-floating mb-3">
                                                    <input type="text" placeholder="Org Name" readonly="" id="ratecardno" class="form-control"  name="ratecardno" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                                        <label for="groupname"><span style="color:red">*</span>Rate Card Id</label>
                                                    </div>-->
<!--                                                   <div class="col-md-4 form-floating mb-3">
                                                        <input type="text" placeholder="Org Name" readonly="" id="ratecardname" class="form-control"  name="ratecardname" maxlength="98" required onkeypress="firstToUpperCase1(event);">
                                                        <label for="groupname"><span style="color:red">*</span>Rate Card Name</label>
                                                    </div>-->
<!--                                                      <div class="col-md-4 form-floating mb-3">
                                                          <input type="text" placeholder="Org Name" readonly="" id="serviceprice" class="form-control"  name="serviceprice" maxlength="98" required onkeypress="return isNumberKey(event)">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <label for="groupname"> <span style="color:red">*</span>Service Billing Type</label><br>
                                                         <div class="col-md-12">
                                                             <input class="" type="checkbox" disabled="" id="myCheck1"> Hour Based &nbsp;
                                                             <input class="" type="checkbox" disabled="" id="myCheck1"> Monthly Based 
...
<!--                                                        <div class="col-md-4  mb-3">
                                                            <input class="" type="checkbox" id="vatCheck" disabled="">
...
<!--                                                        <div class="col-md-4 form-floating mb-3">
                                                            ...
                                                            <input type="text" id="total" readonly="" placeholder="Org Name" class="form-control"  name="total" maxlength="98" required onkeypress="return isNumberKey(event)">
