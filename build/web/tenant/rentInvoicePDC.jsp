...
<jsp:include page="../login/menu.htm" />
   ...
   <main id="main" class="main">
       <div class="mt-3">
      <jsp:include page="../login/headerlink.htm?submodule=Manage Invoice&tab=Rent Invoices PDC&pagetype=list"/>
    </div>
...
<!--                                         <td id="qtnno">Test</td>-->
                                         ...
                                         <td class="text-nowrap">
                                            ...
                                            &nbsp;
                                            <a href="../finance/rentInvoiceFormEdit.htm?SNo=${type.SNo}" class="fa fa-pencil-square-o fa-lg" title="" data-toggle="tooltip" data-bs-original-title="Edit" aria-label="Edit"></a>                                    
                                            <a
                                             onclick="generateReceipt('Payment Received','Reciept_yaat')"
                                                data-toggle="tooltip"
                                            ...
                                            <a
                                                href="../tenant/makeRecurringForm.jsp"
...
$("#headcheck").on('click', function (e) {
     $('input:checkbox').not(this).prop('checked', this.checked);
              ...
              function generateReceipt(recordStatus,reportName) {
                        ...
                        swal("Would you like to confirm, Please write message", {
                          ...
                          .then((value) => {
                            ...
                            var url = '../inventory/yycReportData.htm?recordStatus=' + recordStatus  + '&reportName=' + reportName +'';
