...
//                window.opener.document.getElementById('Class').value = val1;
                window.opener.document.getElementById('comUtility').value = val2;
                window.opener.document.getElementById('comUtilityBillType').value = val3;
                // window.opener.document.getElementById('totUtiAmount').value = val4;
                window.opener.document.getElementById('comutilityBill').value = val5;
...
//                       
                        opener.addOrderRow_test2(split1[0], split1[1], split1[2]);
                    }
                }
...
//                window.close();
            ...
            function getVal($this) {
                ...
                opener.addOrderRow_test2(chkVal[0], chkVal[1], chkVal[2]);
            }
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:forEach items="${tenantUtilityDetails}" var="type">
                                        ...
                                        <tr>
                                            <td><input type="checkbox" id="chk1" name="chk1" value="${type.comUtility}/${type.comUtilityBillType}/${type.comutilityBill}/" onclick="getVal(this)"/></td>
                                            <td class="center" onclick="test('${type.comUtility}', '${type.comUtilityBillType}', '${type.comutilityBill}');">${type.comUtility}</td>
                                            <td class="center" onclick="test('${type.comUtility}', '${type.comUtilityBillType}', '${type.comutilityBill}');">${type.comUtilityBillType}</td>
                                            <td class="center" onclick="test('${type.comUtility}', '${type.comUtilityBillType}', '${type.comutilityBill}');">${type.comutilityBill}</td>
