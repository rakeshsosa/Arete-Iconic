...
function openPropertyList(e) {
    e.preventDefault();
    myServicePackage = window.open("../finance/selectPropertyDetailsInRentInvoice.htm", "PopWindow", "width=1000, height=550, menubar=no,location=no,top=20,left=150,scrollbars=yes,titlebar=no,toolbar=no,directories=0");
}
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="coustmermnForm" autocomplete="off" name="frm" accept-charset="UTF-8" method="post" action="../finance/rentInvoiceFormSubmit.htm" enctype="multipart/form-data">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="invoiceNo" class="form-control" name="invoiceNo" maxlength="98" required value="${orderNo}"/>
                                            <label for="groupname"><span style="color: red;">*</span>Invoice</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="invoiceType" class="form-control" name="invoiceType" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Invoice Type</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <textarea type="text" placeholder="Org Name" id="description" class="form-control" name="description" maxlength="98"></textarea>
                                            <label for="groupname"><span style="color: red;">*</span>Description</label>
                                        </div>

                                        <div class="col-md-4 form-floating mb-3 pick">
                                            <input type="text" class="form-control datepicker" style="pointer-events: none;" readonly="" id="createdDate" name="createdDate" placeholder="" value="<%= (new SimpleDateFormat("dd-MM-yyyy")).format(new
                                            java.util.Date())%>">
                                            <label class="control-label" for="date">Creation Date</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" onkeypress="isAlphaNumeric(event)" placeholder="Vat Applicable" id="taxCode" class="form-control" name="taxCode" maxlength="98" />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" onkeypress="isAlphaNumeric(event)" placeholder="Org Name" id="bookID" class="form-control" name="bookID" maxlength="98" />
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" onkeypress="isAlphaNumeric(event)" id="lpNo" class="form-control" name="lpNo" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Lpo Number</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="propertyName" class="form-control" name="propertyName" readonly="" maxlength="98" onclick="return openPropertyList(event)" />
                                            <label for="groupname"><span style="color: red;">*</span>Property Name</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="unitName" class="form-control" name="unitName" readonly="" maxlength="98" />
                                            <label for="groupname"><span style="color: red;">*</span>Unit Name / Unit Number</label>
                                        </div>
                                        <div class="col-md-4 form-floating mb-3">
                                            <input type="text" placeholder="Org Name" id="customerName" class="form-control" name="customerName" maxlength="98" />
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body row">
                                        <div style="margin-top: 20px; overflow-x: auto;" class="table-responsive">
                                            <table class="table table-condensed table-bordered rentMobileview" id="servicemyTable" style="border: 1px solid #dee2e6;">
                                                <thead class="thead">
                                                    <tr class="">
                                                        <th class="invoice-detail-margin" style="width: 2%;">&nbsp;</th>
                                                        <th class="invoice-detail-sno" style="width: 70px;">S.No</th>
                                                        <th class="invoice-detail-category">Description <a class="text-danger">*</a></th>

                                                        <th class="invoice-detail-rate">Rent Amount <a class="text-danger">*</a></th>
                                                ...
                                                <tbody class="invoice-items">
                                                    ...
                                                    <tr class="item-row item-row-1 with-tax" id="myRow">
                                                        ...
                                                        <td>
                                                            <input class="form-control" id="servicecategory${countserve}" name="rentDesc" value="" />
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input
                                                                ...
                                                                id="vatAmount"
                                                                value="0"
                                                                name="vatPercentageInRentEntity"
                                                                onInput="calcTotal()"
                                                        ...
                                                        <td class="">
                                                            <div class="d-flex">
                                                                <span class="currency"></span><span><input type="text" size="10" readonly class="form-control" value="0.00" name="itemvattotal" id="itemvattotal"  onInput="calcTotal();calculateTotal(event)"/></span>
                                                            </div>
                                                        </td>
                                                        <td class="d-flex">
                                                            <span class="currency"></span>
                                                            <span><input type="text" size="10" readonly class="form-control serviceitemtotal" style="user-select: none; outline: none;" value="0" name="totalAmt" id="itemtotal"/></span>
                                        ...
                                        <div class="col-md-12 col-sm-9 col-xs-12">
                                            <button id="invoice-item-add" title="Add Item" class="btn btn-primary mr-2" onClick="serviceaddRow(event)" style="background-color: #314c68;"><i class="fa fa-plus-circle"></i> Add Item</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-row disc-rate-container mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="disc" value="0" name="discount" placeholder="" onInput="calculateDiscount()" onchange="allowThreeDecimal(event)" min="0" />
                                                    </div>
                                                </div>
                         ...
                         <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5 my-3">
                             <button id="savebtnrent" type="submit" class="btn btn-primary mr-2 btmMobilespace">Save</button>
                            <button id="savebtnrent1" type="submit" class="btn btn-primary mr-2 btmMobilespace">Save As Draft</button>
                            <button id="savebtnrent2" type="submit" class="btn btn-primary mr-2">Save As Send</button>
                            <a href="../tenant/receivablesList.htm" class="btn btn-danger ms-1">Cancel</a>

                            <button type="button" class="btn btn-primary ms-1" onclick="window.print()">Print</button>
                            </div>
...
function showSubscripeDetails() {
 ...
 $("#savebtnrent, #savebtnrent1, #savebtnrent2").on('click', function(e) {
                e.preventDefault();
            
                var cusDetails = document.getElementById("invoiceNo").value &&
                ...
                var conDetails = document.getElementById('bookID').value &&
                ...
                var adddetaGrid = document.getElementById("servicecategory1").value &&
                                   document.getElementById("serviceitemrate1").value
                           
                                 
           
              if(cusDetails == "" || cusDetails == null) {
                    swal("Please fill the required fields in invoice details.")
                }else if(conDetails == "") {
                     swal("Please fill required fields in tenant details.")
                 }
                   else if(adddetaGrid == "") {
                     swal("Please fill the table fields in rent details.")
                 } else {
