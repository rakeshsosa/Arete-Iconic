...
<html lang="en">
    ...
    <head><link href="../common/theme/css/disableSelection.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <script>
            function test(val1, val2, val3, val4) {
                window.opener.document.getElementById('contractPeriod').value = val1;
                window.opener.document.getElementById('startsFrom').value = val2;
                window.opener.document.getElementById('endsTo').value = val3;
                window.opener.document.getElementById('contractName').value = val1;
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${contractName}" var="type">
                                        ...
                                        <tr onclick="test('${type[0]}', '${type[2]}', '${type[3]}', '${type[1]}');">                                            
