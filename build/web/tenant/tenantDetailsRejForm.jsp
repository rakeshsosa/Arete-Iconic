...
//                    alert("Please Enter Only Alphabets");
            ...
            function rentCalc() {
                ...
                var rentTenant = parseFloat(document.getElementById("totalAmount").value);
    ...
    <body class="nav-md">
        ...
        <div id="popUpDiv" style="display: none;"></div>
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include page="../login/headerlink.htm?submodule=Tenant Details&tab=Rejected Tenants&pagetype=form"/>
                            </div>
                            <div class="pagetitle">
                                            ...
                                            <c:if test="${fieldStatus_36 eq 'y'}">
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="Select Flat Name" readonly="" class="form-control" id="subclassifiedAstno" name="subclassifiedAstno" maxlength="50" value="" onkeypress="return isNumberKey3(event)" onclick="selectSubAssetDetails();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" readonly="" id="contractPeriod" name="contractPeriod" maxlength="50" value="${list.contractPeriod}" onkeypress="return isNumberKey3(event)">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="Select Contract" readonly="" class="form-control" id="contractPeriod" name="contractPeriod" maxlength="50" value=""  onclick="selectContractCode();" onblur="return getContAttach();">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" id="advanceAmount" name="advanceAmount" maxlength="10" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.advanceAmount}" />" onkeypress="return isNumberKey(event)">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="advanceAmount" name="advanceAmount" maxlength="10" value="" onkeypress="return isNumberKey(event)">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" readonly="" id="extra2" name="extra2" value="${list.extra2}">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(tenantDetails) > 0}">
                                                            <c:forEach items="${tenantDetails}" var="list">
                                                                <c:choose>
                                                                    <c:when test="${action eq 'edit'}">
                                                                        <input type="text" class="form-control" id="totalAmount" name="totalAmount" maxlength=10" value="<fmt:formatNumber type="number" groupingUsed="false" maxFractionDigits="3" value="${list.totalAmount}" />" onkeypress="return isNumberKey(event)" onchange="rentCalc();">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                        ...
                                                        <c:otherwise>                                                    
                                                            <input type="text" placeholder="" class="form-control" id="totalAmount" name="totalAmount" maxlength="10" value="" onkeypress="return isNumberKey(event)" onchange="rentCalc();">
                                                        </c:otherwise>        
                                                    </c:choose>
                                                ...
                                                <c:forEach items="${tenantDetails}" var="list">
                                                    ...
                                                    <c:if test="${gfcremarks ne null}">
                                                        <tr>
                                                            ...
                                                            <td class="center" style="text-align: left;"> <fmt:formatDate pattern="dd-MMM-yyyy" value="${list.creationDate}" /></td>
