    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                window.opener.document.getElementById('categoryNo').value = val1;
                window.opener.document.getElementById('storeCategory').value = val2;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${storecategorylist}" var="type">

                                        <tr onclick="test('${type.categoryNo}', '${type.storeCategory}');">                                            
                                            <td class="center" style="text-align: left;">${type.categoryNo}</td>
                                            <td class="center" style="text-align: left;">${type.storeCategory}</td>
