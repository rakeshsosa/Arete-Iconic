...
<html lang="en">
   ...
   <main id="main" class="main">
       <div class="mt-3">
           <jsp:include page="../login/headerlink.htm?submodule=Incoming Tax Tracking&tab=Filed Tax&pagetype=list"/>
       </div>
    <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Filled Tax List</h5></div> 
                                                                    ...
                                                                    <c:set var="status" value="${list.status}"></c:set>
                                                                       ...
                                                                       <td style="text-align: left;">${list.insuranceCompanyName}</td>
                                                                        <td class=" last text-nowrap">
                                                                            <a href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=view" class="fa fa-print fa-lg"title="Print"></a>&nbsp;
