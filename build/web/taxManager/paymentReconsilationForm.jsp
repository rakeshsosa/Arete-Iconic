 ...
 <style>
   ...
   <main id="main" class="main">
           <div>
                                ...
                                <br>
                                <div class="text-end"> 
                                    <a class="btn btn-primary btn-sm " href="../taxManager/openChequesList.htm"><i class="bi bi-eye"></i> Show Records</a>
                                </div>
                            </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Payment Reconsilation Form</h5></div> 
               <form class="row validateForm" id="coustmermnForm" accept-charset="UTF-8" method="post" action="../Transactional/calendarPeriodFormSubmit.htm" enctype="multipart/form-data" commandName="calendarPeriod">
                    ...
                    <div class="col-md-4 form-floating mb-3">
                                             <input type="text" autocomplete="off" id="voucherNumber" required="" name="voucherNumber" maxlength="10"  class="form-control capitalize validate[required]" value="" placeholder='fill'>   
                                         <label class="control-label"><span style="color:red">*</span>Invoice Number</label>
                                         </div>
                    <div class="col-md-4 form-floating mb-3">
                                             <input type="text" autocomplete="off" readonly="" id="calendarCode" required="" name="calendarCode" maxlength="10"  class="form-control capitalize validate[required]" value="" placeholder='fill'>   
                    ...
                    <div class="col-md-4 form-floating mb-3">
                                    ...
                                    <div class="col-md-4 mb-3 d-flex form-floating">
                                          
                                        
                                        <input type="text" autocomplete="off" placeholder="Fill" id="calendarCode" required="" name="calendarCode" maxlength="10"  class="form-control capitalize validate[required]">   
                                       <button class="btn btn-primary">Match</button>
                                      
                                     <label class="control-label"><span style="color:red">*</span>TRF Number</label>
