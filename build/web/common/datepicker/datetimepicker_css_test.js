...
function RenderCssCal(bNewCal)
{
    ...
    else //if not to show time.
    {
        ...
        if (UseImageFiles) {
            ...
            vCalClosing += "<span id='close_cal' title='close'onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");stopSpin();' onmouseover='changeBorder(this, 0)'onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family:calibri,verdana,Arial;font-size: 10pt;'>x</span></td>";
        }
        vCalClosing += "</tr>";
    }
    ...
    if (!winCal)
    {
        ...
        cssStr = ".calTD {font-family:calibri,verdana; font-size: 12px; text-align: center; border:0; }\n";
        cssStr += ".calR {font-family:calibri,verdana; font-size: 12px; text-align: center; font-weight: bold;}";
