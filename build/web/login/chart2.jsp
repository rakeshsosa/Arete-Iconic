<%-- 
    Document   : chart2
    Created on : Feb 19, 2016, 6:11:33 PM
    Author     : Sudhanshu
--%>
...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <script src="../common/theme/js/moris/raphael-min.js"></script>
        <script src="../common/theme/js/moris/morris.js"></script>
        <script src="../common/theme/js/moris/example.js"></script>
        <script>
            NProgress.done();
        </script>
    </body>
