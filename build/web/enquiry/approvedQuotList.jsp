                        ...
                        <div class="row top_tiles">
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Supplier Quotation&tab=Approved Quotation&pagetype=list"/>
...
<!--                                                                    <td style="width:15%;">${type[0]}</td>                                                         -->
                                                                    ...
                                                                    <td style="width:10%;">                                                                                                              
                                                                        <a class="myButton7 " href="../purchase/quotPOform.htm?quotNo=${type[2]}">
