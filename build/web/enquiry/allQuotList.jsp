                        ...
                        <div class="row top_tiles">
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Supplier Quotation&tab=Quotation Details&pagetype=list"/>
...
<!--                                                                    <td style="width:15%;">${type[0]}</td>                                                         -->
                                                                    ...
                                                                    <td style="width:15%;">${type[4]}</td>   
                                                                    <td style="width:5%;">  
                                                                        <a href="../purchase/allQuotForm.htm?quotNo=${type[2]}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
