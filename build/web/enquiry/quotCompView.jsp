            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <form class="form-horizontal" id="quotcompForm" action="../purchReq/quotCompFormSubmit.htm" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <c:forEach items="${quotList}" var="list">
                                                        <c:if test="${existItem ne list.itemCode}">
                                                            <c:if test="${type[2] eq list.itemCode}">
                                                                ...
                                                                <td><input style="width: 70px;text-align:right;" class=" form-control input-mini validate[required] validate[custom[notzero],custom[float5]]" onpaste="return false" autocomplete="off" readonly=""  name="qty" id="qty" onkeypress="return check_digit(event, this, 10, 3);"  type="text" onkeyup="validatePrice(this);" value="${list.quantity}"></td>  
                                                                <!--<td> ${list.unit}</td>--> 
                                                                <td><input style="width: 70px;text-align:right;" class="form-control  input-mini validate[custom[notzero],required,custom[float5]]" onpaste="return false" readonly required="" autocomplete="off" onkeypress="return check_digit(event, this, 6, 3);" name="price" id="price" type="text" onkeyup="validatePrice(this);" value="<fmt:formatNumber type="number" groupingUsed="false" pattern="0.000" maxFractionDigits="3" value="${list.unitPrice}"/>"></td>
                                                                <td><input style="text-align:right;width:100px;" class="form-control  input-mini  validate[required]" type="text" readonly onpaste="return false"  id="befdisc" readonly onkeyup="validatePrice(this);" value="<fmt:formatNumber type="number" groupingUsed="false" pattern="0.000" maxFractionDigits="3"  value="${list.quantity*list.unitPrice}"/>"></td>
                                                                <td>
                                                                    <input style="width: 87px;text-align:right;" class="form-control  input-mini validate[required,custom[float5]]]" onpaste="return false" autocomplete="off" readonly onkeyup="validatePrice(this);" id="discount1" onkeypress="return check_digit(event, this, 2, 3);" type="text" maxlength="6" value="<fmt:formatNumber type="number" groupingUsed="false" pattern="0.000" maxFractionDigits="3" value="${list.discount}"/>"></td>
                                                                    <input style="width: 70px;text-align:right;"  onpaste="return false" readonly autocomplete="off" name="discount" id="discount" type="hidden" value="${list.discount}">
                                                                </td>
                                                                <td><input style="text-align:right;width:100px;" class="form-control  input-mini  validate[required,custom[float5]]]" readonly type="text" onpaste="return false" onkeyup="validatePrice(this);" autocomplete="off" id="discountPrice" onkeypress="return check_digit(event, this, 10, 3);"  value="<fmt:formatNumber type="number" groupingUsed="false" pattern="0.000" maxFractionDigits="3" value="${(list.quantity*list.unitPrice)*(list.discount/100)}"/>"></td>
