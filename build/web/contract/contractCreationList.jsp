...
<!--                                        <li class="nav-item">
                                      ...
                                      <br>
                                      <div class="text-end">
                                        <a class="btn btn-primary btn-sm " href="../insurance/contractCreationForm.htm">
                                          <i class="bi bi-plus"></i> Create Contract Creation </a>
                                      </div>
                            </div>
                        </div>
                        <div class="pagetitle">
					...
					<thead>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="even pointer"> 
                                                                        ...
                                                                        <td style="text-align: left;"><fmt:formatDate pattern="dd-MM-yyyy" value="${list[5]}"/></td>
