...
<!--                                        <li class="nav-item">
                                      ...
                                      <br>
                                      <div class="text-end">
                                        <a class="btn btn-primary btn-sm " href="../insurance/contractCreationList.htm">
                                          <i class="bi bi-plus"></i> show Contract Creation </a>
                                      </div>
                            </div>
                            <div class="pagetitle">
          ...
          <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3" id="crNoHide">     
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                            <c:choose>
                                                ...
                                                <c:otherwise>                                                    
                                                    <input type="email"  placeholder="Fill" class="form-control" id="customerEmailId" name="customerEmailId" value="">
                                                </c:otherwise>        
                                            </c:choose>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-floating mb-3">     
                                            <c:choose>
                                                ...
                                                <c:otherwise>                                                    
                                                    <input type="text" onkeypress="isNumberKey(event)" maxlength="11" placeholder="Fill" class="form-control" id="phoneNo" name="phoneNo" value="">
                                                </c:otherwise>        
                                            </c:choose>
          ...
          <table class='table table-bordered col-md-4 table-responsive' id="multiPhoneNumberTable">
              ...
              <tbody>
                  <tr>
                    ...
                    <td><input type="email" placeholder="Fill" class="form-control" id="emailId" name="emailId" value=""></td>
                    <td><input type="text" maxlength="11" onkeypress="isNumberKey(event)" placeholder="Fill" class="form-control" id="phoneNumber" name="phoneNumber" value=""></td>
