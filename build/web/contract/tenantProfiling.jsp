...
<html lang="en">
   ...
   <main id="main" class="main">
    ...
    <a href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=view" class="fa fa-user-plus fa-lg" data-bs-toggle="tooltip" title="Register Tenant"></a>&nbsp;
                                                                            <a href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=view" class="fa fa-envelope fa-lg" data-bs-toggle="tooltip" title="Email"></a>&nbsp;
