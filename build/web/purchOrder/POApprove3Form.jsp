            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <form id="pogenForm" class="form-inline" method="post" action="../purchase/statusUpdate.htm" enctype="multipart/form-data">


                            <div class="x_panel">                             
                                <jsp:include page="../login/headerlink.htm?submodule=Purchase Order&tab=General Manager&pagetype=form"/>
                                <div class="x_title">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                        <thead>
                                            <tr class="headings">  
                                                ...
                                                <!--<th>Item Code</th>-->
                                                <th style="width:10%;font-size:12px">Item Sub Category</th>
                                                <th style="font-size:12px">Item Name</th>
                                                <th>Item Desc</th>                                        
                                                <th style="width:6%;font-size:12px"><span style="color: red">*</span> Quantity</th>
                                                <th style="width:5%;font-size:12px">Unit</th>
                                                <th style="width:8%;font-size:12px"><span style="color: red">*</span> Unit Price</th>
                                                <th style="width:5%;font-size:12px">Total Amount</th>
                                                <th style="width:5%;font-size:12px"><span style="color: red">*</span> Discount(%)</th>
                                                <th style="width:5%;font-size:12px"><span style="color: red">*</span> Discount Amount</th>                                                 
                                                <th style="width:15%;font-size:12px">Total Amount After Discount</th>     
                                                <th style="width:8%;font-size:12px"><span style="color: red">*</span> Delivery Date</th>                                              
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${poList}" var="type"> 
                                                <tr id="quotPoForm" style="font-size:14px;" class="poadditem">
                                                    ...
                                                    <td><input style="width: 100%;text-align:right;" class=" form-control input-mini validate[required,custom[notzero],custom[float5]]" autocomplete="off"  name="qty" id="qty" onkeypress="return check_digit(event, this, 10, 3);"  type="text" value="${type.qty}"></td>  
                                                    <td>${type.uom}
                                                    ...
                                                    <td><input style="width: 100%;text-align:right;" class="form-control  input-mini validate[required,custom[float5]]"   autocomplete="off" id="discount1" onkeypress="return check_digit(event, this, 2, 3);" maxlength="6" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" pattern="0.000" value="${type.discount}"/>"> 
                                                        <input style="width: 70px;text-align:right;"  onpaste="return false" autocomplete="off" name="discount" id="discount" type="hidden" value="${type.discount}">
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input style="width: 100%;text-align:right;" class="form-control  input-mini validate[required]" id="total" name="total" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" pattern="0.000" value="${type.totalValue}"/>" readonly=""></td>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <table id="" class="table table-striped responsive-utilities jambo_table">
                                        <thead >
                                            <tr class="headings" style="font-size:14px;">     
                                                <th>Role</th>
                                                <th>Name</th>
                                                <th>Date</th>
                                                <th>Remarks</th>
...
<!--<a href="../purchOrder/statusUpdate.htm?action=GM Rejected&poNo=${purchaseOrderNo}"></a>--> 
                                    <button type="button" class="btn btn-danger" style="" onclick="reject('${purchaseOrderNo}');" >Reject</button>
                                    <a href="../purchase/POApprove3List.htm"><button type="button" class="btn btn-danger" style="">Cancel</button></a> 
                                    <!--</div>-->
                                </div>
                            </div>
                            <br/>
...
//
//                var inputval = '#qty, #discount,#price,#requisitionUom';
...
////                        var z = $itemRow.find('#qty').val();
//                //                        var zz = $itemRow.find('#price').val();
//                //                        var ccc = $itemRow.find('#discount').val(); //                        var discount = $itemRow.find('#qty').val() * $itemRow.find('#price').val() * (1 - $itemRow.find('#discount').val() / 100);
////                        var discountfinal = roundNumber(discount, 2);
            ...
            function reject(poNo)
            {
                ...
                if (remark == '' || remark == null)
                {
                    ...
                    if (confirm('Do you really want to reject this record')) {
                        formmodified = 0;
                        window.location.href = "../purchase/statusUpdate.htm?poNo=" + poNo + "&remarks=" + remark + "&action=GM Rejected";
