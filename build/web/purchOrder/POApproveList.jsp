...
<html lang="en">
  ...
  <jsp:include page="../login/footer.jsp" />
        ...
        <main id="main" class="main">
            <div class="mt-3">
                <jsp:include page="../login/headerlink.htm?submodule=Purchase Order&tab=Purchase Manager&pagetype=list"/>
            </div>
            <div class="pagetitle">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <td style="width:12%;">${type[3]}</td>                                                                                                                                                    
                                                                    <td class=" last" style="width:10%;">
                                                                        <a href="../purchase/purchRequiView.htm?poNo=${type[0]}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
<!--                                                                        <a class="myButton" href="../purchReq/purchReqView.htm?reqNo=${type[0]}&action=view" >
                                                                        ...
                                                                        <a class="fa fa-check-circle-o fa-lg"  href="../purchase/POApproveForm.htm?poNo=${type[0]}&action=edit" style="color: green;" title="Approve">
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#example').dataTable({
                        ...
                        "bServerSide": true,
                        "aaSorting": [[0, 'desc']],
                        "sAjaxSource": "../purchase/poPaginationList.htm?listPage=approvedPoList&poStatus=PMList",
                        "aoColumnDefs": [
                            {
                                "aTargets": [0],
                                "sWidth": "150px",
                            ...
                            },
                            {
                                ...
                                "sWidth": "100px",
                                "mRender": function (data, type, full) {
                                    return '<div style=""> <a class="fa fa-check-circle-o fa-lg" style="color: green;"  href="../purchase/POApproveForm.htm?poNo=' + full[0] + '&action=edit" title="Approve">\n\
                                               </a></div>';
