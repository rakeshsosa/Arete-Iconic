                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${assetDetails}" var="type">
                                        ...
                                        <tr onclick="    <%--test('${type[0]}', '${type[1]}', '${type[2]}', '${type[6]}', '${type[4]}');">        --%>
                                            window.opener.document.getElementById('customCompanyName').value = '${type[6]}';
                                     <%--       window.opener.document.getElementById('supplierContactNumber').value = '${type[3]}';
                                            window.opener.document.getElementById('supplierEmail').value = '${type[4]}';   --%>
