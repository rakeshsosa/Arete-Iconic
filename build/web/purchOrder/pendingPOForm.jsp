            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <form id="quotform" class="form-inline" method="post" action="../purchOrder/cancelPO.htm" enctype="multipart/form-data">

                            <div class="x_panel">   

                                <jsp:include page="../login/headerlink.htm?submodule=Purchase Order&tab=Pending Purchase Orders&pagetype=form"/>
                                <div class="x_title">
                                ...
                                <c:forEach items="${supplierList}" var="supp">
                                    <c:if test="${supp.EMail eq supplierEmail}">
                                        ...
                                        <c:set var="supnumber" value="${supp.contactNumber}"/>
                                    </c:if>
                                </c:forEach>
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <div> <c:if test="${not empty poRevNo}">
                                                    ...
                                                    <input type="hidden" id="poNo" name="poNo" value="${purchaseOrderNo}"/>  
                                                </c:if>
...
<!--                                            <div> <h5> <strong>Division Name:</strong> ${divisionName}</h5>                                
                            ...
                            <div>
                                ...
                                <select disabled id="costCenter" name="costCenter" data-rel="chosen"   class="form-control validate[required]">
                                    <option value="${costcenterCode}-${costcenterDesc}">${costcenterCode}-${costcenterDesc}</option>  
                            ...
                            <div class="x_panel"> 
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                        <thead>
                                            <tr class="headings">                                                 
                                                ...
                                                <!--<th>Unit Price</th>-->
                                                <!--<th>Total Amount</th>-->
                                                <!--<th><span style="color: red">*</span> Dis(%)</th>-->
                                                <!--<th><span style="color: red">*</span> Dis Amount</th>--> 
                                                <!--<th>Total Amount After Dis</th>-->
                                                <th>Delivery Date</th>
                                                <th>Status</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${poList}" var="type"> 
                                                <tr id="quotPoForm" >                                                       
                                                    ...
                                                    <td class="right"><input class="right form-control input-mini validate[required,custom[float5]]" readonly="" autocomplete="off" required="" name="qty" id="qty" onkeypress="return isNumberKey(event)"  type="hidden" value="${type.qty}"><fmt:formatNumber type="number" pattern="#.000" groupingUsed="false"  maxFractionDigits="3" value="${type.qty}"/></td>  
                                                    <td>${type.uom}</td>
                                                    <td>0.0
                                                        <input class="form-control" id="recQty" name="recQty"  type="hidden" value="0.0"></td>
                                                    <td>0.0
                                                        <input class="form-control" id="pendQty" name="pendQty"  type="hidden" value="0.0"></td>
                                                    <!--<td id="recQty" style="text-align: right" value="0.0"></td>  
                                                    <td id="pendQty" style="text-align: right" value="0.0"></td>  -->  

                                                    <!--<td class="right"><input class="form-control  input-mini validate[required,custom[float5]]" required="" autocomplete="off" readonly="" onkeypress="return check_digit(event, this, 6, 3);" name="price" id="price" type="hidden" value="${type.unitPrice}">${type.unitPrice}</td>-->
                                                    <!--<td class="right"><fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${type.qty*type.unitPrice}"/></td>-->
                                                    <!--<td class="right"><input class="form-control  input-mini" required="" readonly=""  autocomplete="off" name="discount" id="discount" onkeypress="return check_digit(event, this, 2, 3);" type="hidden" value="${type.discount}">${type.discount}</td>-->

                                                    <!--<td class="right"><fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${(type.qty*type.unitPrice)*(type.discount/100)}"/></td>-->



                                                    <!--                                                    <td class="right">
                                                    <fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${type.totalValue}"/>
                                                    <input class="form-control  input-mini" id="total" name="total" type="hidden" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${type.totalValue}"/>" readonly=""></td>-->

                                                    <td><input class=" form-control input-small" readonly=""  name="delDate" readonly="" id="delDate" type="hidden" value="<fmt:formatDate pattern="dd-MMM-yyyy" value="${type.requiredDate}"/>" onclick="javascript:NewCssCal('reqBefore${type.SNo}', 'ddMMMyyyy', '', '', '', '', 'future')"><fmt:formatDate pattern="dd-MMM-yyyy" value="${type.requiredDate}"/></td>
                                ...
                                <c:if test="${action eq 'Cancel'}">
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <a href="../purchOrder/approvedPOList.htm"><button type="button" id="cancel" class="btn btn-danger" style="">Cancel</button></a> 
                                    </div>
                                </c:if>
                            </div>
                            ...
                            <div class="x_panel">
                                <div class="row">
                                    ...
                                    <!--                                    <div class="col-md-offset-8 form-inline " > 
                                                                            ...
                                                                            <input class="right form-control input-mini" style="font-weight: bold" readonly="" id="totalAmtBefDis" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${totalbefdisAmt}"/>">                                   
                                                                        </div> 
                                                                        &nbsp;
                                                                        <div class="col-md-offset-8 form-inline " > 
                                                                            <label class="control-label" style="font-size:  12px">Total Discount Amount:</label>
                                                                            <span class="btn btn-sm">INR</span>                                    
                                                                            <input class="right form-control input-mini" style="font-weight: bold" readonly="" id="totalDisAmt" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${totaldisAmt}"/>">                                   
                                                                        </div> 
                                                                        &nbsp;
                                                                        <div class="col-md-offset-8 form-inline " > 
                                                                            <label class="control-label" style="font-size:  12px">Total Amount:</label>
                                                                            <span class="btn btn-sm">INR</span>                                    
                                                                            <input class="right form-control input-mini" style="font-weight: bold" readonly="" id="totalAmt" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${totalAmt}"/>">                                   
                                                                        </div> 
                                                                        &nbsp;
                                    ...
                                    <input class="right form-control input-mini validate[custom[float7]]" readonly="" maxlength="5" style="width: 70px" autocomplete="off" style="font-weight: bold" onpaste="return false" onkeypress="return check_digit(event, this, 2, 2);" id="lumsumdiscount" name="lumsumdiscount" type="text" value="${lumsumDiscount}">
                                ...
                                <div class="col-md-offset-8 form-inline " > 
                                    ...
                                    <input class="right form-control input-mini" style="font-weight: bold" readonly="" id="grandTotal" name="grandTotal" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" value="${grandtotal}"/>">
        ...
        <script>
            ...
            $(window).load(function () {
                $('#example > tbody  > tr').each(function () {
                    ...
                    var unit = $itemRow.find('#unit').val();
                    var delDate = $itemRow.find('#delDate').val();
                    $.ajax
                            ({
                                type: "POST",
                                url: '../purchase/chkRecQty.htm',
                                data: {
                                    itemCode: itemCode,
                                    poNo: poNo,
                                    unit: unit,
                                ...
                                success: function (data) {
                                    $itemRow.find('#recQty').html(parseFloat(data).toFixed(3));
                                    $itemRow.find('#pendQty').html(parseFloat(parseFloat(qty).toFixed(3) - parseFloat(data).toFixed(3)).toFixed(3));
                                }
                            });
                });
            });
