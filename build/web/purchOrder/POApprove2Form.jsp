...
%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div> <c:if test="${not empty poRevNo}">
                                                        ...
                                                        <input type="hidden" name="action" value="FM Approved"/>  
                                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${poList}" var="type"> 
                                                        <tr id="quotPoForm" style="font-size:14px;" class="poadditem">
                                                            ...
                                                            <td>${type.uom}
                                                                <select style="width: 100px;text-align:center;display: none" readonly  id="requisitionUom" class="form-control input-sm validate[required]" onpaste="return false" onchange="calTotal(this, '${slNo}')"  tabindex="7">
                                                            ...
                                                            <td><input style="width: 100%;text-align:right;" class="form-control  input-mini validate[required,custom[float5]]" readonly  autocomplete="off" id="discount1" onkeypress="return check_digit(event, this, 2, 3);" maxlength="6" type="text" value="<fmt:formatNumber type="number" groupingUsed="false"  maxFractionDigits="3" pattern="0.000" value="${type.discount}"/>"> 
        ...
        <!--<a href="../purchOrder/statusUpdate.htm?action=GM Recected&poNo=${purchaseOrderNo}"></a>--> 
                                            ...
                                            <a href="../purchase/POApprove2List.htm"><button type="button" class="btn btn-danger" style="">Cancel</button></a> 
                                            <!--</div>-->
                                        </div>
                                    </div>
                                    <br/>
                         ...
                         function recheck(poNo)
                        {
                            ...
                            } else
                            {
                                if (confirm('Do you really want to recheck this record')) {
                                    formmodified = 0;
                                    window.location.href = "../purchase/statusUpdate.htm?poNo=" + poNo + "&remarks=" + remark + "&action=FM Recheck";
                    ...
                    function reject(poNo)
                    {
                        ...
                        if (remark == '' || remark == null)
                        {
                            ...
                            if (confirm('Do you really want to reject this record')) {
                                formmodified = 0;
                                window.location.href = "../purchase/statusUpdate.htm?poNo=" + poNo + "&remarks=" + remark + "&action=FM Rejected";
