                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    <c:forEach items="${suppList}" var="type">
                                        <tr onclick="test('${type.supplierCode}', '${type.supplierName}', '${type.supplierAddress}', '${type.supplierContNum}', '${type.mailId}');">
                                            <td class="center" style="text-align: left;width: 250px;">${type.supplierCode}</td>
                                            <td class="center" style="text-align: left;width: 250px;">${type.supplierName}</td>
                                            <td class="center" style="text-align: left;width: 250px;">${type.supplierAddress}</td>
                                            <td class="center" style="text-align: left;width: 250px;">${type.supplierContNum}</td>
                                            <td class="center" style="text-align: left;width: 250px;">${type.mailId}</td>
                                        </tr>
                                    </c:forEach>
