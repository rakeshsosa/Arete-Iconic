    ...
    <body class="nav-md">
                   ...
                   <jsp:include page="../login/menu.htm" />
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include page="../login/headerlink.htm?submodule=Service Request&tab=Rejected Service&pagetype=form"/>
                            </div>
                            <div class="pagetitle">
                                                                            ...
                                                                            <c:if test="${list.itemCode eq mass.itemCode}">
                                                                                <c:if test="${list.itemCode eq type.itemCode}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="center"><input  style="width: 100px;text-align:right;" class=" form-control" readonly name="totalPrice" id="totalPrice${list.sno}" type="text" value="${list.totalPrice}"></td>
                                                                                    </tr>
                                                                                    <c:set var="i" value="${i+1}"/>
                                                                                </c:if>
                                                                            </c:if>
