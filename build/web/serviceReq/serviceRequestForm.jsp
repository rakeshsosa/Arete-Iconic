                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="ServiceRequest" class="form-inline row" action="../serviceReq/serviceRequestFormSubmit.htm" method="post" onsubmit="return checkGrid();">
