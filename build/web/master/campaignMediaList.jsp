                            ...
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <jsp:include page="../login/headerlink.htm?submodule=Campaign Media&tab=Campaign Media&pagetype=list"/>
                                        <div class="row">
                                                        ...
                                                        <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <c:forEach items="${campaignMediaList}" var="type">
                                                                    <tr>
                                                                        <td class="center">${type.mediaCode}</td>
                                                                        <td class="center">${type.mediaName}</td>
                                                                        <td class="center">${type.mediaDesc}</td>


                                                                        <td class="center" style="text-align: left;">
                                                                            <a href="../Master/campaignMediaForm.htm?sno=${type.sno}&action=view" class="fa fa-eye fa-lg"title="View" >
                                                                                                                       
                                                                            </a>

                                                                            <a class="fa fa-pencil fa-lg" href="../Master/campaignMediaForm.htm?sno=${type.sno}&action=edit">
