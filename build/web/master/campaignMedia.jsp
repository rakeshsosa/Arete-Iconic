    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function CSTNO()
            {
                ...
                var cstNo = document.getElementById('cstNo').value;


                $.ajax({
                    type: "POST",
                    url: "../hrMasters/CSTNOFetch.htm",
                    data: {cstNo: cstNo},
                    dataType: "text",
                    success: function (data)
                    {
                        ...
                        {
                            alert("This CST NO is already Exist..");
                                    ...
                                    <form class="row" id="complaintForm" accept-charset="UTF-8" method="post" action="../Master/campaignMediaSubmit.htm" enctype="multipart/form-data" >
                                        ...
                                        <div class="col-md-4 form-floating">
                                            ...
                                            <c:choose>
                                                    ...
                                                    <c:forEach items="${leadmanagmentList}" var="type">
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="campaignMediaName" name="campaignMediaName"  maxlength="30" class="form-control" value="${type.lastName}" autocomplete="off" onkeyup="uniqueMediaCompany();">
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <c:otherwise>
                                                    <input type="text" id="campaignMediaName" placeholder="Fill" name="campaignMediaName" maxlength="30" value="" class="form-control validate[contactPerson]" autocomplete="off"  onchange="uniqueMediaCompany();">
                                                </c:otherwise>        
                                            </c:choose>
                                            <label class="control-label">Campaign Media Name <span style="color:red">*</span></label>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-floating">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <textarea class="form-control" style="resize: none" placeholder="Fill" value="" maxlength="200" name="campaignMediaDesc" id="campaignMediaDesc" type="text"></textarea>
