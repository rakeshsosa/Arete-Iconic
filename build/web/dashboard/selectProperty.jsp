<%-- 
    Document   : selectProperty
    Created on : 3 Jan, 2019, 5:37:09 PM
    Author     : ebs-sdd41
--%>
    ...
    <body>
        ...
        <script>
            function test(val1,val2) {
                window.opener.document.getElementById('propName').value = val2;
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${selectProperty}" var="type">

                                        <tr onclick="test('${type.assetCode}', '${type.assetName}');">                                            
