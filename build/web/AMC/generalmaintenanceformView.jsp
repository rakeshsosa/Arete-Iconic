            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                    ...
                    <c:forEach items="${gmmlist}" var="indvList">
                            ...
                            <div class="col-md-4 form-floating mb-3 pick1">
                                <input type="text" placeholder="Fill" class="form-control" id="serviceDate" name="serviceReqDate" maxlength="40" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.serviceReqDate}"/>" required readonly/>
                                <label class="control-label">Service Request Date<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text"  class="form-control" id="serviceNo" name="serviceNo" maxlength="40" value="${list.serviceReqNo}" required readonly  name="serviceReqNo" />
                                <label class="control-label">Service Request No<a style="color: red;">*</a> </label>
                                <input type="hidden" placeholder="Fill" class="form-control" id="SNo" name="SNo" maxlength="40" value="${list.SNo}" required readonly/>
                            </div>
                            <div class="col-md-4 form-floating mb-3 pick1">
                                <input type="text" placeholder="Fill" class="form-control" readonly="" id="serviceDate" name="serviceReqDate" maxlength="40" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.serviceReqDate}"/>" required/>
                                <label class="control-label">Service Request Date<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                            ...
                            <div class="col-md-4 form-floating mb-3 pick2">
                                <input type="text" placeholder="Fill" class="form-control datepicker" readonly="" id="deadline" required name="deadLine" maxlength="20" value="<fmt:formatDate pattern="dd-MM-yyyy" value="${list.deadLine}"/>" required readonly/>
                                <label class="control-label">Deadline <a style="color: red;">*</a></label>
                            </div>
