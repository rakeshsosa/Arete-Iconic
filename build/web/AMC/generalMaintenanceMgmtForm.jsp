                ...
                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                    ...
                    <body class="nav-md">
                        ...
                        <main id="main" class="main">
                            <div class="mt-3">
                                <jsp:include page="../login/headerlink.htm?submodule=General Maintenance Management&tab=General Maintenance Management&pagetype=form" />
                            </div>
                            <div class="pagetitle">
                            ...
                            <div class="col-md-4 form-floating mb-3 pick1">
                                <input type="text" placeholder="Fill" class="form-control" id="serviceDate" name="serviceReqDate" maxlength="40"  required/>
                                ...
                                <select id="serviceArea" name="serviceArea" required="" class="form-select">
                                    <option value="" disabled="" selected="">Select your option</option>
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" id="assetName" name="serviceName" maxlength="40" value="" required/>
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" id="approvedBudget" name="approvedBudget" maxlength="40" value="" required/>
                                <label class="control-label">Approved Budget <a style="color: red;">*</a> </label>
                            </div>
                            
                            
                            <div class="col-md-4 form-floating mb-3 pick2">
                                <input type="text" placeholder="Fill" class="form-control datepicker" id="deadline" required name="deadLine" maxlength="20" value=""/>
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" readonly placeholder="Fill" class="form-control" name="serviceReqDate" maxlength="40" value="${list.serviceReqDate}" required/>
                                <label class="control-label">Service Request Date<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <select readonly id="serviceArea" name="serviceArea" required="" class="form-control">
                            ...
                            <div class="col-md-4 form-floating mb-3" id="unitNoDiv">
                                <input readonly type="text" placeholder="Select No" class="form-control" id="unitNo" maxlength="40" value="${list.unitNo}" name="unitNo" required readonly/>
                                <label class="control-label">Unit No. <a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input readonly type="text" placeholder="Fill" class="form-control" id="assetName" name="serviceName" maxlength="40" value="${list.serviceName}" required/>
                                <label class="control-label">Asset / Service Name<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input readonly type="text" placeholder="Fill" class="form-control" id="serviceDesc" name="serviceDesc" maxlength="40" value="${list.serviceDesc}" required/>
                                <label class="control-label">Service Description<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input readonly type="text" placeholder="Fill" class="form-control" id="approvedBudget" name="approvedBudget" maxlength="40" value="${list.approvedBudget}" required/>
                                <label class="control-label">Approved Budget <a style="color: red;">*</a> </label>
                            </div>
                            
                            
                            <div class="col-md-4 form-floating mb-3">
                                <input readonly type="text" placeholder="Fill" class="form-control" id="deadline" required name="deadLine" maxlength="20" value="${list.deadLine}"/>
                                <label class="control-label">Deadline <a style="color: red;">*</a></label>
                            </div>
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" readonly="" id="assetName" name="serviceName" maxlength="40" value="${list.serviceName}" required/>
                                <label class="control-label">Asset / Service Name<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" readonly="" id="serviceDesc" name="serviceDesc" maxlength="40" value="${list.serviceDesc}" required/>
                                <label class="control-label">Service Description<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" readonly="" id="approvedBudget" name="approvedBudget" maxlength="40" value="${list.approvedBudget}" required/>
                                <label class="control-label">Approved Budget <a style="color: red;">*</a> </label>
                            </div>
                            
                            
                            <div class="col-md-4 form-floating mb-3 pick2">
                                <input type="text" placeholder="Fill" class="form-control datepicker" readonly="" id="deadline" required name="deadLine" maxlength="20" value="${list.deadLine}"/>
                                <label class="control-label">Deadline <a style="color: red;">*</a></label>
                            </div>
