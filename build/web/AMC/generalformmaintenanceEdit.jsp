                ...
                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                    ...
                    <c:forEach items="${gmmlist}" var="indvList">
                            ...
                            <div class="col-md-4 form-floating mb-3 pick1">
                                <input type="text" placeholder="Fill" class="form-control" id="serviceDate" name="serviceReqDate" maxlength="40" value="<fmt:formatDate pattern="dd-mm-yyyy" value="${list.serviceReqDate}"/>"/>
                            ...
                            <div class="col-md-4 form-floating mb-3 pick1">
                                <input type="text" placeholder="Fill" class="form-control" id="serviceDate" name="serviceReqDate" maxlength="40" value="<fmt:formatDate pattern="dd-mm-yyyy" value="${list.serviceReqDate}"/>" required/>
                                <label class="control-label">Service Request Date<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" id="assetName" name="serviceName" maxlength="40" value="${list.serviceName}" required/>
                                <label class="control-label">Asset / Service Name<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" id="serviceDesc" name="serviceDesc" maxlength="40" value="${list.serviceDesc}" required/>
                                <label class="control-label">Service Description<a style="color: red;">*</a> </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="Fill" class="form-control" id="approvedBudget" name="approvedBudget" maxlength="40" value="${list.approvedBudget}" required/>
                                <label class="control-label">Approved Budget <a style="color: red;">*</a> </label>
                            </div>
                            
                            
                            <div class="col-md-4 form-floating mb-3 pick2">
                                <input type="text" placeholder="Fill" class="form-control datepicker" id="deadline" required name="deadLine" maxlength="20" value="<fmt:formatDate pattern="dd-mm-yyyy" value="${list.deadLine}"/>"/>
                                <label class="control-label">Deadline <a style="color: red;">*</a></label>
                            </div>
