<%-- 
    ...
    Created on : 20 Feb, 2018, 11:36:40 AM
    Author     : ebs05
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            function Project(val1, val2, val3, val4) {
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Please select Supplier<small></small></h2>
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                            ...
                            <tbody>
                                <c:forEach items="${supplier}" var="type">
                                    ...
                                    <tr onclick="Project('${type[0]}', '${type[1]}', '${type[2]}', '${type[3]}')"> 
