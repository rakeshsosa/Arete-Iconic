...
var rowTemp = [
    '<tr class="item-row">',
    '<td align="center" onclick=""><i class="fa fa-trash-o" id="deleteRow" style="font-size: 17px;"></i></td>' +
...
var rowTemp1 = ['<tr class="item-rowcharge">' +
            '<td align="center" onclick=""><i class="fa fa-trash-o" id="deleteRowcharge" style="font-size: 17px;"></i></td>' +
...
var rowTemp2 = ['<tr class="item-rowdiscount">' +
            '<td align="center" onclick=""><i class="fa fa-trash-o" id="deleteRowdiscount" style="font-size: 17px;"></i></td>' +
...
var rowTemp3 = ['<tr class="item-rowdocuments">' +
            '<td align="center" onclick=""><button type="button" id="deleteRowdocument"><i class="fa fa-trash-o"></i></button></td> ' +
            '<td><input class="input-file uniform_on"  id="attachmentReference" type="file" value="" name="attachmentReference"></td>' +
            '</tr>'
...
var rowTemp4 = [
    '<tr class="item-enquiry">' +
            '<td align="center" onclick=""><button type="button" id="deleteEnquiry"><i class="fa fa-trash-o"></i></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" name="product" id="product" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" name="specification" id="specification" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" name="unit" id="unit" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" name="remark" id="remark" type="text" value=""></td>' +
            '</tr>'
...
var rowTempX = [
    '<tr class="item-enquiry">' +
            ...
            '<td>'+addup+'</td>' +
            '<td><input style="" class="form-control validate[required]" maxlength="100" required autocomplete="off" name="utilityBill" id="utilityBill"  onkeypress="" type="text" value=""></td>' +            
            '</tr>'
...
var rowTemp5 = ['<tr class="item-complement">' +
            '<td align="center" onclick=""><i class="fa fa-trash-o" id="deleteComplement" style="font-size: 17px;"></i></td>' +
            '<td><input style="text-align:left;"type="text"  class="form-control" autocomplete="off" name="compCode" id="compCode" value=""/>' +
            '<td><input  style="text-align:left;"class="form-control" autocomplete="off"  onkeypress="return check_digit(event, this, 10, 3);" name="compRate" id="compRate" type="text" value="" ></td>' +
            '</tr>'
...
var rowTemp6 = [
    '<tr class="service-enquiry">' +
            '<td align="center" onclick=""><button type="button" id="deleteService"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addservice + '</td>' +
            ...
            '<td><input style="text-align:right;"class="form-control validate[required,custom[notzero]] req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value=""></td>' +
            ...
            '<td><input style="text-align:left;" class="form-control req"  autocomplete="off"  name="" id="Service" type="checkbox" ><input class="form-control req"  autocomplete="off"  name="complementaryService" id="complementaryService" type="hidden" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" name="serviceunitPrice" readonly  id="serviceunitPrice" type="hidden" ><input style="" class="form-control req" autocomplete="off" name="remarksenqService" id="remarksenqService" type="text" value=""></td>' +
            '</tr>'
...
var rowTemp7 = [
    '<tr class="item-quote">' +
            '<td align="center" onclick=""><button type="button" id="deleteQuote"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addup + '</td>' +
            '<td><input style="text-align:left;" name="pkquoteItem" type="hidden" value="-1" ><input style="text-align:left;" name="status" type="hidden" readonly value="" ><input class="form-control validate[required]" style="width:210px;" readonly placeholder="Select Menu" maxlength="100" required autocomplete="off" name="codeEnquiry" id="codeEnquiry" onclick="selectItem(this);" type="text" value="" ></td>' +
            ...
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text"></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox" value="Yes"><input class="form-control" autocomplete="off"  name="complementaryCode" id="complementaryCode" type="hidden" value="Yes"></td>' +
...
var rowTempDi = [
    '<tr class="item-quote">' +
            '<td align="center" onclick=""><button type="button" id="deleteQuote"><i class="fa fa-trash-o"></i></td>' +
            '<td>' + addup + '</td>' +
            '<td><input style="text-align:left;" name="pkquoteItem" type="hidden" value="-1" ><input style="width:210px;" class="form-control validate[required]" maxlength="100" placeholder="Select Menu" required readonly autocomplete="off" name="codeEnquiry" id="codeEnquiry" onclick="selectItem(this);" type="text" value="" ></td>' +
            ...
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text"></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox" value="="><input class="form-control" autocomplete="off"  name="complementaryCode" id="complementaryCode" type="hidden" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control" autocomplete="off" name="itemquotRemarks" id="itemquotRemarks" type="text" value=""></td>' +
            '<td><input style="text-align:left;" id="menuReference" name="menuReference" type="hidden" value=""/><input class="form-control" autocomplete="off" name="remarksenqItem" id="remarksenqItem" type="hidden" value="">' +
            '<input style="text-align:left;"class="form-control" readonly autocomplete="off" name="menueditStatus" id="menueditStatus" type="text" value="Default"></td>' +
            '</tr>'
...
var rowTempY = [
    '<tr class="item-quote">' +
            '<td align="center" onclick=""><button type="button" id="deleteQuote"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addup + '</td>' +
            '<td><input style="text-align:left;"  name="status" type="hidden" value="" ><input style="" class="form-control validate[required]" maxlength="100" placeholder="Select Menu" readonly required autocomplete="off" name="codeEnquiry" id="codeEnquiry" onclick="selectItem(this);" type="text" value="" ></td>' +
            '<td><input style="" class="form-control validate[required]" maxlength="100" required autocomplete="off" name="nameEnquiry" readonly id="nameEnquiry"  onkeypress="" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text"></td>' +
            '<td><input style="text-align:right;" class="form-control validate[required]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox" value="Yes"><input class="form-control" autocomplete="off"  name="complementaryCode" id="complementaryCode" type="hidden" value="Yes"></td>' +
            '<td><input style="text-align:left;" id="menuReference" name="menuReference" type="hidden" value=""/><input class="form-control" autocomplete="off" name="itemquotRemarks" id="itemquotRemarks" type="text" value=""></td>' +
            '<input style="text-align:left;" class="form-control" autocomplete="off" name="remarksenqItem" id="remarksenqItem" type="hidden" value=""></td>' +
            '</tr>'
...
var rowTemp8 = [
    '<tr class="service-quote">' +
            '<td align="center" onclick=""><button type="button" id="deletequoteService"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addservice + '</td>' +
            '<td><input style="text-align:left;" name="pkquoteService" type="hidden" value="-1"><input name="statusService" type="hidden" value="" ><input class="form-control" maxlength="100" readonly placeholder="Select Service" required autocomplete="off" name="codeService" id="codeService" onclick="selectService(this);" type="text" value="" ></td>' +
            ...
            '<td><input style="" class="form-control validate[required] req" readonly autocomplete="off"  name="uomService" id="uomService" type="text" ></td>' +
            '<td><input style="text-align:right;" class="form-control validate[required] req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="serviceunitPrice"   id="serviceunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="servicetotalPrice" readonly  id="servicetotalPrice" type="text" value=""></td>' +
...
var rowTempSdi = [
    '<tr class="service-quote">' +
            '<td align="center" onclick=""><button type="button" id="deletequoteService"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addservice + '</td>' +
            '<td><input style="text-align:left;" name="pkquoteService" type="hidden" value="-1"><input name="statusService" type="hidden" value="" ><input class="form-control validate[required] req" maxlength="100" readonly placeholder="Select Service" required autocomplete="off" name="codeService" id="codeService" onclick="selectService(this);" type="text" value="" ></td>' +
            '<td><input style="" class="form-control validate[required] req" maxlength="100" required autocomplete="off" name="nameService" readonly id="nameService"  onkeypress="" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required] req"  readonly autocomplete="off"  name="uomService" id="uomService" type="text" ></td>' +
            '<td><input style="text-align:right;"class="form-control validate[required,custom[notzero]] req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value=""></td>' +
            '<td><input  style="text-align:right;"class="form-control validate[required] req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="serviceunitPrice"  id="serviceunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" readonly  autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="servicetotalPrice" readonly  id="servicetotalPrice" type="text" value=""></td>' +
            '<td><input style="" class="form-control req" autocomplete="off" name="servicequotRemarks" id="servicequotRemarks" type="text" value=""></td>' +
            '<td><input style="text-align:left;" name="remarksenqService" id="remarksenqService" class="req" type="hidden"><input class="form-control req"  autocomplete="off"  name="" id="Service" type="checkbox" ><input class="form-control"  autocomplete="off"  name="complementaryService" id="complementaryService" type="hidden" value="Yes"></td>' +
            '</tr>'
...
var rowTempSY = [
    '<tr class="service-quote">' +
            ...
            '<td><input style="text-align:right;" class="form-control req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="serviceunitPrice"  id="serviceunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="servicetotalPrice" readonly  id="servicetotalPrice" type="text" value=""></td>' +
            '<td><input style="" class="form-control" autocomplete="off" name="servicequotRemarks" id="servicequotRemarks" type="text" value="">' +
            '<input style="text-align:left;" class="form-control" autocomplete="off" name="remarksenqService" id="remarksenqService" type="hidden" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="Service" type="checkbox" ><input class="form-control"  autocomplete="off"  name="complementaryService" id="complementaryService" type="hidden" value="Yes"></td>' +
            '</tr>'
...
var rowTemp10 = [
    '<tr class="item-order">' +
            '<td align="center" onclick=""><button type="button" id="deleteOrder"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addup + '</td>' +
            ...
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control validate[required]" readonly required autocomplete="off" onclick="selectdates1(this);" name="requiredenquiryDate" id="requiredenquiryDate" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text"></td>' +
            '<td><input style="text-align:left;" class="form-control validate[required]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemorderfreeQty" id="itemorderfreeQty" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="complementaryCode" id="comp" type="checkbox">' +
            '<input style="text-align:left;" class="form-control"  autocomplete="off"  name="complementaryCode" id="complementaryCode"  type="hidden" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemordertotalWeight" id="itemordertotalWeight" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemorderRate" id="itemorderRate" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;"class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 2, 2);" name="itemorderDiscount" id="itemorderDiscount" type="text" value=""></td>' +
            '<td><input style="text-align:right;"class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemordertotAmt" id="itemordertotAmt" type="text" value=""></td>' +
            '<td><input style="text-align:left;"class="form-control" autocomplete="off" name="itemorderRemarks" id="itemorderRemarks" type="text" value=""></td>' +
            '</tr>'
...
var rowTemp10Y = [
    '<tr class="item-order">' +
            ...
            '<td><input style="text-align:left;" class="form-control validate[required]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            ...
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input class="form-control right" required autocomplete="off" onkeypress="return check_digit(event, this, 2, 2);" name="itemorderDiscount" id="itemorderDiscount" type="text" value=""></td>' +
            '<td><input class="form-control right" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemordertotAmt" id="itemordertotAmt" type="text" value=""></td>' +
...
var rowTempOdi = [
    '<tr class="item-order">' +
            ...
            '<td><input style="text-align:right;" class="form-control validate[required]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice"  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" id="menuReference" name="menuReference" type="hidden" value=""/><input style="text-align:right;" class="form-control validate[required]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox">' +
            '<input class="form-control"  autocomplete="off"  name="complementaryCode" id="complementaryCode"  type="hidden" value=""></td>' +
...
var rowTempOedi = [
    '<tr class="item-order">' +
            ...
            '<td><input style="text-align:right;"class="form-control right validate[required,custom[notzero]]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text"></td>' +
            '<td><input style="text-align:right;" class="form-control" readonly autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice"  id="itemunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;"id="menuReference" name="menuReference" type="hidden" value=""/><input style="text-align:right;" class="form-control" readonly autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="text" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox">' +
            '<input class="form-control"  autocomplete="off"  name="complementaryCode" id="complementaryCode"  type="hidden" value=""></td>' +
            '<td><input class="form-control" autocomplete="off" name="itemorderRemarks" id="itemorderRemarks" type="text" value=""></td>' +
...
var rowTempShipDi = [
    '<tr class="item-ship">' +
            '<td align="center" onclick=""><button type="button" id="deleteShip"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addup + '</td>' +
            '<td><input style="" class="form-control validate[required]" maxlength="100" required placeholder="Select Menu" autocomplete="off" readonly name="codeEnquiry" id="codeEnquiry" onclick="selectItem(this);" type="text" value="" ></td>' +
            '<td><input style=""  class="form-control validate[required]" maxlength="100" required autocomplete="off" readonly name="nameEnquiry" id="nameEnquiry"  onkeypress="" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="text-align:left;" id="menuReference" name="menuReference" type="hidden" value=""/><input style="" class="form-control" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text">' +
            '<input style="text-align:right;" class="form-control" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="hidden" value="">' +
            '<input style="text-align:right;" class="form-control" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="hidden" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox">' +
            '<input class="form-control"  autocomplete="off"  name="complementaryCode" id="complementaryCode"  type="hidden" value=""></td>' +
...
var rowTempShip = [
    '<tr class="item-ship">' +
            ...
            '<td><input style="" class="form-control validate[required]" maxlength="100" required autocomplete="off" readonly name="nameEnquiry" id="nameEnquiry"  onkeypress="" type="text" value=""></td>' +
            '<td><div><span id="addEnquiryGetBtn" class="myButton17" tabindex="" onclick="selectorderdiMenu(this);"><i class="glyphicon glyphicon-copy"></i> Get Recipe</span></div></td>' +
            '<td><input style="text-align:left;" id="menuReference" name="menuReference" type="hidden" value=""/><input style="text-align:right;" class="form-control right validate[required,custom[notzero]]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="portionQty" id="portionQty" type="text" value=""></td>' +
            '<td><input style="" class="form-control validate[required]" readonly autocomplete="off"  name="uomEnquiry" id="uomEnquiry" type="text">' +
            '<input style="text-align:right;" class="form-control validate[required]" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemunitPrice" readonly  id="itemunitPrice" type="hidden" value="">' +
            '<input style="text-align:right;" class="form-control" required autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="itemtotalPrice" readonly  id="itemtotalPrice" type="hidden" value=""></td>' +
            '<td><input style="text-align:left;" class="form-control"  autocomplete="off"  name="" id="comp" type="checkbox">' +
            '<input class="form-control"  autocomplete="off"  name="complementaryCode" id="complementaryCode"  type="hidden" value=""></td>' +
...
var rowTempSodi = [
    '<tr class="service-order">' +
            '<td align="center" onclick=""><button type="button" id="deleteOrderService"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addservice + '</td>' +
            ...
            '<td><input style="text-align:right;" class="form-control validate[required,custom[notzero]] req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="serviceunitPrice"  id="serviceunitPrice" type="text" value=""></td>' +
            '<td><input style="text-align:right;" class="form-control req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="servicetotalPrice" readonly  id="servicetotalPrice" type="text" value=""></td>' +
...
var rowTempShipServiceDi = [
    '<tr class="service-ship">' +
            '<td align="center" onclick=""><button type="button" id="deleteShipService"><i class="fa fa-trash-o"></i></button></td>' +
            '<td>' + addservice + '</td>' +
            '<td><input class="form-control validate[required] req" maxlength="100" required placeholder="Select Service" autocomplete="off" readonly palceholder="Select Service" name="codeService" id="codeService" onclick="selectService(this);" type="text" value="" ></td>' +
            '<td><input class="form-control validate[required] req" maxlength="100" required autocomplete="off" readonly name="nameService" id="nameService"  onkeypress="" type="text" value=""></td>' +
            '<td><input class="form-control validate[required] req" readonly autocomplete="off"  name="uomService" id="uomService" type="text" ></td>' +
            '<td><input style="text-align:right;" class="form-control validate[required,custom[notzero]] req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 1);" name="serviceQty" id="serviceQty" type="text" value="">' +
            '<input style="text-align:right;" class="form-control req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="serviceunitPrice"  id="serviceunitPrice" type="hidden" value="">' +
            '<input style="text-align:right;" class="form-control req" autocomplete="off" onkeypress="return check_digit(event, this, 10, 3);" name="servicetotalPrice" readonly  id="servicetotalPrice" type="hidden" value=""></td>' +
            '<td><input class="form-control req"  autocomplete="off"  name="" id="Service" type="checkbox" >' +
            '<input class="form-control req"  autocomplete="off"  name="complementaryService" id="complementaryService" type="hidden" ></td>' +
