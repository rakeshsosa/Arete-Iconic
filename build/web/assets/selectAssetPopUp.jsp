<%-- 
    Document   : selectAssetPopUp
    Created on : 11 Nov, 2016, 10:47:39 AM
    Author     : Garun Mishra
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3) {
                ...
                window.opener.document.getElementById('assetValue').value = val3;
                window.close();
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <c:forEach items="${selectAssetPopUp}" var="type">

                                    <tr onclick="test('${type.assetCode}', '${type.assetName}', '${type.totalAssetValue}');">
