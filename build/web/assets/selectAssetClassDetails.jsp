    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4) {
                window.opener.document.getElementById('assetClassId').value = val1;
                window.opener.document.getElementById('assetClass').value = val2;
                window.close();
            }
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Asset Class Details List</h2>
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                <thead>
                                    <tr class="headings">                                                   
                                        ...
                                        <th>Asset Class Desc</th>
                                    </tr>
                                </thead>

                                <tbody>                                   

                                    <c:forEach items="${assetClassDetails}" var="type">

                                        <tr onclick="test('${type.assetClassId}', '${type.assetClassName}', '${type.assetClassDescription}');">                                            
                                            <td class="center" style="text-align: left;">${type.assetClassId}</td>
                                            <td class="center" style="text-align: left;">${type.assetClassName}</td>
                                            <td class="center" style="text-align: left;">${type.assetClassDescription}</td>
                                        </tr>
                                    </c:forEach>
