                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${assetDetails}" var="type">
                                        ...
                                        <tr onclick="test('${type.assetCode}', '${type.assetName}', '${type.noOfFloors}', '${type.mezzanineFloor}', '${type.assetType}');">                                            
                                            ...
                                            <td class="center" style="text-align: left;">${type.noOfFloors}</td>
                                            <td class="center" style="text-align: left;">${type.areaCode}</td>
                                        </tr>
                                    </c:forEach>
