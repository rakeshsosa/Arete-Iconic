        ...
        <script>
            function test() {
              ...
              $("table tbody tr input:checkbox:checked").each(function(){
                var tmpVal = $(this).val()
                unitNumbers.push(tmpVal)
                });
                   
            
              opener.addUnitNumbers(unitNumbers,window.currIndexFromOpener);
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${subAssetDetails}" var="type">
                                        ...
                                        <tr>  
                                            <td><input type="checkbox" name="selectUnitNumbers" id="selected+employee" value="${type[0]}"/>
                                        </td>
                            ...
                            <button class="btn btn-primary" onclick="test()">Add to grid</button>
                        </div>
                        </form>
                    </div>
                </div>
