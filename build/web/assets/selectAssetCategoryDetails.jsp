    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4) {
                window.opener.document.getElementById('assetCategoryId').value = val1;
                window.opener.document.getElementById('assetCategory').value = val2;
                window.close();
            }
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Asset Category Details List</h2>
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${assetCatDetails}" var="type">

                                        <tr onclick="test('${type.assetCategoryId}', '${type.assetCategoryName}', '${type.assetCategoryDescription}');">                                            
                                            <td class="center" style="text-align: left;">${type.assetCategoryId}</td>
                                            <td class="center" style="text-align: left;">${type.assetCategoryName}</td>
                                            <td class="center" style="text-align: left;">${type.assetCategoryDescription}</td>
                                        </tr>
                                    </c:forEach>
