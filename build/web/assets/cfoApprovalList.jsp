    ...
    <body class="nav-md">
          ...
          <jsp:include page="../login/menu.htm" />
                    ...
                    <main id="main" class="main">
                        <div>
                            <jsp:include page="../login/headerlink.htm?submodule=Material Return&tab=Approval 2&pagetype=list"/>
                        </div>
                        <div class="pagetitle">
                                                                ...
                                                                <c:forEach items="${cfoApprovalList}" var="list">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="center" style="width:13%;text-align: left;">
                                                                            <c:if test="${list.returnStatus ne 'CFO Approved' }">
                                                                                <a class="fa fa-check-circle-o fa-lg" title="Approval 2" style="color: green;" href="../quality/cfoApprovalForm.htm?pk=${list.sno}&poNo=${list.poNo}&mrNo=${list.mrNo}&action=form">
                                                                                    </a> 
                                                                                </c:if>
                                                                                <c:if test="${list.returnStatus eq 'CFO Approved' }">
