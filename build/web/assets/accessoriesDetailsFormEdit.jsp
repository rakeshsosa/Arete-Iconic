...
//                    alert("Please Enter Only Alphabets");
            ...
            function test()
            {
                var comp = document.getElementById("quantity").value;
                var comp1 = document.getElementById("quantity1").value;
                var desc = document.getElementById("remarks").value;
                var desc1 = document.getElementById("remarks1").value;

//                if (document.getElementById("accessoryCode").value == "")
//                {
//                    alert("Enter Accessory Code");
//                    return false;
//                }
                if (document.getElementById("quantity").value == "")
                {
                    ...
                    if (comp !== comp1 || desc !== desc1) {
                        if (confirm('Do you really want to Save this updated record')) {
                            document.forms["accessory"].submit();
                            return true;
                        } else {
                            return true;
                        }
                                    ...
                                    <form class="form-inline row" id="accessory" action="../assets/accessoriesDetailsFormSubmit.htm"  method="post" onsubmit="return checkGrid();" enctype="multipart/form-data">
                                        ...
                                        <c:if test="${fieldStatus_1 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Select Asset Code" class="form-control" ${mand_status_1} id="assetCode" readonly="" name="assetCode" maxlength="40" value="" onclick="return selectAccAssetDetails();">
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                        ...
                                        <c:if test="${fieldStatus_3 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(accessoryDetails) > 0}">
                                                        <input type="text" class="form-control" readonly="" id="subAssetCode" name="subAssetCode1" value="${subAssetCode}">
                                                    </c:when>
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="Select Sub Asset Code" class="form-control" ${mand_status_3} id="subAssetCode" readonly="" name="subAssetCode"  maxlength="40" value="" onclick="return selectSubAssetDetails();">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_4 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>                                                    
                                                        <input type="text" placeholder="" class="form-control" ${mand_status_4} id="subAssetName" name="subAssetName" readonly="" maxlength="40" value="">
                                                    </c:otherwise>        
                                                </c:choose>
                                        ...
                                        <c:if test="${fieldStatus_5 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <input type="text" placeholder="" readonly="" class="form-control" ${mand_status_5} id="accessoryCategory" maxlength="40" value="">
                                            </div>
                                        </c:if><p>&nbsp;</p>
                                        ...
                                        <c:if test="${fieldStatus_6 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <input type="text" placeholder="" readonly="" class="form-control" ${mand_status_6} id="accessoryName" maxlength="40" value="">
                                        ...
                                        <c:if test="${fieldStatus_10 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <input type="text" placeholder="" class="form-control" id="quantity" maxlength="40" value="" onkeypress="return checkdigit(event, this, 10, 0);">
                                                <input type="hidden" placeholder="" class="form-control" id="quantity1"  maxlength="40" value="" >
                                            </div></c:if>
                                        <c:if test="${fieldStatus_7 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <label style="margin-top:-21px;" class="control-label">${field_7}</label>
                                                <textarea  class="form-control" ${mand_status_7} id="remarks" rows="1" style="resize: none" value="" type="text"></textarea>
                                                <input id="remarks1" class="form-control"  rows="1" maxlength="300" style="resize: none" type="hidden">
                                        ...
                                        <c:if test="${action eq 'edit'}" >
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <button type="button" class="btn btn-secondary" style="" onclick="addOrderRow_test();"><i class="fa fa-plus-circle" style="font-size: 15px"></i> ADD</button>
                                            ...
                                            <script>
                                                ...
                                                function addOrderRow_test() {
                                                    ...
                                                    if (valid1 == true) {
                                                        ...
                                                        var table = document.getElementById("currencytablemed");

                                                        $('#currencytablemed tr').each(function () {
                                                        ...
                                                        tr.innerHTML = '<td align="center" width:190px; class="tinput"><button type="button"  class="fa fa-trash fa-lg-o" onclick="removeRow('
                                                                + slNo + ')" ></button> </td>' +
                                                                '<td ><input class="form-control " style="text-align: left; width: 264px;" type="text" readonly id="accessoryCode11" name="accessoryCode2" value="' + accessoryCode1 +
                                                                '" style="border: none"></td><td><input class="form-control " style="text-align: left; width: 264px;" type="text" readonly name="accessoryCategory2" value="' + accessoryCategory1 +
                                                                '" style="border: none"></td><td><input class="form-control " style="text-align: left; width: 264px;" type="text" readonly name="accessoryName2" value="' + accessoryName1 +
                                                                '" style="border: none"></td><td><input class="form-control " style="text-align: right; width: 264px;" type="text" readonly name="quantity2" value="' + quantity1 +
                                                                '" style="border: none"></td><td><input class="form-control " style="text-align: left; width: 264px;" type="text" readonly name="remarks2" value="' + remarks +
                                                        ...
                                                        <c:forEach items="${accessoryDetails3}" var="list">
                                                            <tr class="item-row"> 
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${action eq 'edit'}">
                                                                            <input class="form-control" style="text-align: left; width: 264px;" readonly="" name="accessoryCategory1" autocomplete="off" type="text" maxlength="30" value="${list[2]}">
                                                                        </c:when>
                                                                        <c:otherwise>
