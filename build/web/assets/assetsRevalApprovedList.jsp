<%-- 
    Document   : assetsRevalApprovedList
    Created on : 8 Feb, 2018, 5:54:23 PM
    Author     : ebs05
--%>
                        ...
                        <div class="row top_tiles">
                            <div class="">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_panel">
                                        <jsp:include page="../login/headerlink.htm?submodule=Property Revaluation&tab=Approved Property Revaluation&pagetype=list"/>
                                        <div class="row">
                                                                ...
                                                                <c:forEach items="${revaluationOfAsseList}" var="list">                                                                                                                                    
                                                                    <tr class="even pointer">
                                                                        ...
                                                                        <td class=" last " style="text-align: left;">
                                                                            <a href="../assetsm/assetsRevalApprovedForm.htm?SNo=${list.SNo}&assetCode=${list.assetCode}&revaluationNo=${list.revaluationNo}&action=view" class="fa fa-eye fa-lg"title="View"></a>&nbsp;
