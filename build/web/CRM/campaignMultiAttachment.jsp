...
<tbody id="">               
<c:choose>
    <c:when test="${fn:length(camAttachmentList) > 0}">
        <c:forEach items="${camAttachmentList}" var="attach">
            <c:choose>
                <c:when test="${action eq 'edit'}">
                    ...
                    <td><c:if test="${not empty attach.fileName}">
                        <a   href="../CRM/camAttachDownload.htm?sno=${attach.sno}" class="fa fa-file-pdf-o" style="color: #000">${attach.fileName}
