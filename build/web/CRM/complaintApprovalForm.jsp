<%-- 
    Document   : complaintApprovalForm
    Created on : 3 Oct, 2016, 2:55:30 PM
    Author     : ebs-sdd27
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function reject(complaintCode, status)
            {
                ...
                if (remarks == null || remarks == '') {
                    ...
                    window.location.href = "../CRM/rejectFormSubmit.htm?complaintCode=" + complaintCode + "&reviewerRecordStatus=" + status + "&reviewerComments2=" + remarks + "";
    ...
    <body class="nav-sm">
            ...
            <jsp:include page="../login/menu.htm" />
                        ...
                        <main id="main" class="main">
                            <div>
                                <jsp:include page="../login/headerlink.htm?submodule=Complaints&tab=Approval 1&pagetype=form"/>
                            </div>
                            <div class="pagetitle">
                            ...
                            <section class="section">
                                <div class="row">
                                    ...
                                    <c:forEach items="${complaintList}" var="type">
                                        <c:set var="complaintCode1" value="${type.complaintCode}"/>
                                    ...
                                    <form class="form-inline row" id="complaintForm" accept-charset="UTF-8" method="post" action="../CRM/approveComplaintFormSubmit.htm" enctype="multipart/form-data" >
                                        ...
                                        <c:if test="${action ne 'view'}">
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                ...
                                                <button type="button" class="btn btn-warning" style="" onclick="reject('${complaintCode1}', 'Rejected');">Reject</button>
                                                <a href="../CRM/complaintApprovalList.htm"  class="btn btn-danger"  style="">Cancel</a>
                                            </div>
                                        </c:if>
