<%-- 
    Document   : tenantDetailsForCustomerFeedback
    Created on : 28 Sep, 2016, 2:20:54 PM
    Author     : ebs-sdd27
--%>
                        ...
                        <form class="form-horizontal" id="contDetForm">
                            ...
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${tenantDetailsForCustomerFeedback}" var="type">
                                        ...
                                        <tr onclick="window.opener.document.getElementById('tenantName').value = '${type.tenantFname}';
                                                ...
                                                window.opener.document.getElementById('subAssetName').value = '${subAssetName1}';
                                                window.opener.document.getElementById('assetName').value = '${type.assetName}';
                                                window.opener.document.getElementById('assetNo').value = '${type.subclassifiedAstno}';
