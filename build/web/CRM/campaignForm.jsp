...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function ROIvalidate()
            {
                var a = document.getElementById('roi').value;

                if (a > 100)
                {
                    alert("ROI should not be more than 100%.\n\
Please Enter correct Budgeted Cost");
                    $("#roi").val("");
                    $("#budgetedCost").val("");
                }
            }
            ...
            function checkMondatory()
            {
                ...
                var m = document.getElementById('campaignName').value &&
            ...
            // Added by Garun to check wether Compaign name extst or not

            function checkCampaignName() {
                var campaignName = document.getElementById('campaignName').value;
                //Ajax calling to check wether campaign Name Name Exist or not
                $.ajax({
                    type: "POST",
                    url: '../CRM/checkCampaignName.htm',
                    data: {
                        campaignName: campaignName
                    },
                    success: function (data) {
                        if (data !== "") {
                            alert('Campaign Name is already exist');
                        ...
                        <div class="col-md-6 col-xs-12 form -inline">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-inline" id="CampaignForm" accept-charset="UTF-8" method="post" action="../CRM/CampaignFormSubmit.htm" enctype="multipart/form-data" onsubmit="return checkMondatory();">
                                        ...
                                        <c:if test="${fieldStatus_1 eq 'y'}">
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input name="campaignName" id="campaignName" readonly="" ${mand_status_1} type="text" maxlength="30" class="form-control" value="${campaignName}" onchange="return checkCampaignName();">
                                                    ...
                                                    <c:otherwise>
                                                        <input name="campaignName" id="campaignName"  maxlength="30" type="text" class="form-control" autocomplete="off" onkeyup="firstToUpperCase();" value=""  onchange="return checkCampaignName();">
                                                        <input name="campaignCode" value="${campaignCode}" type="hidden">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="campaignMedia" name="campaignMedia" ${mand_status_2} class="form-control"  readonly value="${campaignMedia}">
                                                            </c:when>
                                                            <c:otherwise>
                                                    ...
                                                    <c:otherwise>
<!--                                                        <input type="text" placeholder="Select Campaign Media Type" class="form-control" ${mand_status_2} id="campaignMedia" readonly="" name="campaignMedia" maxlength="40" value=""  onclick="return selectCampaignDetails();">
                                                        <input type="hidden" id="campaignMediaCode" name="campaignMediaCode" value="" >
                                                        -->
                                                        <select class="form-control" id="campaignMedia" name="campaignMedia" value="" onchange="checkavl(this.value);">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <!--<input type="text" id="campaignStatus" name="campaignStatus" ${mand_status_3} class="form-control"  readonly value="${campaignStatus}">-->
                                                                <select class="form-control" id="campaignStatus" ${mand_status_3} name="campaignStatus" value="">
                                                    ...
                                                    <c:otherwise>
                                                        <select class="form-control" id="campaignStatus" name="campaignStatus" value="" onchange="checkavl(this.value);">
                                                            <option value="" disabled selected>Select your option</option>
                                                            <c:forEach items="${complaintFormData_dropDown_category}" var="list">
                                                                <c:if test="${list[0] eq 'F-17'}">
                                                                    <option>${list[1]}</option>                                     
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(campaignList) > 0}">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" id="startDate" name="startDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" value="${startDate}">                               

                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" id="startDate" name="startDate" readonly placeholder="Select Date" class="form-control "  value="${startDate}">                                                                
                                                                </c:otherwise> 
                                                            </c:choose>

                                                        </c:when>
                                                        <c:otherwise>
                                                            <div id="id1" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="startDate" name="startDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('startDate', 'ddMMMyyyy', '', '', '', '', '')" onchange="calstartdt();">
                                                            </div>
                                                            <div id="id2" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="startDate1" name="startDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('startDate1', 'ddMMMyyyy', '', '', '', '', 'past')" onchange="calstartdt();">
                                                            </div>
                                                            <div id="id3" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="startDate2" name="startDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('startDate2', 'ddMMMyyyy', '', '', '', '', 'future')" onchange="calstartdt();">
                                                            </div>
                                                        </c:otherwise>        
                                                    </c:choose>
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(campaignList) > 0}">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" id="endDate" name="endDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" value="${endDate}" >

                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" id="endDate" name="endDate" readonly placeholder="Select Date" class="form-control"  value="${endDate}">                     
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:when>
                                                        <c:otherwise>
                                                            ...
                                                            <div id="id11" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="endDate" name="endDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('endDate', 'ddMMMyyyy', '', '', '', '', '')" onchange="calstartdt();">
                                                            </div>
                                                            <div id="id12" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="endDate1" name="endDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('endDate1', 'ddMMMyyyy', '', '', '', '', 'past')" onchange="calstartdt();">
                                                            </div>
                                                            <div id="id13" style="margin-left:136px; margin-top:-24px">
                                                                <input type="text" id="endDate2" name="endDate" readonly placeholder="Select Date" class="form-control"  onmouseover="" style="cursor: pointer;" onclick="javascript:NewCssCal('endDate2', 'ddMMMyyyy', '', '', '', '', 'future')" onchange="calstartdt();">
                                                            </div>
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:length(campaignList) > 0}">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" id="eventOwner" name="eventOwner" maxlength="60" autocomplete="off" class="form-control" readonly="" value="${eventOrganiser}">

                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="text" id="eventOwner" name="eventOwner" readonly class="form-control"  value="${eventOrganiser}">                     
                                                                </c:otherwise> 
                                                            </c:choose>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <input type="text" id="eventOwner" name="eventOwner" maxlength="60" autocomplete="off" class="form-control" >
                                                        </c:otherwise>        
                                                    </c:choose>
                                                </div>
                                            </c:if>
                                                            ...
                                                            <tbody >
                                                                ...
                                                                <c:if test="${action eq null}">
                                                                    <tr class="item-members">
                                                                        ...
                                                                        <td><input class="form-control" maxlength="120" autocomplete="off" name="enquirerCompany" id="enquirerCompany" type="text"  onchange="uniqueCom
                                                                                pany(this);">
                                                                            <input type="hidden" name="SNO" value="">
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control" id="enquirerIndustry" name="enquirerIndustry" value="" >
                                                                        ...
                                                                        <td><input class="form-control"  autocomplete="off"  name="companyDetails" id="companyDetails" type="text"  maxlength="200"></td>
                                                                        <td><input class="form-control"  autocomplete="off"  name="email" id="email" type="email"  maxlength="100" onchange="emailValidate(this);" ></td>
                                                                        <td><input class="form-control" style="text-align: right;"  autocomplete="off" maxlength="12" min="8"  name="phone" id="phone" onkeypress="return check_digit(event, this, 11, 3);" onchange="mobileNoValidation(this);" type="text" ></td> 
                                                                        <td><input class="form-control" autocomplete="off"  name="comremarks" id="comremarks" type="test" maxlength="50"></td>
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="expectedRevenue" name="expectedRevenue" readonly="" autocomplete="off" class="form-control" maxlength="10" value="${expectedRevenue}" >
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" style="text-align: right" id="expectedRevenue" name="expectedRevenue" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="0" onkeyup="calculation();" onchange="ROIvalidate();">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="actualRevenue" name="actualRevenue" autocomplete="off" class="form-control" maxlength="10" readonly="" value="${actualRevenue}" >
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" style="text-align: right" id="actualRevenue" name="actualRevenue" autocomplete="off" class="form-control" maxlength="10"  onkeypress="return isNumberKey(event)" value="0" >
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="budgetedCost" name="budgetedCost" readonly="" autocomplete="off" class="form-control" maxlength="10" value="${budgetedCost}">
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" style="text-align: right" id="budgetedCost" name="budgetedCost" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="0" onkeyup="calculation();" onchange="ROIvalidate();">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="actualCost" name="actualCost" autocomplete="off" class="form-control" maxlength="10" readonly="" onkeypress="return isNumberKey(event)" value="${actualCost}" >
                                                            </c:when>
                                                            <c:otherwise>
                                                                <input type="text" id="actualCost" name="actualCost" autocomplete="off" class="form-control" maxlength="10" readonly="" onkeypress="return isNumberKey(event)" value="${actualCost}" >
                                                            </c:otherwise> 
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" style="text-align: right" id="actualCost" name="actualCost" autocomplete="off" class="form-control" maxlength="10"  onkeypress="return isNumberKey(event)" value="0" >
                                                    </c:otherwise>        
                                                </c:choose>
                                            </div>
                                        </c:if>
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        <c:choose>
                                                            <c:when test="${action eq 'edit'}">
                                                                <input type="text" id="roi" readonly="" name="roi" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="${roi}">%
                                                            </c:when>
                                                            <c:otherwise>
                                                                <input type="text" id="roi" readonly="" name="roi" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="${roi}">%
                                                            </c:otherwise> 
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" id="roi" style="text-align: right"  name="roi" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="0">%
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(campaignList) > 0}">
                                                        <c:forEach items="${campaignList}" var="type">
                                                            <c:choose>
                                                                <c:when test="${action eq 'edit'}">
                                                                    <input type="text" id="budgetRemain" name="budgetRemain" autocomplete="off" readonly="" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="${budgeteRemaining}">
                                                    ...
                                                    <c:otherwise>
                                                        <!--placeholder="0.00"-->
                                                        <input type="text" style="text-align: right"   id="budgetRemain" name="budgetRemain" autocomplete="off" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" value="0">
