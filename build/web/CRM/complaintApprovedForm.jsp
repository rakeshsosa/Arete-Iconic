<%-- 
    Document   : complaintApprovedForm
    Created on : 28 Mar, 2018, 11:21:41 AM
    Author     : ebs05
--%>
                        ...
                        <main id="main" class="main">
                            ...
                            <section class="section">
                                <div class="row">
                                    ...
                                    <form class="form-inline" id="complaintForm" accept-charset="UTF-8" method="post" action="../CRM/complaintFormSubmit.htm" enctype="multipart/form-data" >
