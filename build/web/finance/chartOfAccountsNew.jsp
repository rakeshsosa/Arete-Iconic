        ...
        <main id="main" class="main">
          ...
          <li class="nav-item"><a class="nav-link"  href="../finance/costCenterMasterList.jsp">Cost Center</a></li>
           <li class="nav-item"><a class="nav-link active"  href="../finance/chartOfAccountsNew.jsp">Chart Of Accounts</a></li>
            ...
            <br>
            <div class="text-end">
                   <a class="btn btn-primary btn-sm " href="../finance/chartOfAccountsNewForm.jsp"><i class="bi bi-plus"></i> Create Chart of Accounts</a>
                    </div>   </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title"><h5>Chart of Accounts List</h5></div> 
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${calendarPeriodList}" var="type">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" class="center">${type.periodType}</td>
                                                                        <td style="text-align: left" class="center">${type.calendarStatus}</td>
                                                                        ...
                                                                        <td class="center" style="text-align:left" >
                                                                            ...
                                                                            <c:if test="${type.status ne 'Inactive'}">
                                                                            <a class="myButton" href="../Transactional/calendarPeriodView.htm?sno=${type.sno}&action=view" >
                                                                                <i class="fa fa-search-plus">
                                                                                    </i>                                              
                                                                            </a>
                                                                            <a class="myButton1" href="../Transactional/calendarPeriodEdit.htm?sno=${type.sno}&action=edit" >
                                                                                <i class="fa fa-pencil-square-o">  
                                                                                    </i>                                             
                                                                            </a>
                                                                            </c:if>    
                                                                            <a class="${btncls}"  href="../Transactional/deleteDetails.htm?sno=${type.sno}&clsname=CalendarPeriod&listview=calendarPeriodList&status=${stsval}" onclick="if (confirm('Do you really want to ${lblval} this record?')) {
                                                                                        return true;
                                                                                    } else {
                                                                                        return false;
                                                                                    }">
