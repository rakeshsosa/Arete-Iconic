...
<!--           <li class="nav-item"><a class="nav-link"  href="../finance/chartOfAccountsNew.jsp">Chart Of Accounts</a></li>-->
            ...
            <br>
            <div class="text-end">
                   <a class="btn btn-primary btn-sm " href="../finance/accountingPeriodForm.jsp"><i class="bi bi-plus"></i> Create Accounting</a>
                    </div>   </div>
 <div class="pagetitle">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title"><h5>Accounting Period List</h5></div> 
                                                         ...
                                                         <table id="example" class="table datatable">
                                                            <thead>
                                                                <tr class="headings">                                                                              
                                                                    ...
                                                                    <th style="text-align: center">Calendar Code</th>   
                                                                    <th style="text-align: center">Action Status</th>  
                                                                    <th style="text-align: center">Period Code</th>  
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${accountingPeriodList}" var="type">
                                                                    <tr>
                                                                        <!--<td style="text-align: left" class="center">${type.sno}</td>-->
                                                                        <td style="text-align: left" class="center">${type.orgCode}</td>
                                                                        <td style="text-align: left" class="center">${type.calendarCode}</td>
                                                                        <td style="text-align: left" class="center">${type.actionStatus}</td>
                                                                        <td style="text-align: left" class="center">${type.periodCode}</td>
                                                                        <td style="text-align: left" class="center"><fmt:formatDate value="${type.startDate}" pattern="dd/MM/yyyy"/></td>
                                                                        <td style="text-align: left" class="center"><fmt:formatDate value="${type.endDate}" pattern="dd/MM/yyyy"/></td>
                                                                        <td style="text-align: left" class="center">${type.accountingStatus}</td>
                                                                        ...
                                                                        <td class="center" style="text-align:left" >
                                                                            ...
                                                                            <c:if test="${type.status ne 'Inactive'}">
                                                                            <a class="myButton" href="../Transactional/accountingPeriodView.htm?sno=${type.sno}&action=view" >
                                                                                <i class="fa fa-search-plus">
                                                                                    </i>                                              
                                                                            </a>
                                                                            <a class="myButton1" href="../Transactional/accountingPeriodEdit.htm?sno=${type.sno}&action=edit" >
                                                                                <i class="fa fa-pencil-square-o">  
                                                                                    </i>                                             
                                                                            </a> 
                                                                            </c:if>    
                                                                            <a class="${btncls}"  href="../Transactional/deleteDetails.htm?sno=${type.sno}&clsname=AccountingPeriod&listview=accountingPeriodList&status=${stsval}" onclick="if (confirm('Do you really want to ${lblval} this record?')) {
                                                                                        return true;
                                                                                    } else {
                                                                                        return false;
                                                                                    }">
