   ...
   <main id="main" class="main">
         <div>
          ...
          <li class="nav-item"><a class="nav-link"  href="../finance/costCenterMasterList.jsp">Cost Center</a></li>
           <li class="nav-item"><a class="nav-link active"  href="../finance/chartOfAccountsNew.jsp">Chart Of Accounts</a></li>
            ...
            <br>
            <div class="text-end">
                 <a class="btn btn-primary btn-sm " href="../finance/chartOfAccountsNew.jsp"><i class="bi bi-eye "></i> Show Chart List</a>
                    </div>   </div>
 <div class="pagetitle">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="card-title"><h5>Chart of Accounts Form</h5></div> 
               <form class="row validateForm" id="coustmermnForm" accept-charset="UTF-8" method="post" action="../Transactional/calendarPeriodFormSubmit.htm" enctype="multipart/form-data" commandName="calendarPeriod">
                                        ...
                                        <div class="col-md-4 form-floating mb-3">
                                           <input type="text" autocomplete="off" id="description" required name="description" maxlength="50"  class="form-control capitalize validate[required]" value="" placeholder="Description"> 
                                            <span id="adesc" style="color: red; font: bold; display: none; text-align: right; margin-left: 160px;">Please Enter Description</span>
                                       <label class="control-label"><span style="color:red">*</span>Account Description</label>
                                        </div>

                                         <div class="col-md-4 form-floating mb-3 pick3">
                                            <!--                                            <input class="form-control capitalize validate[required]"  id="startDate" name="startDate" type="text" value="" placeholder="Select Start Date" maxlength="20" onclick="javascript:NewCssCal('startDate', 'ddMMyyyy', '', '', '', '', '')" onchange="getDate1('startDate');"   placeholder="Start Date">-->
                                      
                                            <input class="form-control datepicker3 capitalize validate[required]" required placeholder="Start Date" id="startDate" name="startDate" type="text" value="" placeholder="DD/MM/YYYY" maxlength="10" onchange="getDate1('startDate');">
                                         ...
                                         <div class="col-md-4 form-floating mb-3 pick2">
                                            <!--                                            <input class="form-control capitalize validate[required,custom[startenddateComp]]"  id="endDate" name="endDate" type="text" value="" maxlength="20" placeholder="Select End Date" onclick="javascript:NewCssCal('endDate', 'ddMMyyyy', '', '', '', '', '')" onchange="getDate1('endDate');"  readonly="" placeholder="End Date">-->
                                          
                                            <input class="form-control datepicker2 capitalize validate[required]" required placeholder="End Date" id="endDate" name="endDate" type="text" value="" placeholder="DD/MM/YYYY" maxlength="10" onkeypress="return manDt1(event)" onchange="getDate1('endDate');">
                                          ...
                                          <div class="col-md-4 form-floating mb-3">
                                           <select class="form-control capitalize validate[required]" id="parentCode" name="parentCode" type="text" value="" maxlength="10" placeholder="" data-original-title="Parent Code">                                                
                                                <option value="" selected="">Select an Option</option>
                                                    ...
                                                    <option value="Expen">Expen Expenditure</option>
                                                
                                                    <option value="Income">Income Income</option>
                                                
                                                    <option value="Liab">Liab Liabilities</option>
    ...
    <div class="col-md-4 form-floating mb-3">
         ...
         <label class="control-label"><span style="color:red">*</span>Account Group</label>
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                ...
                                                <a href="../finance/calendarPeriodList.jsp"  class="btn btn-danger" >Cancel</a>      
                                            </div>  
