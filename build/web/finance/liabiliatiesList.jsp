...
<html lang="en">
 ...
 <jsp:include page="../login/footer.jsp"/>
     <main id="main" class="main">
        ...
        <br />
        <div class="text-end">
            <a class="btn btn-primary btn-sm" href="../finance/liabilitiesForm.htm"><i class="bi bi-plus"></i> Create Liabilities</a>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table datatable table-hover table-bordered">
                                ...
                                <tbody>
<!--                                    <c:forEach items="${liabilitiesList}" var="type">
                                                                <tr class="even pointer">
                                                                <td class="center">${type.liabilitiesClassId}</td>
                                                                <td class="center">${type.liabilitiesClassName}</td>
                                                                <td class="center">${type.liabilitiesClassDescription}</td>
                                                                                                                                        
                                                                    <td>
                                            <a href="../finance/liabilitiesForm.htm?SNo=${type.SNo}&action=view" class="fa fa-eye fa-lg" data-toggle="tooltip" title="View"></a>
                                            <a class="fa fa-edit fa-lg" href="../finance/liabilitiesForm.htm?SNo=${type.SNo}&action=edit" data-toggle="tooltip" title="Edit"> </a>
                                            <a
