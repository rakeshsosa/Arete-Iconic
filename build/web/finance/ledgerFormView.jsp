                    ...
                    <div class="card-body">
                        ...
                        <form class="row validateForm" id="coustmermnForm" accept-charset="UTF-8" method="post" action="../finance/ledgerFormSubmit.htm" enctype="multipart/form-data" commandName="coa">
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <select class="form-select" id="ledgerType" disabled name="ledgerCode" value="${ledgerGroup}" readonly="">
<!--                                    <option value="" selected="" disabled="">Select an option</option>
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <select class="form-select" id="accountGroup" disabled name="ledgerGroup" value="${ledgerGroup}" readonly="">
<!--                                    <option value="" selected="" disabled="">Select an option</option>
...
<!--                                    <option value="" selected="">Select an Option</option>                                                
                            ...
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" required name="ledgerName" value="${ledgerName}" readonly="" maxlength="50" class="form-control capitalize validate[required]" />
                                <label class="control-label"><span style="color: red;">*</span>Ledger Account Name</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input type="text" placeholder="fill" autocomplete="off" id="costcentername" required name="ledgerDescription" value="${ledgerDescription}" readonly="" maxlength="50" class="form-control capitalize validate[required]" />
                            ...
                            <div class="col-md-4 mb-3 my-auto">
                               <label class="control-label">
                                   <input type="checkbox" disabled placeholder="fill" id="keepBankAcc" name="costcentername" /> Do you wish to add the bank details? 
                               </label>
                            </div>
                            <div class="col-md-4 form-floating mb-3" id="bankAccNameHide">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" required name="bankAccountName" value="${bankAccountName}" readonly="" maxlength="50" class="form-control capitalize validate[required]" />
                            ...
                            <div class="col-md-4 form-floating mb-3" id="bankAccNoHide">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" required name="bankAccountNo" value="${bankAccountNo}" readonly="" maxlength="50" class="form-control capitalize validate[required]" />
                                <label class="control-label"><span style="color: red;">*</span>Bank Account Number</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="propertyname" required name="ledgerReportGroup" value="${ledgerReportGroup}" readonly="" maxlength="50" class="form-control capitalize validate[required]" value="" onclick="return selectAssetDetails()"/>
                                <label class="control-label"><span style="color: red;">*</span>Property Name</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="unitnumber" required name="ledgerSubgroup" maxlength="50" value="${ledgerSubgroup}" readonly="" class="form-control capitalize validate[required]" readonly value="" />
                                <label class="control-label"><span style="color: red;">*</span>Unit Number</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" required name="shop" maxlength="50" value="${shop}" readonly="" class="form-control capitalize validate[required]" value="" />
                                <label class="control-label"><span style="color: red;">*</span>Shop Name</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" name="costCenter" maxlength="50" value="${costCenter}" readonly="" class="form-control capitalize validate[required]" value="" />
                                <label class="control-label">Cost Center</label>
                            </div>
                            <div class="col-md-4 form-floating mb-3">
                                <input placeholder="fill" type="text" autocomplete="off" id="costcentername" required name="ledgerOpeningBalance" value="${ledgerOpeningBalance}" readonly="" maxlength="50" class="form-control capitalize validate[required]" value="" />
