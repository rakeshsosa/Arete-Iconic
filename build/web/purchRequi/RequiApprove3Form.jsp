<%-- 
    Document   : RequiApprove3Form
    Created on : 15 Oct, 2016, 3:06:30 PM
...
<html lang="en">
    ...
    <script>
        ...
        {
            var remarks = $('#reviewerComments3').val();
            if (remarks == null || remarks == '') {
                alert("Please Write Remarks..!!");
                return  false;
            } else {
                window.location.href = "../purchase/rejectedRequiSubmit.htm?reqNo=" + reqNo + "&reviewerRecordStatus=" + status + "&reviewerComments3=" + remarks + "";
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="x_panel">
                                <jsp:include page="../login/headerlink.htm?submodule=Purchase Requisition&tab=Approval 2&pagetype=form"/>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="requiForm" class="form-inline" action="../purchase/RequiApprov3Submit.htm" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <textarea  rows="2" class="form-control" id="reviewerComments3" required="" style="resize: none" name="reviewerComments3" maxlength="120"></textarea> 
                                        </div>
                                        ...
                                        <c:if test="${action ne 'view'}">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                                                ...
                                                <a href="../purchase/RequiApprove3List.htm" class="btn btn-danger">Cancel</a>
                                            </div>
