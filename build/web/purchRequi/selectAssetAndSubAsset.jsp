<%-- 
    Document   : selectAssetAndSubAsset
    Created on : 6 Oct, 2016, 1:38:49 PM
    Author     : Shweta S
--%>
    ...
    <body>
        ...
        <script>
            function test(val1, val2, val3, val4) {
                ...
                window.opener.document.getElementById('subAssetCategory').value = val4;
                window.close();
            }
