...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <a href="receivedDueList.jsp"></a>
    <jsp:include page="../login/footer.jsp"/>

   <main id="main" class="main">
       <div class="mt-3">
           <jsp:include page="../login/headerlink.htm?submodule=Charges Tracking&tab=Received Dues&pagetype=list"/>
       </div>
    <div class="pagetitle">
 ...
 <a  class="fa fa-pencil fa-lg"title="Edit" href="../master/insuranceMasterForm.htm?pk=${list.sno}&insuranceCompId=${list.insuranceCompanyId}&action=edit"> </a>
   ...
   <script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js"></script>
        ...
        tippy('#information', {
            content: '<p>Select Invoice Type, Search and View the Invoice Type, Invoice, Property Name, Unit Number, Invoice Amount,   Due date, Payment Date, Payment Method, and TRF Number. </p>\n\
             ',
            allowHTML: true,
            hideOnClick: true,
            trigger: 'click',
