    ...
    <body>
        ...
        <script>
            function test(val1, val2) {
                window.opener.document.getElementById('landlordId').value = val1;
                window.opener.document.getElementById('landlordname').value = val2;
                window.close();
            }
                        ...
                        <form class="form-horizontal" id="contDetForm">                            
                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="overflow-y:scroll;">
                                ...
                                <tbody>                                   
                                    ...
                                    <c:forEach items="${landLord}" var="type">

                                        <tr onclick="test('${type.landlordId}', '${type.landlordName}');">                                            
