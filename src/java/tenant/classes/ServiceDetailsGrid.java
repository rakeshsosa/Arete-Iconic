 ...
 */
@Entity
@Table(name = "service_details_grid", schema = "arete_tms")        
public class ServiceDetailsGrid implements java.io.Serializable{
    private Integer sno;
    ...
    public ServiceDetailsGrid(){
    
    }

    public ServiceDetailsGrid(String orgId, String userId, String bookingId, String quotationNo, String serviceCategory, String serviceName, double chargesQuoted1, double vatPercentage1, double vatAmount1, double totalAmount1, String securityDeposit, String advance, Boolean status, Date lastmodifiedDate) {
        this.orgId = orgId;
        this.userId = userId;
    ...
    public ServiceDetailsGrid(Integer sno, String orgId, String userId, String bookingId, String quotationNo, String serviceCategory, String serviceName, double chargesQuoted1, double vatPercentage1, double vatAmount1, double totalAmount1, String securityDeposit, String advance, Boolean status, Date lastmodifiedDate) {
        this.sno = sno;
        this.orgId = orgId;
        this.userId = userId;
        this.bookingId = bookingId;
