 ...
 */
@Entity
@Table(name = "tenant_type", catalog = "arete_tms"
) 
public class TenantType implements java.io.Serializable {
    ...
    public TenantType(String userId, String orgId, String tenantType, String typeDesc, String typeSeqNo, String extra1, String extra2, String extra3, String extra4, String extra5, String status, Date creationDate, Date lastmodifiedDate) {
        this.userId = userId;
        this.orgId = orgId;
    ...
    public TenantType(Integer sno, String userId, String orgId, String tenantType, String typeDesc, String typeSeqNo, String extra1, String extra2, String extra3, String extra4, String extra5, String status, Date creationDate, Date lastmodifiedDate) {
        this.sno = sno;
        this.userId = userId;
        this.orgId = orgId;
        this.tenantType = tenantType;
