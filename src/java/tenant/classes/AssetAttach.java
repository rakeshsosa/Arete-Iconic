 ...
 */
@Entity
@Table(name = "asset_attach", schema = "arete_tms")     
public class AssetAttach implements java.io.Serializable {
    ...
    public AssetAttach(byte[] content, String contentType, String assetCode, String filename, Date lastmodifiedDate, String orgId,
