...
@Entity
@Table(name = "manage_invoice", schema = "arete_tms")
public class ManageInvoice implements java.io.Serializable {  
...
//	private SaveType saveType;
    ...
    public ManageInvoice(String userId, String orgId, String invoiceId, String invoiceName, String invoiceType, String invoiceDesc, String taxCode, String pdChequeNo, String lpNo, 
    ...
    public ManageInvoice(Integer invoicePk, String userId, String orgId, String invoiceId, String invoiceName, String invoiceType, String invoiceDesc, String taxCode, String pdChequeNo, String lpNo, String unitName, String tenantName, Date dueDate, String propertyName, String serviceAreaDesc, String custName, Date fromDate, Date toDate, Boolean recurringBtn, Double discount, Double amtPaid, String paymentTerms, String contractTerms, Date creationDate, Boolean activeStatus, String frequency, Date nextIssueDate, String invoiceRecurringType, Double subTotal, Double balance, Double vat, Double totalPayableAmount, String recordStatus, String bankAccountDetails) {
